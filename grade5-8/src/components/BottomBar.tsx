...
import { AssessmentMode } from '../lib/data';
  ...
  return (
    <div className={clsx(
      ...
      <div className="flex items-center gap-4">
        <button onClick={onClear} className={clsx(secondaryBtn, "hidden md:flex")}>
          <Eraser size={18} />
          Clear Answer
        </button>

        <button onClick={onRoughWork} className={clsx(secondaryBtn)}>
          <PenTool size={18} />
