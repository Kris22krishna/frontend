...
import './Class7ExplanationModal.css';

const Class7ExplanationModal = ({ isOpen, isCorrect, correctAnswer, explanation, onClose, onNext }) => {
    return (
        <AnimatePresence>
            {isOpen && (
                <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/40 backdrop-blur-sm p-4 sm:p-2">
                    ...
                    >
                        ...
                        <div className="flex-shrink-0 bg-[#E0FBEF] explanation-mascot-panel p-3 lg:p-6 lg:w-[220px] relative">
                            <img src={mascotImg} alt="Mascot" className="explanation-mascot-image" />
                            <div className="explanation-mascot-tag mt-2 lg:mt-4">
...
export default Class7ExplanationModal;
