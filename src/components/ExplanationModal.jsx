...
const ExplanationModal = ({ isOpen, isCorrect, correctAnswer, explanation, onClose, onNext }) => {
    return (
        <AnimatePresence>
            {isOpen && (
                <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/40 backdrop-blur-sm p-2">
                    <motion.div
                    ...
                    >
                        ...
                        <div className="flex-1 overflow-y-auto p-4 lg:p-8">
                            ...
                            <div className="flex-1">
                                ...
                                <div className="text-gray-600 text-lg leading-relaxed overflow-y-auto pr-4 scrollbar-thin whitespace-pre-line">
