...
const testimonials = [
    {
        ...
        text: 'skill100.ai made maths so much fun! I used to struggle with algebra, but the practice sessions helped me score 95% in my board exams. Thank you!',
    ...
    },
    {
        ...
        text: 'From fractions to geometry, skill100.ai covers everything. I recommend it to all my classmates!',
