        ...
        <section className="py-16 px-8 bg-gradient-to-br from-orange-50 via-blue-50 to-purple-50">
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 items-start">
                    ...
                    <div className="rounded-2xl p-8 bg-gradient-to-br from-indigo-300 via-violet-300 to-indigo-400 relative overflow-hidden flex flex-col h-[336px]">
                        <div className="space-y-4 relative z-10 overflow-y-auto flex-1" style={{ scrollbarWidth: 'thin', scrollbarColor: 'rgba(99,102,241,0.4) transparent' }}>
                            <button
                                id="arithmetic-btn"
