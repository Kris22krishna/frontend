                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        ...
                        <div className="space-y-4 relative z-10">
                            {column3Grades.map((grade) => (
                                <button
                                    key={grade.id}
                                    onClick={() => handleGradeClick(grade.id)}
                                    className="w-full text-left px-6 py-4 rounded-xl bg-white/80 hover:bg-violet-100 transition-all duration-300 shadow-[0_6px_12px_rgba(0,0,0,0.15),inset_0_-2px_4px_rgba(0,0,0,0.1)] hover:shadow-[0_8px_16px_rgba(0,0,0,0.2),inset_0_-3x_6px_rgba(0,0,0,0.15)] hover:scale-105 border-b-4 border-purple-300/50 group flex items-center justify-between"
                                    style={{ transform: 'translateZ(0)' }}
                                >
                                    <span className="text-gray-800 font-medium">{grade.label}</span>
                    ...
                    <div className="rounded-2xl p-8 bg-gradient-to-br from-indigo-300 via-violet-300 to-indigo-400 relative overflow-hidden flex flex-col justify-center">
                        <div className="space-y-4 relative z-10">
                            ...
                            >
                                <div>
                                    <span className="text-gray-800 font-semibold block">Algebra</span>
                                    <span className="text-gray-500 text-xs">Variables, Equations & More</span>
                                </div>
                                <span className="opacity-0 group-hover:opacity-100 transition-opacity text-indigo-600 font-bold text-lg">→</span>
                            </button>
                            <button
                                ...
                                className="w-full text-left px-6 py-4 rounded-xl bg-white/80 hover:bg-purple-100 transition-all duration-300 shadow-[0_6px_12px_rgba(0,0,0,0.15),inset_0_-2px_4px_rgba(0,0,0,0.1)] hover:shadow-[0_8px_16px_rgba(0,0,0,0.2),inset_0_-3px_6px_rgba(0,0,0,0.15)] hover:scale-105 border-b-4 border-purple-400/50 group flex items-center justify-between"
                                style={{ transform: 'translateZ(0)' }}
                            >
                                <div>
                                    <span className="text-gray-800 font-semibold block">Calculus</span>
                            ...
                            <button
                                id="coordinate-geometry-btn"
                                onClick={() => navigate('/coordinate-geometry')}
                                className="w-full text-left px-6 py-4 rounded-xl bg-white/80 hover:bg-cyan-100 transition-all duration-300 shadow-[0_6px_12px_rgba(0,0,0,0.15),inset_0_-2px_4px_rgba(0,0,0,0.1)] hover:shadow-[0_8px_16px_rgba(0,0,0,0.2),inset_0_-3px_6px_rgba(0,0,0,0.15)] hover:scale-105 border-b-4 border-cyan-400/50 group flex items-center justify-between"
                                style={{ transform: 'translateZ(0)' }}
                            >
                                <div>
                                    <span className="text-gray-800 font-semibold block">Coordinate Geometry</span>
                                    <span className="text-gray-500 text-xs">2D, 3D, Lines & Apps</span>
                                </div>
                                <span className="opacity-0 group-hover:opacity-100 transition-opacity text-cyan-600 font-bold text-lg">→</span>
                            </button>
                        </div>
                    </div>
                </div>
