...
// --- SVG Generators ---
const create3DShapeSVG = (name) => {
    const strokeColor = "#4f46e5";
    const fillColor = "#e0e7ff";
    const opacity = "0.6";
    ...
    switch (name) {
        ...
        case 'Cube':
            return `<svg width="200" height="200" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                <rect x="40" y="60" width="80" height="80" stroke="${strokeColor}" stroke-width="2" fill="${fillColor}" fill-opacity="${opacity}" />
                <rect x="80" y="20" width="80" height="80" stroke="${strokeColor}" stroke-width="2" fill="none" />
                <line x1="40" y1="60" x2="80" y2="20" stroke="${strokeColor}" stroke-width="2" />
                <line x1="120" y1="60" x2="160" y2="20" stroke="${strokeColor}" stroke-width="2" />
                <line x1="40" y1="140" x2="80" y2="100" stroke="${strokeColor}" stroke-width="2" />
                <line x1="120" y1="140" x2="160" y2="100" stroke="${strokeColor}" stroke-width="2" />
            </svg>`;
        case 'Cuboid':
            return `<svg width="200" height="200" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                <rect x="30" y="80" width="100" height="60" stroke="${strokeColor}" stroke-width="2" fill="${fillColor}" fill-opacity="${opacity}" />
                <rect x="70" y="40" width="100" height="60" stroke="${strokeColor}" stroke-width="2" fill="none" />
                <line x1="30" y1="80" x2="70" y2="40" stroke="${strokeColor}" stroke-width="2" />
                <line x1="130" y1="80" x2="170" y2="40" stroke="${strokeColor}" stroke-width="2" />
                <line x1="30" y1="140" x2="70" y2="100" stroke="${strokeColor}" stroke-width="2" />
                <line x1="130" y1="140" x2="170" y2="100" stroke="${strokeColor}" stroke-width="2" />
            </svg>`;
        case 'Triangular Prism':
            return `<svg width="200" height="200" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                <path d="M40,140 L100,40 L160,140 Z" stroke="${strokeColor}" stroke-width="2" fill="${fillColor}" fill-opacity="${opacity}" />
                <path d="M70,110 L130,10 L190,110 Z" stroke="${strokeColor}" stroke-width="2" fill="none" />
                <line x1="40" y1="140" x2="70" y2="110" stroke="${strokeColor}" stroke-width="2" />
                <line x1="100" y1="40" x2="130" y2="10" stroke="${strokeColor}" stroke-width="2" />
                <line x1="160" y1="140" x2="190" y2="110" stroke="${strokeColor}" stroke-width="2" />
            </svg>`;
        case 'Square Pyramid':
            return `<svg width="200" height="200" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                <path d="M40,140 L120,160 L160,120 L80,100 Z" stroke="${strokeColor}" stroke-width="2" fill="${fillColor}" fill-opacity="${opacity}" />
                <line x1="40" y1="140" x2="100" y2="30" stroke="${strokeColor}" stroke-width="2" />
                <line x1="120" y1="160" x2="100" y2="30" stroke="${strokeColor}" stroke-width="2" />
                <line x1="160" y1="120" x2="100" y2="30" stroke="${strokeColor}" stroke-width="2" />
                <line x1="80" y1="100" x2="100" y2="30" stroke="${strokeColor}" stroke-width="2" stroke-dasharray="4" />
            </svg>`;
        case 'Triangular Pyramid':
            return `<svg width="200" height="200" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                <path d="M40,150 L160,150 L100,120 Z" stroke="${strokeColor}" stroke-width="2" fill="${fillColor}" fill-opacity="${opacity}" />
                <line x1="40" y1="150" x2="100" y2="20" stroke="${strokeColor}" stroke-width="2" />
                <line x1="160" y1="150" x2="100" y2="20" stroke="${strokeColor}" stroke-width="2" />
                <line x1="100" y1="120" x2="100" y2="20" stroke="${strokeColor}" stroke-width="2" stroke-dasharray="4" />
            </svg>`;
        case 'Hexagonal Prism':
            return `<svg width="200" height="200" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                <path d="M60,60 L100,40 L140,60 L140,100 L100,120 L60,100 Z" stroke="${strokeColor}" stroke-width="2" fill="${fillColor}" fill-opacity="${opacity}" />
                <path d="M90,40 L130,20 L170,40 L170,80 L130,100 L90,80 Z" stroke="${strokeColor}" stroke-width="2" fill="none" />
                <line x1="60" y1="60" x2="90" y2="40" stroke="${strokeColor}" stroke-width="2" />
                <line x1="100" y1="40" x2="130" y2="20" stroke="${strokeColor}" stroke-width="2" />
                <line x1="140" y1="60" x2="170" y2="40" stroke="${strokeColor}" stroke-width="2" />
                <line x1="140" y1="100" x2="170" y2="80" stroke="${strokeColor}" stroke-width="2" />
                <line x1="100" y1="120" x2="130" y2="100" stroke="${strokeColor}" stroke-width="2" />
                <line x1="60" y1="100" x2="90" y2="80" stroke="${strokeColor}" stroke-width="2" />
            </svg>`;
        case 'Pentagonal Pyramid':
            return `<svg width="200" height="200" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                <path d="M50,140 L100,160 L150,140 L130,110 L70,110 Z" stroke="${strokeColor}" stroke-width="2" fill="${fillColor}" fill-opacity="${opacity}" />
                <line x1="50" y1="140" x2="100" y2="20" stroke="${strokeColor}" stroke-width="2" />
                <line x1="100" y1="160" x2="100" y2="20" stroke="${strokeColor}" stroke-width="2" />
                <line x1="150" y1="140" x2="100" y2="20" stroke="${strokeColor}" stroke-width="2" />
                <line x1="130" y1="110" x2="100" y2="20" stroke="${strokeColor}" stroke-width="2" stroke-dasharray="4" />
                <line x1="70" y1="110" x2="100" y2="20" stroke="${strokeColor}" stroke-width="2" stroke-dasharray="4" />
            </svg>`;
        default: return "";
    }
};
...
export const generate3DShapeIdentification = () => {
    ...
    const shapes = {
        'Triangular Prism': {
            ...
            category: 'Prism',
            imagePath: create3DShapeSVG('Triangular Prism')
        },
        'Square Prism': {
            name: 'Square Prism',
            category: 'Prism',
            imagePath: create3DShapeSVG('Square Prism')
        },
        'Hexagonal Prism': {
            name: 'Hexagonal Prism',
            category: 'Prism',
            imagePath: create3DShapeSVG('Hexagonal Prism')
        },
        'Triangular Pyramid': {
            name: 'Triangular Pyramid',
            category: 'Pyramid',
            imagePath: create3DShapeSVG('Triangular Pyramid')
        },
        'Square Pyramid': {
            name: 'Square Pyramid',
            category: 'Pyramid',
            imagePath: create3DShapeSVG('Square Pyramid')
        },
        'Pentagonal Pyramid': {
            name: 'Pentagonal Pyramid',
            category: 'Pyramid',
            imagePath: create3DShapeSVG('Pentagonal Pyramid')
        }
    };
...
export const generateFVETable = () => {
    ...
    const shapes = [
        ...
        {
            name: 'Triangular Pyramid',
            image: create3DShapeSVG('Triangular Pyramid'),
            faces: 4,
            vertices: 4,
            edges: 6
        },
        {
            name: 'Square Pyramid',
            image: create3DShapeSVG('Square Pyramid'),
            faces: 5,
            vertices: 5,
            edges: 8
        },
        {
            name: 'Triangular Prism',
            image: create3DShapeSVG('Triangular Prism'),
            faces: 5,
            vertices: 6,
            edges: 9
        }
    ...
    return {
        ...
        question: "Complete the following table based on the 3D shapes shown below:",
