...
import { physicalChemIntroData } from './PhysicalChemIntroData';
...
export default function PhysicalChemIntro() {
    const navigate = useNavigate();

    return (
        <div className="chemPage">
            <nav className="chemNav">
                <button className="chemNavBack" onClick={() => navigate('/chemistry/physical')}>
                    ← Back to Dashboard
                </button>
            ...
            <div className="chemModuleHero" style={{ background: 'linear-gradient(135deg, #1e1b4b 0%, #312e81 50%, #4338ca 100%)' }}>
                <h1 className="chemModuleTitle">
                    Dive into <span style={{ color: '#a5b4fc' }}>Physical Chemistry</span>
                </h1>
            ...
            <main style={{ maxWidth: 1000, margin: '0 auto', padding: '40px 24px' }}>
                ...
                <div className="chemIntroGrid">
                    {physicalChemIntroData.cards5W1H.map((card, idx) => (
                ...
                <div style={{
                    ...
                    <div>
                        ...
                        <p style={{ margin: 0, opacity: 0.8 }}>Next up: Key terms and identities of Physical Chemistry.</p>
                    </div>
                    <button
                        onClick={() => navigate('/chemistry/physical/terminology')}
                        style={{ padding: '12px 28px', background: '#fff', color: '#1e1b4b', border: 'none', borderRadius: 100, fontWeight: 800, cursor: 'pointer' }}
                    >
                        Terminology →
                    </button>
                </div>
