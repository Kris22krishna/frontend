...
import { PHYSICAL_CHEM_SKILLS } from './PhysicalChemSkillsData';
            ...
            <div style={{ display: 'grid', gap: 10 }}>
                {options.map((opt, i) => {
                    ...
                    if (disabled && showCorrect) {
                        ...
                        if (i === selectedOption) { bg = '#eef2ff'; bdr = BRANCH_COLOR; }
                    } else if (i === selectedOption) {
                        bg = `${BRANCH_COLOR}08`; bdr = BRANCH_COLOR;
                    }
                    return (
...
const SKILL_NODE_ID_MAP = {
    'skill-1': NODE_IDS.chemPhysicalStatesClassification,
    'skill-2': NODE_IDS.chemPhysicalStatesProperties,
    'skill-3': NODE_IDS.chemPhysicalBalancingEquations,
};

export default function PhysicalChemSkills() {
    ...
    const activeSkill = PHYSICAL_CHEM_SKILLS.find(s => s.id === activeSkillId);
        ...
        <div className="chemPage">
            <nav className="chemNav">
                ...
                <div className="chemNavLinks">
                    ...
                    <button className="chemNavLink" onClick={() => navigate('/chemistry/physical/terminology')}>📖 Terminology</button>
                ...
                {view === 'list' && (
                    <div>
                        ...
                        <div className="chemSkillsList">
                            {PHYSICAL_CHEM_SKILLS.map((skill) => (
