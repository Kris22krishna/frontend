...
import { inorganicChemIntroData } from './InorganicChemIntroData';
...
export default function InorganicChemIntro() {
    const navigate = useNavigate();

    return (
        <div className="chemPage">
            <nav className="chemNav">
                <button className="chemNavBack" onClick={() => navigate('/chemistry/inorganic')}>
                    ← Back to Dashboard
                </button>
            ...
            <div className="chemModuleHero" style={{ background: 'linear-gradient(135deg, #064e3b 0%, #065f46 50%, #059669 100%)' }}>
                <h1 className="chemModuleTitle">
                    Dive into <span className="chemAccentText">Inorganic Chemistry</span>
                </h1>
            ...
            <main style={{ maxWidth: 1000, margin: '0 auto', padding: '40px 24px' }}>
                ...
                <div className="chemIntroGrid">
                    {inorganicChemIntroData.cards5W1H.map((card, idx) => (
                ...
                <div style={{
                    ...
                    <div>
                        ...
                        <p style={{ margin: 0, opacity: 0.8 }}>Next up: Key terms and identities of Inorganic Chemistry.</p>
                    </div>
                    <button
                        onClick={() => navigate('/chemistry/inorganic/terminology')}
                        style={{ padding: '12px 28px', background: '#fff', color: '#064e3b', border: 'none', borderRadius: 100, fontWeight: 800, cursor: 'pointer' }}
                    >
                        Terminology →
                    </button>
                </div>
