...
export default function CubesAssessmentEngine({ questionPool, sampleSize = 10, title, color, onBack, nodeId }) {
                            ...
                            <div key={i} style={{
                                ...
                                <div className={styles['ccr-quiz-options']}>
                                    <div style={{ background: 'rgba(16,185,129,0.08)', borderRadius: 10, padding: '10px 14px' }}>
                                        ...
                                        <div style={{ fontSize: 14, fontWeight: 600, color: '#1e293b' }}><LatexText text={q.options[q.correct]} /></div>
                                    </div>
        ...
        <div className={styles['ccr-assessment-layout']}>
            <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: 20 }}>
                    <button className={styles['ccr-btn-secondary']} onClick={() => setCurrent((c) => Math.max(0, c - 1))} disabled={current === 0}
