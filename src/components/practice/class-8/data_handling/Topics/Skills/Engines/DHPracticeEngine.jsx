        ...
        return (
            <div style={{ textAlign: 'center', padding: '40px 0' }}>
                ...
                <div style={{ display: 'flex', gap: 12, justifyContent: 'center' }}>
                    <button className={styles['dh-btn-primary']} onClick={handleRetry} style={{ background: color }}>New Questions</button>
                    <button className={styles['dh-btn-secondary']} onClick={onBack}>Return to Skills</button>
                </div>
            </div>
        );
    }
