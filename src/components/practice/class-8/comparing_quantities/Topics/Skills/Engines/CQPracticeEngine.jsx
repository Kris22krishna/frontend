        ...
        return (
            <div style={{ textAlign: 'center', padding: '40px 0' }}>
                ...
                <div style={{ display: 'flex', gap: 12, justifyContent: 'center' }}>
                    <button className="cq-btn-primary" onClick={handleRetry} style={{ background: color }}>🔀 New Questions</button>
                    <button className="cq-btn-secondary" onClick={onBack}>Return to Skills</button>
                </div>
            </div>
        );
    }
