...
const AdditiveMultiplicativeIdentityComponent = () => {
    ...
    useEffect(() => {
        ...
        startSession({ nodeId: NODE_IDS.g8MathRNIdentities, sessionType: 'practice' });
    ...
    // EASY 1: Additive identity
    const questionEasy1 = () => {
        const correctAnswer = "$0$";

        return {
            text: `<div class='question-container'>
                      <p>What is the <strong>additive identity</strong> for rational numbers?</p>
                   </div>`,
            correctAnswer,
            solution: `The <strong>additive identity</strong> is the number that, when added to any rational number, gives the same number.<br/><br/>
                       For any rational number $a$: $a + 0 = a$<br/><br/>
                       Therefore, the additive identity is <strong>0</strong>.`,
            options: [
                "$0$",
                "$1$",
                "$-1$",
    ...
    // EASY 2: Multiplicative identity
    const questionEasy2 = () => {
        const correctAnswer = "$1$";

        return {
            text: `<div class='question-container'>
                      <p>What is the <strong>multiplicative identity</strong> for rational numbers?</p>
                   </div>`,
            correctAnswer,
            solution: `The <strong>multiplicative identity</strong> is the number that, when multiplied with any rational number, gives the same number.<br/><br/>
                       For any rational number $a$: $a \\times 1 = a$<br/><br/>
                       Therefore, the multiplicative identity is <strong>1</strong>.`,
            options: [
                "$1$",
                "$0$",
                "$-1$",
    ...
    // MEDIUM 1: Application of additive identity
    const questionMedium1 = () => {
        const correctAnswer = "$-\\frac{5}{7}$";

        return {
            text: `<div class='question-container'>
                      <p>What is the value of $-\\frac{5}{7} + 0$?</p>
                   </div>`,
            correctAnswer,
            solution: `Using the <strong>additive identity property</strong>: $a + 0 = a$<br/><br/>
                       Therefore: $-\\frac{5}{7} + 0 = -\\frac{5}{7}$<br/><br/>
    ...
    // MEDIUM 2: Application of multiplicative identity
    const questionMedium2 = () => {
        const correctAnswer = "$\\frac{3}{8}$";

        return {
            text: `<div class='question-container'>
                      <p>Simplify: $\\frac{3}{8} \\times 1 \\times 1$</p>
                   </div>`,
            correctAnswer,
            solution: `Using the <strong>multiplicative identity property</strong>: $a \\times 1 = a$<br/><br/>
                       $\\frac{3}{8} \\times 1 = \\frac{3}{8}$<br/><br/>
                       Then: $\\frac{3}{8} \\times 1 = \\frac{3}{8}$<br/><br/>
                       Therefore: $\\frac{3}{8} \\times 1 \\times 1 = \\frac{3}{8}$`,
            options: [
                "$\\frac{3}{8}$",
                "$\\frac{3}{16}$",
                "$1$",
    ...
    // HARD 1: Combined application
    const questionHard1 = () => {
        const correctAnswer = "$-\\frac{2}{9}$";

        return {
            text: `<div class='question-container'>
                      <p>If $x$ is the multiplicative identity and $y$ is the additive identity, what is the value of $(-\\frac{2}{9} \\times x) + y$?</p>
                   </div>`,
            correctAnswer,
            solution: `First, identify the identities:<br/>
                       Multiplicative identity: $x = 1$<br/>
                       Additive identity: $y = 0$<br/><br/>
                       Now substitute:<br/>
                       $(-\\frac{2}{9} \\times 1) + 0$<br/><br/>
                       Using multiplicative identity: $-\\frac{2}{9} \\times 1 = -\\frac{2}{9}$<br/><br/>
                       Then using additive identity: $-\\frac{2}{9} + 0 = -\\frac{2}{9}$`,
            options: [
                "$-\\frac{2}{9}$",
                "$\\frac{2}{9}$",
                "$0$",
...
export default AdditiveMultiplicativeIdentityComponent;
