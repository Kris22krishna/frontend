...
import { functionsExamEdgeData as data } from "./FunctionsExamEdgeData";

const EXAM_TABS = [{ id: "board", name: "Board Level", color: "#f59e0b", icon: Trophy }];

export default function FunctionsExamEdge() {
  ...
  return (
    <div className="rel-page">
      <FunctionsTopNav active="exam-edge" backLabel="Back to Functions" />
      ...
      <div className="rel-intro-hero">
        ...
        <div className="rel-intro-hero-inner">
          <h1 className="rel-intro-hero-title">
            Functions <span className="rel-intro-hero-highlight">Exam Edge</span>
          </h1>
          <p className="rel-intro-hero-sub">
            High-yield topics, exam-style patterns, and a revision plan built for Functions.
          </p>
        </div>
      </div>
