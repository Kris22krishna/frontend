...
import { inverseTrigonometricFunctionsConnectomicsData as data } from "./InverseTrigonometricFunctionsConnectomicsData";

export default function InverseTrigonometricFunctionsConnectomics() {
  return (
      ...
      <div className="rel-intro-hero">
        ...
        <div className="rel-intro-hero-inner">
          <h1 className="rel-intro-hero-title">
            ...
            <span className="rel-intro-hero-highlight">Connectomics</span>
          </h1>
          <p className="rel-intro-hero-sub">
            See how restricted domains, principal values, geometry, and calculus all meet inside
            inverse trig.
          </p>
        </div>
      </div>
      ...
      <main style={{ maxWidth: 1100, margin: "0 auto", padding: "40px 24px" }}>
            ...
            return (
              ...
              >
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16 }}>
                  <div style={{ fontSize: 12, fontWeight: 900, color: fromNode.color }}>
                    {fromNode.icon}
                  </div>
                  <div
                    style={{
        ...
        >
          ...
          <h3 style={{ fontSize: 20, fontWeight: 800, color: "var(--rel-text)", margin: 0 }}>
            One Chapter, Many Branches
          </h3>
          <p style={{ maxWidth: 640, margin: 0, color: "#64748b", lineHeight: 1.7 }}>
            Inverse trigonometric functions are the meeting point of ratios, angles, restrictions,
            and principal values. That is why they reappear in geometry, identities, and calculus.
          </p>
        </div>
      </main>
    </div>
