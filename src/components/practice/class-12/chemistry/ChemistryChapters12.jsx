...
const ChemistryChapters12 = () => {
    ...
    const handleChapterClick = (chapter) => {
        if (!isAuthenticated) {
            ...
            navigate(`/senior/grade/12/chemistry/${chapter.key}`);
        }
    };

    const handleLoginSuccess = () => {
        if (pendingChapter) {
            navigate(`/senior/grade/12/chemistry/${pendingChapter.key}`);
            ...
            <header className="senior-header-container">
                <div className="header-inner">
                    ...
                    <div className="page-title">
                        <span style={{ fontSize: '0.75rem', fontWeight: '700', color: '#0ea5e9', background: '#e0f2fe', padding: '4px 12px', borderRadius: '20px', marginBottom: '10px', display: 'inline-block', letterSpacing: '0.05em' }}>GRADE 12 • CHEMISTRY</span>
