...
const QUIZ_QUESTIONS = [
  ...
  },
  {
    ...
    hints: [
      "Use the 2×2 formula: swap diagonal, negate off-diagonal, divide by det.",
    ],
  },
  {
    id: "inv3",
            ...
            >
              ...
              {concept.example && (
                ...
                >
                  ...
                  >
                    <MatrixGrid
                      rows={concept.example.matA.length}
                      cols={concept.example.matA[0].length}
                      values={concept.example.matA}
                      compact={true}
                    />
                    {concept.example.matB && (
                      <>
                        ...
                        <MatrixGrid
                          rows={concept.example.matB.length}
                          cols={concept.example.matB[0].length}
                          values={concept.example.matB}
                          compact={true}
                        />
                      </>
                    )}
                    {concept.example.result && (
                      <>
                        ...
                        <MatrixGrid
                          rows={concept.example.result.length}
                          cols={concept.example.result[0].length}
                          values={concept.example.result}
                          compact={true}
                        />
                      </>
                    )}
                      ...
                      {concept.example.steps.map((step, sIdx) => (
                        <div
                          ...
                          style={{
                            ...
                            borderRadius: 8,
                            background:
                              activeStep === sIdx ? "#EEF2FF" : "transparent",
                            cursor: "pointer",
