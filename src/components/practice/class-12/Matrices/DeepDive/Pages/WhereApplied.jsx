...
const APPLICATIONS = [
  {
    ...
    description:
      "Google's original search algorithm (PageRank) models the entire internet as a giant matrix where rows and columns are websites, and entries are links between them. By finding the 'eigenvector' of this massive matrix, it determines which pages are most important.",
    color: "#F0F9FF",
    borderColor: "#BAE6FD",
  },
  {
    ...
    description:
      "An image on your screen is just a huge matrix of pixels (usually 3 matrices for Red, Green, and Blue). When you apply a blur or sharpen filter on Instagram, your phone is multiplying that image matrix by a small 'kernel' matrix.",
    color: "#F5F3FF",
    borderColor: "#DDD6FE",
  },
  {
    ...
    description:
      "You can encrypt a secret message by converting letters into numbers, grouping them into a matrix, and multiplying them by a secret 'Key Matrix'. To decrypt the message, the receiver multiplies it by the inverse of the Key Matrix.",
    color: "#FFF1F2",
    borderColor: "#FECDD3",
  },
];
    ...
    >
      ...
      <div style={{ maxWidth: 800, margin: "0 auto", padding: "40px 20px" }}>
        <div style={{ marginBottom: 40, textAlign: "center" }}>
          ...
          >
            Now that you know how matrices work, let's look at three specific,
            massive applications that run the modern world.
          </p>
        </div>
