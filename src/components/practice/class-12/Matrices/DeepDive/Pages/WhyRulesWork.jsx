...
const SCENARIOS = [
  {
    ...
    description:
      "If you multiply 3 × 4, you get 12. If you multiply 4 × 3, you also get 12. This is called the commutative property. However, for matrices, $AB \\neq BA$ in most cases.",
  ...
  },
  {
    ...
    description:
      "Why didn't mathematicians just define multiplication as multiplying the corresponding elements together (like addition)?",
...
2. In the equation $3x + 4y = 10$, the coefficients $(3, 4)$ from the row combine with the variables $(x, y)$ from the column. The dot product captures this exact combination.`,
    hints: [
      "Think about why matrices were invented—mostly to solve systems of equations!",
    ],
  },
  {
    id: "why4",
...
3. Because the outcomes are different, the operations are not commutative ($AB \\neq BA$). Matrices represent actions/transformations, so order matters.`,
    hints: [
      "Does doing action A then B give the same result as doing B then A?",
    ],
  },
];
    ...
    >
      ...
      <div style={{ maxWidth: 800, margin: "0 auto", padding: "40px 20px" }}>
        <div style={{ marginBottom: 40, textAlign: "center" }}>
          ...
          >
            When you first learn matrix multiplication, it feels like an
            arbitrary set of rules. Why row multiplied by column? Why is $AB$
            different from $BA$? Let's break down the logic behind the math.
          </p>
        </div>
                  ...
                  >
                    ...
                    >
                      ...
                      <MatrixGrid
                        rows={2}
                        cols={2}
                        values={scenario.mathExample.ab}
                        compact={true}
                      />
                    </div>
                    <div
                    ...
                    >
                      ...
                      <MatrixGrid
                        rows={2}
                        cols={2}
                        values={scenario.mathExample.ba}
                        compact={true}
                      />
                    </div>
                    <div
        ...
        >
          ...
          <button
            onClick={() =>
              navigate("/senior/grade/12/matrices/deep-dive/where-applied")
            }
            style={{
              background: "#4F46E5",
              color: "#fff",
