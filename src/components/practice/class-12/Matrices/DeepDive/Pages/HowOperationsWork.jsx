...
$5-2=3$, $3-1=2$, $1-4=-3$, $7-3=4$.`,
  ...
  },
  {
    ...
    options: [
      "No, dimensions don't match",
      "Yes, result is $2 \\times 3$",
      "Yes, result is $2 \\times 2$",
      "Yes, result is $2 \\times 5$",
    ],
...
$= 5 + 14 = 19$`,
    hints: [
      ...
      "Multiply matching elements then add.",
    ],
  },
  {
    id: "op6",
...
$(2,2): 3(6)+4(8)=50$`,
    hints: [
      "Calculate each entry by dot product of the corresponding row and column.",
    ],
  },
...
So $A'_{2\\times 3} → (A')_{3 \\times 2}$.`,
    hints: [
      ...
      "The order changes from m×n to n×m.",
    ],
  },
  {
    id: "op9",
...
Both A and B are non-zero, but AB = O. This shows matrix multiplication can produce a zero matrix from non-zero factors!`,
    hints: [
      "Look for matrices where rows of A are proportional to cancellations with cols of B.",
    ],
  },
];
      ...
      <div style={{ maxWidth: 800, margin: "0 auto", padding: "40px 20px" }}>
        <div style={{ marginBottom: 32 }}>
          ...
          <p style={{ fontSize: "1.05rem", color: "#64748B", lineHeight: 1.6 }}>
            Master addition, scalar multiplication, matrix multiplication, and
            transpose with step-by-step visual guidance.
          </p>
        </div>
            ...
            {[
              {
                name: "Addition",
                icon: "➕",
                desc: "Add corresponding elements",
              },
              {
                name: "Scalar ×",
                icon: "✖️",
                desc: "Multiply every element by a scalar",
              },
              {
                name: "Multiplication",
                icon: "🔗",
                desc: "Dot product of rows & columns",
              },
