...
const SKILL_ID = 12207;
const SKILL_NAME = "Matrices — Topic 4: Operations on Matrices";

const MatrixOperationsTest = () => {
  ...
  useEffect(() => {
    ...
    (() => {
      ...
      const w1 = `$\\begin{bmatrix}${S[0][0] + 1}&${S[0][1]}\\\\${S[1][0]}&${S[1][1]}\\end{bmatrix}$`;
      const w2 = `$\\begin{bmatrix}${S[0][1]}&${S[0][0]}\\\\${S[1][1]}&${S[1][0]}\\end{bmatrix}$`;
      const w3 = `$\\begin{bmatrix}${A[0][0] * B[0][0]}&${A[0][1] * B[0][1]}\\\\${A[1][0] * B[1][0]}&${A[1][1] * B[1][1]}\\end{bmatrix}$`;
      qs.push({
        text: `Find $A + B$ where $A = \\begin{bmatrix}${A[0][0]}&${A[0][1]}\\\\${A[1][0]}&${A[1][1]}\\end{bmatrix}$ and $B = \\begin{bmatrix}${B[0][0]}&${B[0][1]}\\\\${B[1][0]}&${B[1][1]}\\end{bmatrix}$.`,
        options: shuffle([c, w1, w2, w3]),
        correctAnswer: c,
        solution: "Add corresponding elements: $(A+B)_{ij} = a_{ij} + b_{ij}$.",
    ...
    (() => {
      ...
      const R = A.map((r, i) => r.map((v, j) => 2 * v - B[i][j]));
      const c = `$\\begin{bmatrix}${R[0][0]}&${R[0][1]}\\\\${R[1][0]}&${R[1][1]}\\end{bmatrix}$`;
      const w1 = `$\\begin{bmatrix}${R[0][0] + 2}&${R[0][1]}\\\\${R[1][0]}&${R[1][1] + 1}\\end{bmatrix}$`;
      const w2 = `$\\begin{bmatrix}${R[1][0]}&${R[1][1]}\\\\${R[0][0]}&${R[0][1]}\\end{bmatrix}$`;
      const w3 = `$\\begin{bmatrix}${R[0][0] - 1}&${R[0][1] + 1}\\\\${R[1][0] + 1}&${R[1][1] - 1}\\end{bmatrix}$`;
      qs.push({
        text: `Find $2A - B$ where $A = \\begin{bmatrix}${A[0][0]}&${A[0][1]}\\\\${A[1][0]}&${A[1][1]}\\end{bmatrix}$, $B = \\begin{bmatrix}${B[0][0]}&${B[0][1]}\\\\${B[1][0]}&${B[1][1]}\\end{bmatrix}$.`,
        options: shuffle([c, w1, w2, w3]),
        correctAnswer: c,
        solution:
          "First compute $2A$ (multiply each element of $A$ by 2), then subtract $B$ element-wise.",
        difficulty_level: "Medium",
      });
    })();

    // Q3: Scalar multiplication 3A
    (() => {
      const A = [
        [rand(1, 4), rand(1, 4)],
        [rand(1, 4), rand(1, 4)],
      ...
      const c = `$\\begin{bmatrix}${R[0][0]}&${R[0][1]}\\\\${R[1][0]}&${R[1][1]}\\end{bmatrix}$`;
      const w1 = `$\\begin{bmatrix}${R[0][0] + 1}&${R[0][1]}\\\\${R[1][0]}&${R[1][1] - 1}\\end{bmatrix}$`;
      const w2 = `$\\begin{bmatrix}${A[0][0]}&${A[0][1]}\\\\${A[1][0]}&${A[1][1]}\\end{bmatrix}$`;
      const w3 = `$\\begin{bmatrix}${R[1][0]}&${R[1][1]}\\\\${R[0][0]}&${R[0][1]}\\end{bmatrix}$`;
      qs.push({
        text: `Find $3A$ where $A = \\begin{bmatrix}${A[0][0]}&${A[0][1]}\\\\${A[1][0]}&${A[1][1]}\\end{bmatrix}$.`,
        options: shuffle([c, w1, w2, w3]),
        correctAnswer: c,
        solution: "Multiply every element of $A$ by 3.",
        difficulty_level: "Easy",
      });
    })();

    // Q4: Matrix multiplication AB (2×2)
    (() => {
      const A = [
        [rand(1, 3), rand(1, 3)],
        [rand(1, 3), rand(1, 3)],
      ...
      const w1 = `$\\begin{bmatrix}${AB[0][0] + 1}&${AB[0][1]}\\\\${AB[1][0]}&${AB[1][1] + 1}\\end{bmatrix}$`;
      const w2 = `$\\begin{bmatrix}${A[0][0] * B[0][0]}&${A[0][1] * B[0][1]}\\\\${A[1][0] * B[1][0]}&${A[1][1] * B[1][1]}\\end{bmatrix}$`;
      const w3 = `$\\begin{bmatrix}${AB[1][0]}&${AB[1][1]}\\\\${AB[0][0]}&${AB[0][1]}\\end{bmatrix}$`;
      qs.push({
        text: `Compute $AB$ where $A = \\begin{bmatrix}${A[0][0]}&${A[0][1]}\\\\${A[1][0]}&${A[1][1]}\\end{bmatrix}$, $B = \\begin{bmatrix}${B[0][0]}&${B[0][1]}\\\\${B[1][0]}&${B[1][1]}\\end{bmatrix}$.`,
        options: shuffle([c, w1, w2, w3]),
        correctAnswer: c,
        solution:
          "$(AB)_{ij} = \\sum_k a_{ik}b_{kj}$. Use dot product of row $i$ of $A$ with column $j$ of $B$.",
    ...
    // Q5: Commutativity
    qs.push({
      text: "For matrices $A$ and $B$, is $AB = BA$ always true?",
      options: shuffle([
      ...
      correctAnswer: "No, matrix multiplication is generally not commutative",
      solution:
        "In general, $AB \\neq BA$. Matrix multiplication is not commutative.",
      difficulty_level: "Easy",
    });

    // Q6: Solve for X: 2A + 3X = 5B
    (() => {
      const A = [
        [rand(1, 3), rand(1, 3)],
        [rand(1, 3), rand(1, 3)],
      ...
      const xfrac = A.map((r, i) =>
        r.map((v, j) => {
          const n = 5 * B[i][j] - 2 * v;
          return n % 3 === 0 ? `${n / 3}` : `\\frac{${n}}{3}`;
        }),
      );
      const c = `$\\begin{bmatrix}${xfrac[0][0]}&${xfrac[0][1]}\\\\${xfrac[1][0]}&${xfrac[1][1]}\\end{bmatrix}$`;
      qs.push({
        text: `Find $X$ if $2A + 3X = 5B$, $A = \\begin{bmatrix}${A[0][0]}&${A[0][1]}\\\\${A[1][0]}&${A[1][1]}\\end{bmatrix}$, $B = \\begin{bmatrix}${B[0][0]}&${B[0][1]}\\\\${B[1][0]}&${B[1][1]}\\end{bmatrix}$.`,
        options: [
          c,
          `$\\begin{bmatrix}${B[0][0]}&${B[0][1]}\\\\${B[1][0]}&${B[1][1]}\\end{bmatrix}$`,
          `$\\begin{bmatrix}${A[0][0]}&${A[0][1]}\\\\${A[1][0]}&${A[1][1]}\\end{bmatrix}$`,
          "Not possible",
        ],
        correctAnswer: c,
        solution: "$3X = 5B - 2A \\Rightarrow X = \\frac{1}{3}(5B - 2A)$.",
        difficulty_level: "Hard",
      });
    })();

    // Q7: Additive identity
    qs.push({
      text: "The additive identity for matrix addition is:",
      options: shuffle([
        "Zero matrix $O$",
        "Identity matrix $I$",
        "The matrix itself",
      ...
      solution:
        "$A + O = A$ for any matrix $A$. So the zero matrix is the additive identity.",
      difficulty_level: "Easy",
    });

    // Q8: Verify associativity
    qs.push({
      text: "Matrix addition is associative, meaning:",
      options: shuffle([
        "$(A+B)+C = A+(B+C)$",
        "$A+B = B+A$",
        "$A(B+C) = AB+AC$",
    ...
    // Q9: Distributive property
    qs.push({
      text: "Which is the distributive property of matrix multiplication over addition?",
      options: shuffle([
        "$A(B+C) = AB + AC$",
        "$A+B = B+A$",
        "$(AB)C = A(BC)$",
      ...
      solution: "Multiplication distributes over addition: $A(B+C) = AB + AC$.",
      difficulty_level: "Medium",
    });

    // Q10: A × I = A
    qs.push({
      text: "For any square matrix $A$, $AI = $",
      options: shuffle(["$A$", "$I$", "$O$", "$A^2$"]),
      correctAnswer: "$A$",
      solution:
  ...
  if (questions.length === 0) return <div className="flex items-center justify-center min-h-screen">Loading Matrix Operations Test...</div>;
...
export default MatrixOperationsTest;
