...
const TILES = [
    { id: 'who', emoji: '👤', title: 'Who?', content: <><p>Placeholder content for Who: Cofactors</p></> },
    { id: 'what', emoji: '📖', title: 'What?', content: <><p>Placeholder content for What: Cofactors</p></> },
    { id: 'when', emoji: '⏰', title: 'When?', content: <><p>Placeholder content for When: Cofactors</p></> },
    { id: 'where', emoji: '📍', title: 'Where?', content: <><p>Placeholder content for Where: Cofactors</p></> },
    { id: 'why', emoji: '💡', title: 'Why?', content: <><p>Placeholder content for Why: Cofactors</p></> },
    { id: 'how', emoji: '🔧', title: 'How?', content: <><p>Placeholder content for How: Cofactors</p></> },
];
