...
const TILES = [
    { id: 'who', emoji: '👤', title: 'Who?', content: <><p>Placeholder content for Who: Collinearity of Points</p></> },
    { id: 'what', emoji: '📖', title: 'What?', content: <><p>Placeholder content for What: Collinearity of Points</p></> },
    { id: 'when', emoji: '⏰', title: 'When?', content: <><p>Placeholder content for When: Collinearity of Points</p></> },
    { id: 'where', emoji: '📍', title: 'Where?', content: <><p>Placeholder content for Where: Collinearity of Points</p></> },
    { id: 'why', emoji: '💡', title: 'Why?', content: <><p>Placeholder content for Why: Collinearity of Points</p></> },
    { id: 'how', emoji: '🔧', title: 'How?', content: <><p>Placeholder content for How: Collinearity of Points</p></> },
];

const Collinearity5W1H = () => {
...
export default Collinearity5W1H;