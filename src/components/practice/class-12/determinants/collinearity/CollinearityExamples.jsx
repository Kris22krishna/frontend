...
const EXAMPLES = [
    { id: 1, title: 'Example 1', question: <><p>Placeholder Question 1 for Collinearity of Points</p></>, steps: [<><InlineMath math="1 + 1 = 2" /></>], answer: <>Answer 1</> },
    { id: 2, title: 'Example 2', question: <><p>Placeholder Question 2 for Collinearity of Points</p></>, steps: [<><InlineMath math="1 + 2 = 3" /></>], answer: <>Answer 2</> },
    { id: 3, title: 'Example 3', question: <><p>Placeholder Question 3 for Collinearity of Points</p></>, steps: [<><InlineMath math="1 + 3 = 4" /></>], answer: <>Answer 3</> },
    { id: 4, title: 'Example 4', question: <><p>Placeholder Question 4 for Collinearity of Points</p></>, steps: [<><InlineMath math="1 + 4 = 5" /></>], answer: <>Answer 4</> },
    { id: 5, title: 'Example 5', question: <><p>Placeholder Question 5 for Collinearity of Points</p></>, steps: [<><InlineMath math="1 + 5 = 6" /></>], answer: <>Answer 5</> },
];

const CollinearityExamples = () => {
    ...
    return (
        <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg, #F8FAFF, #EEF2FF, #F5F3FF)', fontFamily: "'Inter', sans-serif", paddingBottom: 60 }}>
            <header style={{ background: 'linear-gradient(135deg, #0F172A, #1E293B)', padding: '32px 24px 40px', color: '#fff', textAlign: 'center', position: 'relative' }}>
                ...
                <h1 style={{ fontSize: 'clamp(1.4rem, 3vw, 1.8rem)', fontWeight: 800 }}>Collinearity of Points</h1>
...
export default CollinearityExamples;