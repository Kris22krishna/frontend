...
const TILES = [
    { id: 'who', emoji: '👤', title: 'Who?', content: <><p>Placeholder content for Who: Solving Systems (Inverse Matrix Method)</p></> },
    { id: 'what', emoji: '📖', title: 'What?', content: <><p>Placeholder content for What: Solving Systems (Inverse Matrix Method)</p></> },
    { id: 'when', emoji: '⏰', title: 'When?', content: <><p>Placeholder content for When: Solving Systems (Inverse Matrix Method)</p></> },
    { id: 'where', emoji: '📍', title: 'Where?', content: <><p>Placeholder content for Where: Solving Systems (Inverse Matrix Method)</p></> },
    { id: 'why', emoji: '💡', title: 'Why?', content: <><p>Placeholder content for Why: Solving Systems (Inverse Matrix Method)</p></> },
    { id: 'how', emoji: '🔧', title: 'How?', content: <><p>Placeholder content for How: Solving Systems (Inverse Matrix Method)</p></> },
];

const SolvingSystem5W1H = () => {
...
export default SolvingSystem5W1H;