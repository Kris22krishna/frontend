...
// We import the mascot from assets. Adjust the path based on location.
...
const SKILL_ID = 12100;
const SKILL_NAME = "Class 12 - Determinants - Chapter Test";

const DeterminantsTest = () => {
    ...
    const generateQuestions = () => {
        const pool = [
            {
                id: 1,
                text: "Evaluate the determinant: $\\begin{vmatrix} 2 & 4 \\\\ -1 & 2 \\end{vmatrix}$",
                options: ["$0$", "$8$", "$4$", "$-8$"],
                correctAnswer: "$8$",
                solution: "Using the formula $ad - bc$: $(2)(2) - (4)(-1) = 4 + 4 = 8$."
            },
            {
                id: 2,
                text: "Evaluate the determinant: $\\begin{vmatrix} \\cos\\theta & -\\sin\\theta \\\\ \\sin\\theta & \\cos\\theta \\end{vmatrix}$",
                options: ["$0$", "$1$", "$\\cos 2\\theta$", "$-1$"],
                correctAnswer: "$1$",
                solution: "$(\\cos\\theta)(\\cos\\theta) - (-\\sin\\theta)(\\sin\\theta) = \\cos^2\\theta + \\sin^2\\theta = 1$."
            },
            {
                id: 3,
                text: "If $\\begin{vmatrix} x & 2 \\\\ 18 & x \\end{vmatrix} = \\begin{vmatrix} 6 & 2 \\\\ 18 & 6 \\end{vmatrix}$, then $x$ is equal to:",
                options: ["$6$", "$\\pm 6$", "$-6$", "$0$"],
                correctAnswer: "$\\pm 6$",
                solution: "Left Hand Side: $x^2 - 36$. Right Hand Side: $36 - 36 = 0$. So $x^2 - 36 = 0$, which gives $x = \\pm 6$."
            },
            {
                id: 4,
                text: "Find area of triangle with vertices $(1,0), (6,0), (4,3)$ using determinants.",
                options: ["$7.5$ sq. units", "$15$ sq. units", "$8$ sq. units", "$9$ sq. units"],
                correctAnswer: "$7.5$ sq. units",
                solution: "Area $= \\frac{1}{2} |\\begin{vmatrix} 1 & 0 & 1 \\\\ 6 & 0 & 1 \\\\ 4 & 3 & 1 \\end{vmatrix}| = \\frac{1}{2} |1(0-3) - 0 + 1(18-0)| = \\frac{1}{2}|-3 + 18| = \\frac{15}{2} = 7.5$."
            },
            {
                id: 5,
                text: "For any square matrix $A$ of order 3, $|kA|$ is equal to:",
                options: ["$k|A|$", "$k^2|A|$", "$k^3|A|$", "$|A|$"],
                correctAnswer: "$k^3|A|$",
                solution: "If $A$ is a square matrix of order $n$, then $|kA| = k^n|A|$. Here order is 3, so $|kA| = k^3|A|$."
            },
            {
                id: 6,
                text: "Let $A$ be a non-singular square matrix of order $3 \\times 3$. Then $|adj A|$ is equal to:",
                options: ["$|A|$", "$|A|^2$", "$|A|^3$", "$3|A|$"],
                correctAnswer: "$|A|^2$",
                solution: "For a non-singular matrix of order $n$, $|adj A| = |A|^{n-1}$. For $n=3$, $|adj A| = |A|^{3-1} = |A|^2$."
            },
            {
                id: 7,
                text: "If $A$ is an invertible matrix of order 2, then $det(A^{-1})$ is equal to:",
                options: ["$det(A)$", "$\\frac{1}{det(A)}$", "$1$", "$0$"],
                correctAnswer: "$\\frac{1}{det(A)}$",
                solution: "By properties of determinants, $det(A^{-1}) = \\frac{1}{det(A)}$."
            },
            {
                id: 8,
                text: "Evaluate the determinant: $\\begin{vmatrix} a & h & g \\\\ h & b & f \\\\ g & f & c \\end{vmatrix}$",
                options: ["$abc + 2fgh - af^2 - bg^2 - ch^2$", "$abc - 2fgh + af^2 + bg^2 + ch^2$", "$abc - fgh$", "$abc$"],
                correctAnswer: "$abc + 2fgh - af^2 - bg^2 - ch^2$",
                solution: "Expanding along first row: $a(bc - f^2) - h(hc - fg) + g(hf - bg) \n= abc - af^2 - h^2c + hfg + ghf - bg^2 \n= abc + 2fgh - af^2 - bg^2 - ch^2$."
            }
        ];
...
export default DeterminantsTest;
