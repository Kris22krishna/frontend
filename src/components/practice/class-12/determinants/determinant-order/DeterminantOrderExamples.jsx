...
const EXAMPLES = [
    {
        id: 1,
        title: 'Evaluate a 2×2 determinant',
        question: <><p>Evaluate <InlineMath math={String.raw`\begin{vmatrix} 2 & 4 \\ -1 & 2 \end{vmatrix}`} /></p></>,
        steps: [
            <><InlineMath math="= 2 \times 2 - 4 \times (-1)" /></>,
            <><InlineMath math="= 4 - (-4) = 4 + 4" /></>,
        ],
        answer: <><InlineMath math="= 8" /></>,
    },
    {
        id: 2,
        title: 'Evaluate a 2×2 determinant with variable',
        question: <><p>Evaluate <InlineMath math={String.raw`\begin{vmatrix} x & x+1 \\ x-1 & x \end{vmatrix}`} /></p></>,
        steps: [
            <><InlineMath math="= x \cdot x - (x+1)(x-1)" /></>,
            <><InlineMath math="= x^2 - (x^2 - 1)" /></>,
            <><InlineMath math="= x^2 - x^2 + 1" /></>,
        ],
        answer: <><InlineMath math="= 1" /> (independent of <InlineMath math="x" />)</>,
    },
    {
        id: 3,
        title: 'Evaluate a 3×3 determinant (with zeros)',
        question: <><p>Evaluate <InlineMath math={String.raw`\begin{vmatrix} 1 & 2 & 4 \\ -1 & 3 & 0 \\ 4 & 1 & 0 \end{vmatrix}`} /></p></>,
        steps: [
            <>Expand along column 3 (has two zeros):</>,
            <><InlineMath math={String.raw`= 4 \cdot \begin{vmatrix} -1 & 3 \\ 4 & 1 \end{vmatrix} \cdot (-1)^{1+3}`} /></>,
            <><InlineMath math="= 4 \cdot [(-1)(1) - (3)(4)]" /></>,
            <><InlineMath math="= 4 \cdot (-1 - 12) = 4 \times (-13)" /></>,
        ],
        answer: <><InlineMath math="= -52" /></>,
    },
    {
        id: 4,
        title: 'Diagonal matrix determinant',
        question: <><p>Evaluate <InlineMath math={String.raw`\begin{vmatrix} 3 & 0 & 0 \\ 0 & 5 & 0 \\ 0 & 0 & 2 \end{vmatrix}`} /></p></>,
        steps: [
            <>For a diagonal matrix, the determinant is the product of diagonal entries.</>,
            <><InlineMath math="= 3 \times 5 \times 2" /></>,
        ],
        answer: <><InlineMath math="= 30" /></>,
    },
    {
        id: 5,
        title: 'Skew-symmetric matrix of odd order',
        question: <><p>Evaluate <InlineMath math={String.raw`\begin{vmatrix} 0 & \sin\alpha & -\cos\alpha \\ -\sin\alpha & 0 & \sin\beta \\ \cos\alpha & -\sin\beta & 0 \end{vmatrix}`} /></p></>,
        steps: [
            <>Observe that this is a skew-symmetric matrix (<InlineMath math="A^T = -A" />).</>,
            <>For any skew-symmetric matrix of <strong>odd order</strong>, the determinant is always zero.</>,
            <>This is because <InlineMath math={String.raw`|A| = |A^T| = |-A| = (-1)^n |A|`} />. For odd <InlineMath math="n" />, <InlineMath math="|A| = -|A|" />, so <InlineMath math="2|A| = 0" />.</>,
        ],
        answer: <><InlineMath math="= 0" /></>,
    },
];

const DeterminantOrderExamples = () => {
...
export default DeterminantOrderExamples;
