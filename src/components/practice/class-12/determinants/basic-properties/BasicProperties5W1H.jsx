...
const TILES = [
    { id: 'who', emoji: '👤', title: 'Who?', content: <><p>Placeholder content for Who: Basic Properties (Row / Column Ops)</p></> },
    { id: 'what', emoji: '📖', title: 'What?', content: <><p>Placeholder content for What: Basic Properties (Row / Column Ops)</p></> },
    { id: 'when', emoji: '⏰', title: 'When?', content: <><p>Placeholder content for When: Basic Properties (Row / Column Ops)</p></> },
    { id: 'where', emoji: '📍', title: 'Where?', content: <><p>Placeholder content for Where: Basic Properties (Row / Column Ops)</p></> },
    { id: 'why', emoji: '💡', title: 'Why?', content: <><p>Placeholder content for Why: Basic Properties (Row / Column Ops)</p></> },
    { id: 'how', emoji: '🔧', title: 'How?', content: <><p>Placeholder content for How: Basic Properties (Row / Column Ops)</p></> },
];

const BasicProperties5W1H = () => {
...
export default BasicProperties5W1H;