...
const SKILL_ID = 12302;
const SKILL_NAME = "Expansion along Row / Column";
const TOTAL_QUESTIONS = 10;

const ExpansionRowColumnPractice = () => {
    ...
    const generateQuestion = (index) => {
        let q = { text: "<div class='question-container'><p>Sample question for Expansion along Row / Column</p></div>", correctAnswer: "$1$", solution: "Sample solution", options: ["$1$", "$2$", "$3$", "$4$"] };
            ...
            <footer className="junior-bottom-bar">
                <div className="desktop-footer-controls">
                    ...
                    <div className="bottom-center" style={{display:'flex',gap:'8px',alignItems:'center'}}>
                        ...
                        {!isSubmitted ? (
                            <>
                                <button className="bg-indigo-50 text-indigo-600 px-4 py-2 rounded-xl border-2 border-indigo-100 font-bold hover:bg-indigo-100 transition-colors flex items-center gap-2 text-sm" onClick={()=>navigate('/senior/grade/12/determinants/expansion-row-column/5w1h')}><BookOpen size={16}/> Learn 5W1H</button>
                                <button className="bg-amber-50 text-amber-600 px-4 py-2 rounded-xl border-2 border-amber-100 font-bold hover:bg-amber-100 transition-colors flex items-center gap-2 text-sm" onClick={()=>navigate('/senior/grade/12/determinants/expansion-row-column/examples')}><Lightbulb size={16}/> Learn by Example</button>
                            </>
                        ) : (
...
export default ExpansionRowColumnPractice;