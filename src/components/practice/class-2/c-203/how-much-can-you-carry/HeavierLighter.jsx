...
const DynamicVisual = ({ data }) => {
    ...
    const renderSVG = (type) => {
        switch (type) {
            case 'Pumpkin': return <span style={{ fontSize: '50px' }}>🎃</span>;
            case 'Feather': return <span style={{ fontSize: '50px' }}>🪶</span>;
            default: return null;
        }
    };
    ...
    return (
        <div style={{ display: 'flex', justifyContent: 'center', gap: '80px', width: '100%', padding: '40px', background: 'white', borderRadius: '30px', boxShadow: '0 10px 25px rgba(0,0,0,0.05)' }}>
            <motion.div whileHover={{ scale: 1.05 }} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '15px' }}>
                ...
                <span style={{ fontWeight: 800, color: '#0369a1', fontSize: '1.2rem' }}>{objectA.name}</span>
            </motion.div>
            ...
            <motion.div whileHover={{ scale: 1.05 }} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '15px' }}>
                ...
                <span style={{ fontWeight: 800, color: '#0369a1', fontSize: '1.2rem' }}>{objectB.name}</span>
            </motion.div>
        </div>
    );
};
    ...
    if (showResults) {
        ...
        return (
            <div className="grade1-practice-page results-view overflow-y-auto">
                ...
                <main className="results-content" style={{ marginTop: '20px' }}>
