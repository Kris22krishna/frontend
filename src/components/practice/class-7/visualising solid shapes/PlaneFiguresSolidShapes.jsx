...
const PlaneFiguresSolidShapes = () => {
    ...
    useEffect(() => {
        ...
        startSession({ nodeId: 'a4071015-0001-0000-0000-000000000000', sessionType: 'practice' });
                            ...
                            <div className="c7-interaction-area">
                                <div className="c7-options-grid">
                                    {currentQuestion.options.map((option, idx) => (
                                        <button key={idx}
                                            className={`c7-option-btn ${selectedOption === option ? 'selected' : ''} ${isSubmitted && option === currentQuestion.correctAnswer ? 'correct' : ''} ${isSubmitted && selectedOption === option && !isCorrect ? 'wrong' : ''}`}
