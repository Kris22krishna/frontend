...
const SKILL_ID = "07103";
const SKILL_NAME = "SimpleEquations - Hard Test";

export default function SimpleEquationsHardTest() {
    ...
    const generateQuestions = () => {
        let pool = [];
        // Pull primarily from assessment
        SKILLS.forEach(s => {
        ...
        // Pick 20 random for Hard Test
        return formattedPool.sort(() => Math.random() - 0.5).slice(0, 20);
    };
