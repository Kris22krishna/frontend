...
} from '../../Topics/Skills/fractionsAndDecimalsQuestions';
...
const SKILL_ID = "07202";
const SKILL_NAME = "Fractions & Decimals - Medium Test";

export default function FractionsAndDecimalsMediumTest() {
    ...
    if (isTestOver) {
        ...
        return (
            <div className="frac-practice-page grey-selection-theme p-4 md:p-8" style={{ background: '#F8FAFC', minHeight: '100vh', overflowY: 'auto' }}>
                ...
                <div className="exam-report-container mx-auto p-4 md:p-8 my-4 md:my-8">
                    ...
                    <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', marginBottom: '3rem' }}>
                        ...
                        <button onClick={() => navigate('/middle/grade/7/fractions-and-decimals')} className="bg-white text-[#31326F] border-2 border-[#31326F] px-8 py-3 rounded-2xl font-black uppercase tracking-wider hover:bg-[#31326F] hover:text-white transition-colors shadow-sm">Back to Chapter</button>
                    </div>
    ...
    return (
        <div className="frac-practice-page grey-selection-theme" style={{ fontFamily: '"Open Sans", sans-serif', height: '100vh', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
            <style>{BLUE_THEME_CSS}</style>
            <header className="frac-practice-header" style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1fr) auto minmax(0, 1fr)', alignItems: 'center', padding: '0 2rem', gap: '1rem' }}>
            ...
            <footer className="frac-bottom-bar" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '1rem 2rem', background: 'white', borderTop: '1px solid #E2E8F0', position: 'fixed', bottom: 0, left: 0, right: 0, zIndex: 10 }}>
                <div className="desktop-footer-controls" style={{ display: 'flex', justifyContent: 'space-between', width: '100%' }}>
                    <div className="bottom-left">
                        <button className="bg-red-50 text-red-500 px-6 py-2 rounded-xl border-2 border-red-100 font-bold hover:bg-red-100" onClick={() => navigate('/middle/grade/7/fractions-and-decimals')}>Exit Test</button>
                    </div>
                    <div className="bottom-right">
                        <div style={{ display: 'flex', gap: '1.5rem' }}>
                            <button className="nav-pill-next-btn nav-pastel-btn" onClick={handlePrev} disabled={qIndex === 0} style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', padding: '0.5rem 1rem', borderRadius: '8px' }}>
                                <ChevronLeft size={20} /> Previous
                            </button>
                            <button className="nav-pill-next-btn nav-pastel-btn" onClick={handleNext} style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', padding: '0.5rem 1rem', borderRadius: '8px' }}>
