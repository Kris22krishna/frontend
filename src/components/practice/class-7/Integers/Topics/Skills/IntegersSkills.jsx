            ...
            <div className="int-skills-page" style={{ background: '#f8fafc', minHeight: '100vh', paddingBottom: '60px' }}>
                <nav className="int-intro-nav">
                    ...
                    <div className="int-intro-nav-links">
                        <button className="int-intro-nav-link" onClick={() => navigate('/middle/grade/7/integers/introduction')}>🌟 Intro</button>
                        <button className="int-intro-nav-link" onClick={() => navigate('/middle/grade/7/integers/terminology')}>📖 Terminology</button>
            ...
            <div className="int-lexicon-container" style={{ padding: '20px 24px 80px' }}>
                ...
                <div style={{ textAlign: 'center', marginBottom: 40 }}>
                    <h1 style={{ fontFamily: 'Outfit, sans-serif', fontSize: '2.8rem', fontWeight: 900, color: 'var(--int-text)', margin: '0 0 8px' }}>
                        Integers <span style={{ background: 'linear-gradient(135deg, var(--int-blue), var(--int-teal))', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Skills</span>
                    </h1>
