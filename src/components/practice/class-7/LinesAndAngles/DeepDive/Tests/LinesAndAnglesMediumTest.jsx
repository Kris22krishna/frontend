...
import { SKILLS } from '../../Topics/Skills/LinesAndAnglesSkillsData.js';
...
const SKILL_NAME = "LinesAndAngles - Medium Test";
            ...
            <div className="junior-practice-page grey-selection-theme p-4 md:p-8" style={{ background: '#F8FAFC', minHeight: '100vh', overflowY: 'auto' }}>
                ...
                <div className="exam-report-container mx-auto p-4 md:p-8 my-4 md:my-8">
                    ...
                    <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', marginBottom: '3rem' }}>
                        ...
                        <button onClick={() => navigate('/middle/grade/7/lines-and-angles')} className="bg-white text-[#31326F] border-2 border-[#31326F] px-8 py-3 rounded-2xl font-black uppercase tracking-wider hover:bg-[#31326F] hover:text-white transition-colors shadow-sm">Back to Chapter</button>
                    </div>
            ...
            <footer className="junior-bottom-bar">
                <div className="desktop-footer-controls">
                    <div className="bottom-left">
                        <button className="bg-red-50 text-red-500 px-6 py-2 rounded-xl border-2 border-red-100 font-bold hover:bg-red-100" onClick={() => navigate('/middle/grade/7/lines-and-angles')}>Exit Test</button>
                    </div>
