...
import { SKILLS } from './LinesAndAnglesSkillsData.js';
...
export default function LinesAndAnglesSkills() {
    ...
    if (view !== 'list' && skill) {
        return (
            <div className="la-skills-page" style={{ background: '#f8fafc', minHeight: '100vh', paddingBottom: '60px' }}>
                ...
                <div style={{ padding: '40px 24px 0' }}>
                    {view === 'learn' ? (
                        <div className="la-lexicon-container">
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: 'minmax(260px, 300px) 1fr', gap: 24, alignItems: 'start', maxWidth: 1100, margin: '0 auto' }}>
                                ...
                                {/* Detailed Window */}
                                <main className="la-details-window-anim" key={selectedLearnIdx} style={{ background: '#fff', borderRadius: 24, padding: 32, border: '1px solid #e2e8f0', minHeight: 400 }}>
    ...
    return (
        <div className="la-skills-page" style={{ background: '#f8fafc', minHeight: '100vh', paddingBottom: '60px' }}>
            ...
            {/* ── MAIN CONTENT ──────────────────────────────── */}
            <div className="la-lexicon-container" style={{ padding: '40px 24px 80px', maxWidth: 1000, margin: '0 auto' }}>

                {/* Centered Heading */}
                <div style={{ textAlign: 'center', marginBottom: 40 }}>
                    <h1 style={{ fontFamily: 'Outfit, sans-serif', fontSize: '2.8rem', fontWeight: 900, color: '#0f172a', margin: '0 0 8px' }}>
                        Lines and Angles <span style={{ color: '#10b981' }}>Skills</span>
                    </h1>
                ...
                <div className="la-skills-grid">
                    {SKILLS.map((s, i) => (
                        <div key={s.id} className="la-skill-card" style={{ '--skill-color': s.color }}>
                            <div className="la-skill-icon" style={{ background: `${s.color}10`, color: s.color }}>
                                {s.icon}
                            </div>

                            <div className="la-skill-content">
                                <div className="la-skill-text-stack">
                            ...
                            <div className="la-skill-actions">
                                <button className="la-skill-btn-outline" onClick={() => { setActiveSkill(i); setView('learn'); }}>Learn</button>
                                <button className="la-skill-btn-outline" onClick={() => { setActiveSkill(i); setView('practice'); }}>Practice</button>
                                <button className="la-skill-btn-filled" onClick={() => { setActiveSkill(i); setView('assessment'); }}>Assess</button>
                            </div>
                        </div>
                    ))}
                </div>
