...
import { linIneqIntroData } from "./LinIneqIntroData";
        ...
        {open && (
          <div className="mat-intro-card-body">
            ...
            <div className="mat-intro-card-fact">
              <span style={{ color: card.gradFrom, fontWeight: 800 }}>
                💡 Fun Fact:{" "}
              </span>
...
export default function LinIneqIntro5W1H() {
  ...
  const navLinks = [
    { path: `${BASE}/introduction`, label: "🌟 Introduction", active: true },
    { path: `${BASE}/terminology`, label: "📖 Terminology", active: false },
    { path: `${BASE}/skills`, label: "🎯 Skills", active: false },
    { path: `${BASE}/connectomics`, label: "🌐 Connectomics", active: false },
    { path: `${BASE}/exam-edge`, label: "⚔️ Exam Edge", active: false },
  ];
    ...
    <div className="mat-page">
      <nav className="mat-nav">
        ...
        <div className="sets-nav-links" style={{ display: "flex", gap: "8px" }}>
          {navLinks.map(({ path, label, active }) => (
            <button
              key={path}
              className={`sets-nav-link${active ? " active" : ""}`}
              style={
                active
                  ? {
                      padding: "8px 18px",
      ...
      >
        ...
        <div className="det-intro-hero-inner">
          <h1 className="det-intro-hero-title">
            Discover Linear Inequalities Through{" "}
      ...
      >
        <section style={{ marginBottom: "60px" }}>
          ...
          >
            {linIneqIntroData.prerequisites.map((p, idx) => (
              <div
                key={idx}
                style={{
                  background: "#fff",
        ...
        <div className="mat-intro-grid">
          {linIneqIntroData.cards5W1H.map((card, idx) => (
        ...
        >
          <div>
            ...
            <p style={{ margin: 0, opacity: 0.8 }}>
              Next up: 12 key terms and the 6 golden rules of Linear
              Inequalities.
            </p>
          </div>
          <button
