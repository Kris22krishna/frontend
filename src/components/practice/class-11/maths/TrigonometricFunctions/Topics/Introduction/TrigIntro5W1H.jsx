...
import { trigIntroData } from "./TrigIntroData";
  ...
  return (
    ...
    >
      ...
      <div className="mat-intro-card-main">
        ...
        {!open && (
          <div style={{ color: "#94a3b8", fontSize: "13px", fontWeight: 600, marginTop: "-8px", paddingLeft: "90px", paddingBottom: "24px" }}>
            Tap to explore →
          </div>
        )}
...
export default function TrigIntro5W1H() {
  ...
  return (
    <div className="mat-page">
      <nav className="mat-nav">
        ...
        <div className="sets-nav-links" style={{ display: "flex", gap: "8px", flexWrap: "wrap" }}>
          <button
      ...
      <div className="det-intro-hero" style={{ padding: "16px 24px 20px" }}>
        ...
        <div className="det-intro-hero-inner">
          <h1 className="det-intro-hero-title">
            Discover Trigonometric Functions Through{" "}
      ...
      <main style={{ maxWidth: "1200px", margin: "0 auto", padding: "40px 24px" }}>
        <section style={{ marginBottom: "60px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "24px" }}>
            {trigIntroData.prerequisites.map((p, idx) => (
        ...
        <div className="mat-intro-grid">
          {trigIntroData.cards5W1H.map((card, idx) => (
        ...
        >
          <div>
            <h3 style={{ fontSize: "20px", fontWeight: 800, margin: "0 0 4px" }}>Ready to learn the language of waves?</h3>
            <p style={{ margin: 0, opacity: 0.8 }}>Next up: 12 key terms and the 6 golden rules of Trigonometry.</p>
          </div>
          <button
