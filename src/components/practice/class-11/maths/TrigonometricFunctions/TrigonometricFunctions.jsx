...
const MODULES = [
  {
    ...
    desc: "6 big questions about Trigonometric Functions — what, why, who, when, where and how.",
    color: "#0891b2",
  },
  {
    id: "terminology",
    ...
    desc: "Master angles, radians, sin/cos/tan, identities, and the golden rules of Trigonometry.",
    color: "#7c3aed",
  },
  {
    id: "skills",
    ...
    desc: "6 core skills with Learn, Practice (20 Qs + Previous), and Assess (timed + palette + report) modes.",
    color: "#0369a1",
  },
  {
    id: "connectomics",
    ...
    icon: Network,
    tagline: "Big Picture",
    desc: "See how Trigonometric Functions connect to waves, astronomy, engineering, and real-world science.",
    color: "#d97706",
  },
  {
    id: "exam-edge",
    ...
    label: "Exam Edge",
    icon: Trophy,
    tagline: "CET · JEE Mains · JEE Advanced",
    desc: "Exam patterns, formula sheet, high-yield topics, and PYQ practice for all competitive exams.",
    color: "#ef4444",
  },
];

const STATS = [
  { label: "Core Topics", num: "6", color: "#6366f1" },
  { label: "Practice Skills", num: "6", color: "#0d9488" },
  { label: "Question Bank", num: "240+", color: "#7c3aed" },
      ...
      <div className="mat-left">
        ...
        <div className="mat-left-content">
          ...
          <h1 className="mat-main-title">
            Master
            <br />
            <span className="mat-title-accent">Trigonometric Functions</span>
          </h1>

          <p className="mat-main-sub">
            From angles and radians to sum-difference formulas and trigonometric
            equations — master Trig the way it was meant to be taught.
          </p>
