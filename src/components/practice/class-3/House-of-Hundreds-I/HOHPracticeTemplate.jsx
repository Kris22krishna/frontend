...
const SKILL_ID_MAP = {
  'HOH-01': NODE_IDS.g3MathHOHCountingBeyond200,
  'HOH-02': NODE_IDS.g3MathHOHNumberSequences,
  'HOH-03': NODE_IDS.g3MathHOHNumberRepresentation,
  'HOH-04': NODE_IDS.g3MathHOHNumberLine,
  'HOH-05': NODE_IDS.g3MathHOHNumberGamesPatterns,
  'HOH-06': NODE_IDS.g3MathHOHLargeNumbersContext,
  'HOH-07': NODE_IDS.g3MathHOHNumberGrid,
  'HOH-08': NODE_IDS.g3MathHOHPlaceValueHTO,
  'HOH-09': NODE_IDS.g3MathHOHPatternsGroups,
  'HOH-10': NODE_IDS.g3MathHOHNumberHuntGames,
  'HOH-11': NODE_IDS.g3MathHOHComparingNumbers,
};

const TOTAL_QUESTIONS = 5;
const TOPIC_URL = encodeURIComponent('House of Hundreds I');

const HOHPracticeTemplate = ({ skillId, skillName, questions, questionMeta, logicProps }) => {
  ...
  useEffect(() => {
    const nodeId = SKILL_ID_MAP[skillId] || NODE_IDS.g3MathHouseOfHundreds;
    ...
    return (
      <div className="grade1-practice-page results-view overflow-y-auto">
        ...
        <header className="results-header">
          <h1 className="results-title">Hundreds Explorer Report</h1>
        ...
        <main className="results-content">
          <div className="results-hero-section">
            ...
            <h2 style={{ fontSize: '2.5rem', color: '#31326F', fontFamily: 'Nunito, sans-serif' }}>House of Hundreds Complete! 🏠</h2>
...
export default HOHPracticeTemplate;
