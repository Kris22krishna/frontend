...
const SKILL_ID_MAP = {
    'WIN-01': NODE_IDS.g3MathWINTallyReading,
    'WIN-02': NODE_IDS.g3MathWINTallyMaking,
    'WIN-03': NODE_IDS.g3MathWINTallyMissing,
    'WIN-04': NODE_IDS.g3MathWINCountingLetters,
    'WIN-05': NODE_IDS.g3MathWINLongestShortest,
    'WIN-06': NODE_IDS.g3MathWINNumberNames,
    'WIN-07': NODE_IDS.g3MathWINNumberPuzzles,
    'WIN-08': NODE_IDS.g3MathWINGrouping,
    'WIN-09': NODE_IDS.g3MathWINDataCollection,
};

const TOTAL_QUESTIONS = 5;
const TOPIC_URL = encodeURIComponent("What's in a Name?");

const WINPracticeTemplate = ({ skillId, skillName, questions, questionMeta, logicProps }) => {
    ...
    useEffect(() => {
        const nodeId = SKILL_ID_MAP[skillId] || NODE_IDS.g3MathWIN;
...
export default WINPracticeTemplate;
