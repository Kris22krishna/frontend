...
const SKILL_ID_MAP = {
  'DC-01': NODE_IDS.g3MathDCCounting,
  'DC-02': NODE_IDS.g3MathDCNumberBoard,
  'DC-03': NODE_IDS.g3MathDCBeforeAfter,
  'DC-04': NODE_IDS.g3MathDCMaking100,
  'DC-05': NODE_IDS.g3MathDCNumbers101to150,
  'DC-06': NODE_IDS.g3MathDCPlaceValue,
  'DC-07': NODE_IDS.g3MathDCNumbers150to200,
  'DC-08': NODE_IDS.g3MathDCJumpingGame,
};

const TOTAL_QUESTIONS = 5;
const TOPIC_URL = encodeURIComponent('Double Century');

const DCPracticeTemplate = ({ skillId, skillName, questions, questionMeta, logicProps }) => {
  ...
  useEffect(() => {
    const nodeId = SKILL_ID_MAP[skillId] || NODE_IDS.g3MathDC;
...
export default DCPracticeTemplate;
