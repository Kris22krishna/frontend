...
const SKILL_ID_MAP = {
  'FWS-01': NODE_IDS.g3MathFWSRecognisingShapes,
  'FWS-02': NODE_IDS.g3MathFWSFlatShapes,
  'FWS-03': NODE_IDS.g3MathFWSRectangles,
  'FWS-04': NODE_IDS.g3MathFWSSquares,
  'FWS-05': NODE_IDS.g3MathFWSCorners,
  'FWS-06': NODE_IDS.g3MathFWSTriangles,
  'FWS-07': NODE_IDS.g3MathFWSCircles,
  'FWS-08': NODE_IDS.g3MathFWSCompositeShapes,
  'FWS-09': NODE_IDS.g3MathFWSLinesTangram,
};

const TOTAL_QUESTIONS = 5;
const TOPIC_URL = encodeURIComponent('Fun with Shapes');

const FWSPracticeTemplate = ({ skillId, skillName, questions, questionMeta, logicProps }) => {
  ...
  useEffect(() => {
    const nodeId = SKILL_ID_MAP[skillId] || NODE_IDS.g3MathFunWithShapes;
    ...
    return (
      <div className="grade1-practice-page results-view overflow-y-auto">
        ...
        <header className="results-header">
          <h1 className="results-title">Shape Explorer Report</h1>
        ...
        <main className="results-content">
          <div className="results-hero-section">
            ...
            <h2 style={{ fontSize: '2.5rem', color: '#31326F', fontFamily: 'Nunito, sans-serif' }}>Shape Safari Complete! 🎉</h2>
...
export default FWSPracticeTemplate;
