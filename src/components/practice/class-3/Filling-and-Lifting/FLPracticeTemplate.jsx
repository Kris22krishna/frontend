...
const SKILL_ID_MAP = {
  'FL-01': NODE_IDS.g3MathFLComparingCapacity,
  'FL-02': NODE_IDS.g3MathFLEstimatingCapacity,
  'FL-03': NODE_IDS.g3MathFLMeasuringByFilling,
  'FL-04': NODE_IDS.g3MathFLLitre,
  'FL-05': NODE_IDS.g3MathFLHeavyAndLight,
  'FL-06': NODE_IDS.g3MathFLBalance,
  'FL-07': NODE_IDS.g3MathFLKilogram,
  'FL-08': NODE_IDS.g3MathFLHalfQuarterKg,
  'FL-09': NODE_IDS.g3MathFLWeightPuzzles,
};

const TOTAL_QUESTIONS = 5;
const TOPIC_URL = encodeURIComponent('Filling and Lifting');

const FLPracticeTemplate = ({ skillId, skillName, questions, questionMeta, logicProps }) => {
  ...
  useEffect(() => {
    const nodeId = SKILL_ID_MAP[skillId] || NODE_IDS.g3MathFL;
...
export default FLPracticeTemplate;
