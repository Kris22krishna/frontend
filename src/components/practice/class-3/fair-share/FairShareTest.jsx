...
import '../../../../pages/juniors/grade3/fair-sharetest.css';
...
const FairShareTest = () => {
    ...
    const generateQuestions = () => { const qs = []; for (let i = 1; i <= 20; i++) { if (i <= 5) { qs.push({ id: i, text: 'What is half of ' + (i * 4) + ' apples?', options: ['' + (i * 2), '' + (i * 3), '' + (i * 4), '' + i], correctAnswer: '' + (i * 2), solution: 'Half means dividing by 2. ' + (i * 4) + ' / 2 = ' + (i * 2) + '.' }); } else if (i <= 10) { qs.push({ id: i, text: 'Double of ' + (i + 5) + ' is?', options: ['' + ((i + 5) * 2), '' + ((i + 5) * 2 - 1), '' + ((i + 5) * 2 + 1), '' + (i + 8)], correctAnswer: '' + ((i + 5) * 2), solution: 'Double means multiplying by 2. ' + (i + 5) + ' * 2 = ' + ((i + 5) * 2) + '.' }); } else if (i <= 15) { qs.push({ id: i, text: 'If you share ' + (i * 3) + ' candies among 3 children equally, how many does each get?', options: ['' + i, '' + (i + 1), '' + (i + 2), '' + (i - 1)], correctAnswer: '' + i, solution: 'Dividing ' + (i * 3) + ' by 3 gives ' + i + '.' }); } else { qs.push({ id: i, text: 'Guess the number: I am double of ' + i + ' and half of ' + (i * 4) + '.', options: ['' + (i * 2), '' + (i * 3), '' + i, '' + (i * 4)], correctAnswer: '' + (i * 2), solution: 'Double of ' + i + ' is ' + (i * 2) + '. Half of ' + (i * 4) + ' is ' + (i * 2) + '.' }); } } return qs; };
    useEffect(() => {
