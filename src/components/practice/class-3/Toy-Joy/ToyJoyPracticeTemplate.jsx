            ...
            <div className="grade1-practice-page results-view overflow-y-auto">
                ...
                <header className="results-header">
                    ...
                    <div className="exit-container">
                        <StickerExit onClick={() => navigate('/junior/grade/3/topic/Toy%20Joy')} />
                    </div>
                </header>
                <main className="results-content">
                    ...
                    <div className="results-actions">
                        ...
                        <button className="action-btn-large back-topics-btn" onClick={() => navigate('/junior/grade/3/topic/Toy%20Joy')}><FileText size={24} /> Back to Skills</button>
                    </div>
                </main>
            </div>
        );
        ...
        <div className="grade1-practice-page">
            ...
            <div className="g1-practice-container">
                <div className="g1-header-nav">
                    ...
                    <div className="exit-practice-sticker"><StickerExit onClick={() => navigate('/junior/grade/3/topic/Toy%20Joy')} /></div>
                </div>

                <div className="g1-topic-header-compact" style={{ textAlign: 'center', margin: '10px 0', fontSize: '0.9rem', color: '#64748B', textTransform: 'uppercase', letterSpacing: '2px' }}>{skillName}</div>
...
export default ToyJoyPracticeTemplate;
