...
const SKILL_ID_MAP = {
  'VN-01': NODE_IDS.g3MathVNAdditionSubtractionFacts,
  'VN-02': NODE_IDS.g3MathVNAdditionSubtractionTensFrame,
  'VN-03': NODE_IDS.g3MathVNNumberLineJumps,
  'VN-04': NODE_IDS.g3MathVNNumberGridOperations,
  'VN-05': NODE_IDS.g3MathVNPatternsMagicSquares,
  'VN-06': NODE_IDS.g3MathVNStoryBasedAddSub,
  'VN-07': NODE_IDS.g3MathVNBoxDiagramMethod,
  'VN-08': NODE_IDS.g3MathVNEstimationAround100,
  'VN-09': NODE_IDS.g3MathVNOpenNumberLine,
};

const TOTAL_QUESTIONS = 5;
const TOPIC_URL = encodeURIComponent('Vacation with My Nani Maa');

const VNPracticeTemplate = ({ skillId, skillName, questions, questionMeta, logicProps }) => {
  ...
  useEffect(() => {
    const nodeId = SKILL_ID_MAP[skillId] || NODE_IDS.g3MathVN;
      ...
      <div className="grade1-practice-page results-view overflow-y-auto">
        ...
        <main className="results-content">
          <div className="results-hero-section">
            ...
            <h2 style={{ fontSize: '2.5rem', color: '#31326F', fontFamily: 'Nunito, sans-serif' }}>Quest Complete! 🎉</h2>
...
export default VNPracticeTemplate;
