...
const NODE_ID = 'a4041011-0003-0000-0000-000000000000';
const randomInt = (min, max) => Math.floor(Math.random() * (max - min + 1)) + min;

const CORRECT_MESSAGES = [
    "✨ Perfect grouping! ✨",
    "🌟 You got the group logic! 🌟",
    "🎉 Awesome! Total-ly correct! 🎉",
    "✨ Great counting! ✨",
    "🚀 Super! Multiplication master! 🚀",
    "🌿 Nice work! All groups accounted for! 🌿",
    "🎊 Correct! 🎊",
    "💎 Spot on! 💎"
];
  ...
  useEffect(() => {
    ...
    useEffect(() => {
      ...
      v4IsFinishedRef.current = false; setSessionId(sess.session_id);
        ...
        const questions = [];
        const themes = [
            { emoji: '🍎', container: 'box', name: 'apples' },
            { emoji: '⭐', container: 'cloud', name: 'stars' },
            { emoji: '🍪', container: 'circle', name: 'cookies' },
            { emoji: '🐠', container: 'circle', name: 'fish' },
            { emoji: '🐞', container: 'cloud', name: 'bugs' }
        ];
