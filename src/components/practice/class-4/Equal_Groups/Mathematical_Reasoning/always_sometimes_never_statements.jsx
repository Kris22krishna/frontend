...
import { RefreshCw, Check, Eye, ChevronRight, ChevronLeft, X, Star, AlertTriangle, Zap } from 'lucide-react';
...
const NODE_ID = 'a4041011-0016-0000-0000-000000000000';
...
const AlwaysSometimesNeverStatements = () => {
  ...
  useEffect(() => {
    ...
    const SKILL_ID = 1158;
    const SKILL_NAME = "Equal Groups - Always, Sometimes, Never";
    ...
    useEffect(() => {
      ...
      v4IsFinishedRef.current = false; setSessionId(sess.session_id);
        ...
        // Define the pool of questions
        const questionPool = [
            {
                text: "When you multiply two numbers, the answer is bigger than the numbers you started with.",
                correctAnswer: "Sometimes",
                solution: "It is <strong>Usually</strong> true, but not always.<br/>Example: $5 \\times 1 = 5$ (not bigger).<br/>Example: $5 \\times 0 = 0$ (smaller)."
            },
            {
                text: "When you multiply a number by 0, the answer is 0.",
                correctAnswer: "Always",
                solution: "Any number multiplied by 0 is 0.<br/>$5 \\times 0 = 0$, $100 \\times 0 = 0$."
            },
            {
                text: "When you divide a number by itself, the answer is 1.",
                correctAnswer: "Sometimes", // Because of 0
                solution: "$5 \\div 5 = 1$, but we cannot divide $0$ by $0$.<br/>So it is true for all non-zero numbers."
            },
            {
                text: "If you change the order of numbers in division, the answer stays the same.",
                correctAnswer: "Never",
                solution: "Order matters in division!<br/>$10 \\div 2 = 5$, but $2 \\div 10$ is a fraction (not 5)."
            },
            {
                text: "An even number divided by 2 gives an even number.",
                correctAnswer: "Sometimes",
                solution: "$8 \\div 2 = 4$ (Even).<br/>But $6 \\div 2 = 3$ (Odd)."
            },
            {
                text: "Multiplying two odd numbers gives an odd answer.",
                correctAnswer: "Always",
                solution: "$3 \\times 3 = 9$, $5 \\times 3 = 15$.<br/>Odd $\\times$ Odd is Always Odd."
            },
            {
                text: "A number divided by 1 is that same number.",
                correctAnswer: "Always",
                solution: "$5 \\div 1 = 5$, $100 \\div 1 = 100$."
            },
            {
                text: "You can divide a number by 0.",
                correctAnswer: "Never",
                solution: "Division by zero is impossible in math!"
            },
            {
                text: "If you double a number, the answer is even.",
                correctAnswer: "Always",
                solution: "Doubling means multiplying by 2.<br/>Any number multiplied by 2 is even."
            },
            {
                text: "The remainder in division is smaller than the divisor.",
                correctAnswer: "Always",
                solution: "If the remainder were equal to or bigger than the divisor, we could make another group!"
            }
        ];

        // Shuffle and pick 10 (though we only have 10 here, so just shuffle order)
    ...
    const recordQuestionAttempt = async (question, selected, isCorrect) => {
        ...
        try {
            await api.recordAttempt({
                ...
                skill_id: SKILL_ID,
                template_id: null,
                difficulty_level: 'Medium', // Logic questions are generally medium cognitive load
            ...
            <div className="junior-practice-page results-view overflow-y-auto" style={{ fontFamily: '"Open Sans", sans-serif' }}>
                <header className="junior-practice-header results-header relative">
                    ...
                    <div className="title-area">
                        <h1 className="results-title">Logic Legend!</h1>
                    </div>
                </header>
                                ...
                                <div className="question-card-modern" style={{ paddingLeft: '2rem' }}>
                                    <div className="question-header-modern">
                                        <div className="flex justify-center mb-6">
                                            <div className="bg-indigo-50 rounded-full p-4 border-2 border-indigo-100">
...
export default AlwaysSometimesNeverStatements;
