...
const NODE_ID = 'a4041011-0001-0000-0000-000000000000';
const randomInt = (min, max) => Math.floor(Math.random() * (max - min + 1)) + min;

const CORRECT_MESSAGES = [
    "✨ Ribbit! Great jump! ✨",
    "🌟 Hop to it! You got it! 🌟",
    "🎉 Amazing! You're a jump master! 🎉",
    "✨ Fantastic work! ✨",
    "🚀 Super! Leaping ahead! 🚀",
  ...
  useEffect(() => {
    ...
    useEffect(() => {
      ...
      v4IsFinishedRef.current = false; setSessionId(sess.session_id);
        ...
        const animals = [
            { name: "Frog 🐸", step: 3 },
            { name: "Squirrel 🐿️", step: 4 },
            { name: "Rabbit 🐇", step: 6 },
            { name: "Kangaroo 🦘", step: 8 },
            { name: "Grasshopper 🦗", step: 5 },
            { name: "Cat 🐱", step: 3 }
        ];
