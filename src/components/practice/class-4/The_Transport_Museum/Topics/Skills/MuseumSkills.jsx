...
export default function MuseumSkills() {
    ...
    return (
        <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', backgroundColor: '#fcfaf3' }}>
            ...
            <nav className="tm-nav">
                <button className="tm-nav-back" onClick={() => mode !== 'menu' ? onBack() : navigate('/the-transport-museum')}>
                ...
                {mode === 'menu' && (
                    <div className="tm-nav-links">
                        ...
                        <button className="tm-nav-link tm-nav-link--active" onClick={() => navigate('/the-transport-museum/skills')}>🎯 Skills</button>
                    </div>
                )}
            </nav>
