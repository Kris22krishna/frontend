...
const SubtractionWithRegrouping = () => {
    ...
    const SKILL_ID = 4005;
    const SKILL_NAME = "The Cleanest Village - Subtraction with Regrouping";
            ...
            if (!seenCombinations.has(comboKey)) {
                ...
                questions.push({
                    ...
                    solution: `Align numbers by place value.<br/>
                               ...
                               ${is3Digit ? 'Continue for all columns.<br/>' : ''}
...
export default SubtractionWithRegrouping;
