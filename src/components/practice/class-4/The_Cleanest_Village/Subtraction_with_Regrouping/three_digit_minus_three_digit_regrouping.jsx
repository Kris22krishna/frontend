...
const CORRECT_MESSAGES = [
    "✨ Amazing! You're a subtraction star! ✨",
    "🌟 Brilliant work! 🌟",
    "🎉 Correct! The village shines brighter! 🎉",
    "✨ Fantastic! Keep subtracting the waste! ✨",
...
const ThreeDigitSubtractionRegrouping = () => {
    ...
    const SKILL_ID = 4006;
    const SKILL_NAME = "The Cleanest Village - Subtraction with Regrouping (3-Digit)";
    ...
    useEffect(() => {
        ...
        while (questions.length < TOTAL_QUESTIONS) {
            let num1 = randomInt(200, 999);
            let num2 = randomInt(100, num1 - 10);

            // Check for borrowing requirement in at least one column
            const ones1 = num1 % 10;
            const ones2 = num2 % 10;
            const tens1 = Math.floor((num1 / 10)) % 10;
            const tens2 = Math.floor((num2 / 10)) % 10;

            const needsRegrouping = (ones1 < ones2) || (tens1 < tens2);

            if (!needsRegrouping) continue;
            ...
            if (!seenCombinations.has(comboKey)) {
                ...
                while (uniqueOptions.length < 4) {
                    let rand = (total + randomInt(-20, 20)).toString();
                ...
                questions.push({
                    ...
                    solution: `Align numbers by place value.<br/>
                               If top digit < bottom digit, borrow from the left.<br/>
                               Subtract column by column.<br/>
                               <strong>${num1} - ${num2} = ${total}</strong>.`,
...
export default ThreeDigitSubtractionRegrouping;
