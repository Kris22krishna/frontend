...
const CORRECT_MESSAGES = [
    "✨ Amazing! Big numbers are no problem for you! ✨",
...
const ThreeDigitAdditionRegrouping = () => {
    ...
    const SKILL_ID = 4004;
    const SKILL_NAME = "The Cleanest Village - Addition with Regrouping (3-Digit)";
    ...
    useEffect(() => {
        ...
        while (questions.length < TOTAL_QUESTIONS) {
            // Generate numbers where at least one column regroups
            let num1 = randomInt(100, 899);
            let num2 = randomInt(100, 999 - num1);

            // Check if regrouping happens (sum of ones >= 10 OR sum of tens >= 10)
            const ones1 = num1 % 10;
            const ones2 = num2 % 10;
...
export default ThreeDigitAdditionRegrouping;
