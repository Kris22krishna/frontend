    ...
    useEffect(() => {
        ...
        while (questions.length < TOTAL_QUESTIONS) {
            ...
            if (index < 3) {
                ...
                // Medium: moderate numbers (100-400)
                num1 = randomInt(100, 400);
                num2 = randomInt(100, 400);
            } else {
                // Hard: larger numbers (400-900)
            ...
            if (!seenCombinations.has(comboKey)) {
                ...
                const templates = [
                    `<div class='question-container'>
                        <p>Team A collected ${num1} kg of waste.</p>
                        <p>Team B collected ${num2} kg of waste.</p>
                        <p>How much <strong>more</strong> did the winning team collect?</p>
                     </div>`,
                    `<div class='question-container'>
                        <p>North Street has ${num1} trees.</p>
                        <p>South Street has ${num2} trees.</p>
                        <p>What is the <strong>difference</strong> in the number of trees?</p>
                     </div>`,
                    `<div class='question-container'>
                        <p>Dustbin X holds ${num1} liters.</p>
                        <p>Dustbin Y holds ${num2} liters.</p>
