    ...
    return [
        {
            ...
            practice: [
                { type: 'multiple-choice', question: 'What shape does a round glass look like from the top?', options: ['Square', 'Circle', 'Triangle', 'Rectangle'], correctAnswer: 1, explanation: 'Looking straight down at a round glass, you see its circular rim.', image: '🥛' },
                ...
                { type: 'multiple-choice', question: 'A cone (like a party hat) from the TOP looks like a...', options: ['Triangle', 'Circle', 'Square', 'Star'], correctAnswer: 1, explanation: 'Looking down at a cone, you see just its circular base.', image: '🎉' },
                { type: 'multiple-choice', question: 'A dice from the FRONT shows how many dots at maximum?', options: ['1', '3', '6', 'Depends on which face'], correctAnswer: 3, explanation: 'A dice has different numbers on each face, so the front view depends on orientation.', image: '🎲' },
                ...
                { type: 'multiple-choice', question: 'From the SIDE, a coin looks like a...', options: ['Circle', 'Thin Rectangle/Line', 'Square', 'Triangle'], correctAnswer: 1, explanation: 'From the side, a thin coin looks like a very thin line or slim rectangle.', image: '🪙' },
                { type: 'multiple-choice', question: 'A pyramid from the TOP view looks like a...', options: ['Triangle', 'Square with diagonals', 'Circle', 'Pentagon'], correctAnswer: 1, explanation: 'From directly above, a square pyramid shows the square base with lines going to the center point.', image: '🔺' },
                { type: 'multiple-choice', question: 'A cylinder (like a tin can) from the top looks like a...', options: ['Rectangle', 'Oval', 'Circle', 'Square'], correctAnswer: 2, explanation: 'The top of a cylinder is a circle.', image: '🥫' },
                ...
                { type: 'multiple-choice', question: 'An umbrella from above looks like a...', options: ['Triangle', 'Rectangle', 'Circle', 'Star'], correctAnswer: 2, explanation: 'An open umbrella from above looks like a big circle.', image: '☂️' },
                ...
                { type: 'multiple-choice', question: 'A pencil held upright — what does it look like from DIRECTLY above?', options: ['Long thin rectangle', 'Circle (the tip)', 'Triangle', 'Hexagon'], correctAnswer: 1, explanation: 'Looking down at the tip of a pencil, you see a small circle (or hexagon for hexagonal pencils).', image: '✏️' },
                { type: 'multiple-choice', question: 'Why is the top view also called the "plan view"?', options: ['Because you plan to see it', 'Because architects use it to plan buildings', 'Because it shows plans/trees', 'Because it\u2019s plain and simple'], correctAnswer: 1, explanation: 'Architects draw "plans" (top views) to design buildings and rooms.' },
            ],
            assessment: [
                { type: 'multiple-choice', question: 'A glass from the top looks like a...', options: ['Rectangle', 'Circle', 'Triangle', 'Square'], correctAnswer: 1, explanation: 'Looking down into a glass, you see its circular rim.' },
                { type: 'multiple-choice', question: 'A shoe from the SIDE view shows its...', options: ['Sole only', 'Full profile with heel and toe', 'Top surface only', 'Laces only'], correctAnswer: 1, explanation: 'The side view of a shoe shows its complete profile shape.', image: '👟' },
                { type: 'multiple-choice', question: 'A cricket bat from the FRONT (face) looks like a...', options: ['Circle', 'Wide paddle shape', 'Triangle', 'Thin line'], correctAnswer: 1, explanation: 'The front face of a cricket bat shows its wide flat paddle.', image: '🏏' },
                { type: 'multiple-choice', question: 'From the TOP, a donut looks like...', options: ['A circle with a hole', 'A rectangle', 'A solid circle', 'A square'], correctAnswer: 0, explanation: 'A donut from above shows a circle with a hole in the middle.', image: '🍩' },
                ...
                { type: 'multiple-choice', question: 'An ice cream cone from the SIDE looks like a...', options: ['Circle', 'Rectangle', 'Triangle', 'Oval'], correctAnswer: 2, explanation: 'From the side, an ice cream cone shows its triangular profile.', image: '🍦' },
                { type: 'multiple-choice', question: 'A cylinder from the SIDE looks like a...', options: ['Circle', 'Rectangle', 'Triangle', 'Hexagon'], correctAnswer: 1, explanation: 'The side view of a cylinder is a rectangle.' },
                { type: 'multiple-choice', question: 'Which view of a house shows the roof shape?', options: ['Top View', 'Front View', 'Back View', 'Both Front and Side'], correctAnswer: 3, explanation: 'The triangular roof is visible from the front and side views, not from directly above.' },
                { type: 'multiple-choice', question: 'A pipe from the FRONT (end) looks like a...', options: ['Rectangle', 'Circle / Ring', 'Triangle', 'Square'], correctAnswer: 1, explanation: 'Looking at the end of a pipe, you see its circular cross-section.' },
                ...
                { type: 'multiple-choice', question: 'A cone from the FRONT looks like a...', options: ['Circle', 'Triangle', 'Rectangle', 'Square'], correctAnswer: 1, explanation: 'The front view of a cone shows its triangular cross-section.' },
                ...
                { type: 'multiple-choice', question: 'A banana from the top looks roughly like a...', options: ['Circle', 'Curved line', 'Rectangle', 'Triangle'], correctAnswer: 1, explanation: 'A banana from above looks like a curved arc.', image: '🍌' },
                { type: 'multiple-choice', question: 'If two objects look the same from ALL three views, are they the same shape?', options: ['Always yes', 'Usually yes, but not guaranteed', 'Never', 'Only if they are the same color'], correctAnswer: 1, explanation: 'Objects with identical top, front, and side views are usually the same shape, but edge cases can exist.' },
                { type: 'multiple-choice', question: 'A traffic cone from the top looks like a...', options: ['Triangle', 'Circle', 'Square', 'Star'], correctAnswer: 1, explanation: 'Looking down at a traffic cone, you see its circular base.', image: '🔶' },
                { type: 'multiple-choice', question: 'An engineer draws the top, front, and side views. These are called...', options: ['Sketches', 'Orthographic Projections', 'Paintings', 'Photographs'], correctAnswer: 1, explanation: 'Engineers call the three standard views "orthographic projections".' },
            ]
        },
        {
            id: 'grid-navigation',
