...
const RiverCrossingSubtraction = () => {
    ...
    const generateQuestion = (difficulty, index) => {
        ...
        if (difficulty === 'easy') {
            ...
            if (Math.random() > 0.5) {
                n1 = Math.round(randomInt(2, 9)) * 1000;
                ...
                let rem = randomInt(2000, 4000);
                ans = n1 - rem;
                questionText = `The total distance is **${n1}** km. After some travel, **${rem}** km are remaining. How far have we traveled?`;
                explanation = `Total - Travelled = Remaining<br/>${n1} - ? = ${rem}<br/>? = ${n1} - ${rem} = ${ans}`;
            }
        }
            ...
            <div className="junior-practice-page results-view overflow-y-auto" style={{ fontFamily: '"Open Sans", sans-serif' }}>
                ...
                <main className="practice-content results-content max-w-5xl mx-auto w-full px-4">
                    <div className="results-hero-section flex flex-col items-center mb-8">
                        <h2 className="text-4xl font-normal text-[#31326F] mb-2">Safe Arrival! ⚓</h2>
                    ...
                    <div className="detailed-breakdown w-full mb-12">
                        <h3 className="text-2xl font-normal text-[#31326F] mb-6 px-4">Navigation Log 📜</h3>
            ...
            <main className="practice-content-wrapper flex items-center justify-center min-h-[calc(100vh-200px)] p-4 relative top-[-20px]">
                <div className="w-full max-w-6xl bg-white/90 backdrop-blur-sm rounded-[3rem] shadow-xl border-4 border-[#E0FBEF] p-6 lg:p-10 flex flex-col md:flex-row gap-8 items-stretch">
                    ...
                    <div className="flex-1 flex flex-col justify-center items-center border-b-2 md:border-b-0 md:border-r-2 border-dashed border-gray-200 pb-6 md:pb-0 md:pr-8">
                        <div className="p-6 mb-8 text-7xl">{currentQuestion.icon}</div>
