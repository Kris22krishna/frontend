            ...
            <div className="junior-practice-page results-view overflow-y-auto" style={{ fontFamily: '"Open Sans", sans-serif' }}>
                ...
                <main className="practice-content results-content max-w-5xl mx-auto w-full px-4">
                    <div className="results-hero-section flex flex-col items-center mb-8">
                        <h2 className="text-4xl font-normal text-[#31326F] mb-2">Gathering Complete! 🧺</h2>
                    ...
                    <div className="detailed-breakdown w-full mb-12">
                        <h3 className="text-2xl font-normal text-[#31326F] mb-6 px-4">Gathering Log 📜</h3>
                    ...
                    <div className="flex-1 flex flex-col justify-center items-center border-b-2 md:border-b-0 md:border-r-2 border-dashed border-gray-200 pb-6 md:pb-0 md:pr-8">
                        <div className="flex flex-wrap justify-center gap-4 mb-8">
                            {currentQuestion.items.map((item, idx) => (
                                <div key={idx} className="bg-orange-50 px-6 py-4 rounded-3xl shadow-sm border-4 border-orange-200 flex items-center gap-3">
                                    <span className="text-4xl">{item.icon}</span>
                                    <span className="text-[#31326F] font-normal text-2xl">{item.count}</span>
                                </div>
                            ))}
                        </div>
