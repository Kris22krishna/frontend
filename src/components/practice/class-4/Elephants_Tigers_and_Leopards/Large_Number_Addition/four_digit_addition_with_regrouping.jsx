...
const FourDigitAdditionWithRegrouping = () => {
    ...
    const SKILL_NAME = "Elephants, Tigers, and Leopards - Four Digit Addition with Regrouping";
...
export default FourDigitAdditionWithRegrouping;
