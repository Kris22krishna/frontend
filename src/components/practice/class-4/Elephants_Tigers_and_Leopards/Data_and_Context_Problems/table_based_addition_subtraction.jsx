...
const CORRECT_MESSAGES = [
    "✨ Brilliant analysis! You're a data pro! ✨",
    ...
    const generateQuestion = (difficulty, index) => {
        ...
        if (difficulty === 'easy') {
            if (qType <= 2) {
                ...
                correctAnswer = Math.max(jeeps, buses, vans);
            ...
            <div className="junior-practice-page results-view overflow-y-auto" style={{ fontFamily: '"Open Sans", sans-serif' }}>
                ...
                <main className="practice-content results-content max-w-5xl mx-auto w-full px-4">
                    <div className="results-hero-section flex flex-col items-center mb-8">
                        <h2 className="text-4xl font-black text-[#31326F] mb-2">Safari Mission Complete! 🎉</h2>
                    ...
                    <div className="detailed-breakdown w-full mb-12">
                        <h3 className="text-2xl font-black text-[#31326F] mb-6 px-4">Safari Log 📜</h3>
                                                ...
                                                <tbody>
                                                    {currentQuestion && currentQuestion.tableData.map((item, idx) => (
                                                        <tr key={idx} className={idx % 2 === 0 ? 'bg-gray-50' : 'bg-white'}>
                                                            ...
                                                            <td className="p-4 font-black text-right text-2xl text-blue-500">{item.count}</td>
                                                        </tr>
                                                    ))}
                                                </tbody>
                                            </table>
