            ...
            <div className="junior-practice-page results-view overflow-y-auto" style={{ fontFamily: '"Open Sans", sans-serif' }}>
                ...
                <main className="practice-content results-content max-w-5xl mx-auto w-full px-4">
                    <div className="results-hero-section flex flex-col items-center mb-8">
                        <h2 className="text-4xl font-black text-[#31326F] mb-2">Wildlife Mission Complete! 🌿</h2>
                    ...
                    <div className="detailed-breakdown w-full mb-12">
                        <h3 className="text-2xl font-black text-[#31326F] mb-6 px-4">Wild Log 📜</h3>
                                            ...
                                            <div className="grid grid-cols-[auto_1fr_auto] gap-x-6 gap-y-0 text-lg">
                                                ...
                                                {currentQuestion && currentQuestion.tableData.map((item, idx) => (
                                                    <div key={idx} className="contents group">
                                                        ...
                                                        <div className={`p-4 flex items-center justify-end font-black text-[#4FB7B3] text-2xl ${idx % 2 === 0 ? 'bg-gray-50' : 'bg-white'}`}>{item.count}</div>
                                                    </div>
                                                ))}
                                            </div>
                                        </div>
