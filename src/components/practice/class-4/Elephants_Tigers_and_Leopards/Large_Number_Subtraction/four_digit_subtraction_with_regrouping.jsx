...
const CORRECT_MESSAGES = [
    "✨ Precise calculation! Smooth sailing! ✨",
    "🌟 Your subtraction is spot on! 🌟",
    "🎉 Correct! You've crossed the river safely! 🎉",
    "✨ Fantastic work! ✨",
    ...
    const generateQuestion = (difficulty, index) => {
        ...
        if (difficulty === 'easy') {
            ...
            if (Math.random() > 0.5) {
                ...
                diff = n1 - n2;
                questionText = `Evaluate the difference: **${n1} - ${n2}**`;
        ...
        while (distractors.size < 4) {
            let offset = randomInt(1, 10) * (difficulty === 'hard' ? 10 : 100);
            if (Math.random() > 0.5) offset *= -1;
            const res = diff + offset;
            if (res > 0 && res !== diff) distractors.add(res.toString());
        }
            ...
            <div className="junior-practice-page results-view overflow-y-auto" style={{ fontFamily: '"Open Sans", sans-serif' }}>
                ...
                <main className="practice-content results-content max-w-5xl mx-auto w-full px-4">
                    <div className="results-hero-section flex flex-col items-center mb-8">
                        <h2 className="text-4xl font-normal text-[#31326F] mb-2">River Master! ⚓</h2>
                    ...
                    <div className="detailed-breakdown w-full mb-12">
                        <h3 className="text-2xl font-normal text-[#31326F] mb-6 px-4">Crossing Log 📜</h3>
