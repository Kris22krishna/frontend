...
const FourDigitSubtractionWithRegrouping = () => {
    ...
    const SKILL_NAME = "Elephants, Tigers, and Leopards - Four Digit Subtraction with Regrouping";
...
export default FourDigitSubtractionWithRegrouping;
