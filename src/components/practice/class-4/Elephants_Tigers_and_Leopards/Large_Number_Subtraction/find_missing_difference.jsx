...
const CORRECT_MESSAGES = [
    ...
    "🎉 Correct! The mystery is solved! 🎉",
    "✨ Fantastic work! ✨",
    "🚀 Super! Keep striving for excellence! 🚀",
    "🌿 Perfect! Nature is proud of your precision! 🌿",
    "🎊 Great job! Moving on... 🎊",
    "💎 Spot on! Excellent! 💎"
];
    ...
    const generateQuestion = (difficulty, index) => {
        ...
        if (difficulty === 'easy') {
            ...
            if (Math.random() > 0.5) {
                ...
                missing = 'sub';
                questionText = `$$${min} - \\; ? = ${diff}$$`;
                explanation = `To find the missing number, subtract the result from the top number.<br/>$$${min} - ${diff} = ${sub}$$`;
            }
        } else {
            ...
            if (type === 1) {
                ...
                explanation = `Reverse the subtraction by adding: $$${diff} + ${sub} = ${min}$$`;
                missing = 'min';
            } else if (type === 2) {
                ...
                questionText = `Evaluate the missing difference: $$${min} - ${sub} = \\; ?$$`;
        ...
        while (distractors.size < 4) {
            ...
            let offset = randomInt(1, 5) * (difficulty === 'easy' ? 1 : (difficulty === 'medium' ? 10 : 100));
            if (Math.random() > 0.5) offset *= -1;
            const res = val + offset;
            if (res > 0 && res !== val) distractors.add(res.toString());
        }
            ...
            <div className="junior-practice-page results-view overflow-y-auto" style={{ fontFamily: '"Open Sans", sans-serif' }}>
                ...
                <main className="practice-content results-content max-w-5xl mx-auto w-full px-4">
                    ...
                    <div className="detailed-breakdown w-full mb-12">
                        <h3 className="text-2xl font-black text-[#31326F] mb-6 px-4">Mystery Log 📜</h3>
                        ...
                        <AnimatePresence mode="wait">
                            <motion.div key={qIndex} initial={{ x: 50, opacity: 0 }} animate={{ x: 0, opacity: 1 }} exit={{ x: -50, opacity: 0 }} transition={{ duration: 0.4, ease: "easeOut" }} style={{ height: '100%', width: '100%' }}>
                                <div className="question-card-modern" style={{ padding: '0 0 2rem 0' }}>
                                    <div className="w-full bg-[#FFF3E0] p-8 mb-8 rounded-b-[3rem] border-b-4 border-orange-200 flex flex-col items-center">
                                        <div className="flex justify-center mb-6">
                                            <div className="bg-white/50 p-4 rounded-full shadow-sm border-2 border-orange-100"><Search size={48} className="text-orange-600" /></div>
                                        </div>
