...
import { RefreshCw, Check, Eye, ChevronRight, ChevronLeft, X, Star, Scissors } from 'lucide-react';
...
const CORRECT_MESSAGES = [
    "✨ Brilliant estimation! You're a math scout! ✨",
    "🌟 Your calculations are spot on! 🌟",
    "🎉 Correct! The village is proud of your precision! 🎉",
    "✨ Fantastic work! ✨",
    "🚀 Super! Keep striving for excellence! 🚀",
    "🌿 Perfect! Nature loves your accuracy! 🌿",
    "🎊 Great job! Moving on... 🎊",
    "💎 Spot on! Excellent! 💎"
];
...
const EstimateFirstSubtraction = () => {
    ...
    const generateQuestion = (difficulty, index) => {
        ...
        while (distractors.size < 4) {
            let offset = randomInt(1, 4) * roundBase;
            if (Math.random() > 0.5) offset *= -1;
            const res = diffEst + offset;
            if (res > 0 && res !== diffEst) distractors.add(res.toString());
        }
            ...
            <div className="junior-practice-page results-view overflow-y-auto" style={{ fontFamily: '"Open Sans", sans-serif' }}>
                ...
                <main className="practice-content results-content max-w-5xl mx-auto w-full px-4">
                    <div className="results-hero-section flex flex-col items-center mb-8">
                        <h2 className="text-4xl font-black text-[#31326F] mb-2">Estimation Scout! 🎯</h2>
                        ...
                        <AnimatePresence mode="wait">
                            <motion.div key={qIndex} initial={{ x: 50, opacity: 0 }} animate={{ x: 0, opacity: 1 }} exit={{ x: -50, opacity: 0 }} transition={{ duration: 0.4, ease: "easeOut" }} style={{ height: '100%', width: '100%' }}>
                                <div className="question-card-modern" style={{ padding: '0 0 2rem 0' }}>
                                    <div className="w-full bg-[#FFEBEE] p-8 mb-8 rounded-b-[3rem] border-b-4 border-red-200 flex flex-col items-center">
                                        <div className="flex justify-center mb-6">
                                            <div className="bg-white/50 p-4 rounded-full shadow-sm border-2 border-red-100"><Scissors size={48} className="text-red-600" /></div>
                                        </div>
