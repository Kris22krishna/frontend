...
const CompensationStrategyQuestions = () => {
    ...
    const SKILL_NAME = "Elephants, Tigers, and Leopards - Compensation Strategy Questions";
...
export default CompensationStrategyQuestions;
