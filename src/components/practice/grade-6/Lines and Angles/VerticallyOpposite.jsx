...
const CORRECT_MESSAGES = [
    "✨ Mirror image! You've spotted the equal pair! ✨",
    "🌟 X-Ray Vision! Intersecting lines are no match for you! 🌟",
    "🎉 Correct! Vertically opposite and vertically perfect! 🎉",
    "✨ Spot on! You know these angles are identical twins! ✨",
    "🚀 Wow! You're crossing into geometry mastery! 🚀"
];
...
const VerticallyOpposite = () => {
    ...
    const SKILL_ID = 2007;
    const SKILL_NAME = "Vertically Opposite Angles";
    ...
    const generateQuestion = (index, retryCount = 0) => {
        const types = ["equality", "calculation", "formation"];
        ...
        if (type === "equality") {
            qText = "When two lines intersect, the vertically opposite angles are always:";
            correct = "Equal";
            options = ["Equal", "Unequal", "Sum to $90^\\circ$", "Sum to $180^\\circ$"];
            explanation = "Vertically opposite angles are formed when two lines intersect. A key property is that these opposite angles are always equal to each other.";
        } else if (type === "calculation") {
            const values = [40, 55, 75, 110, 130];
            const val = values[index % values.length];
            qText = `If one angle in a pair of vertically opposite angles is $${val}^\\circ$, what is the measure of the other angle?`;
            correct = `$${val}^\\circ$`;
            options = [`$${val}^\\circ$`, `$${180 - val}^\\circ$`, `$${90 - val}^\\circ$`, `$${360 - val}^\\circ$`];
            explanation = `Vertically opposite angles are equal. So if one is $${val}^\\circ$, its opposite must also be $${val}^\\circ$.`;
        } else {
            qText = "Vertically opposite angles are formed by the intersection of how many lines?";
            correct = "2";
            options = ["1", "2", "3", "4"];
            explanation = "When two straight lines cross each other, they form two pairs of vertically opposite angles.";
        }
                                    ...
                                    <div className="question-header-modern">
                                        ...
                                        <div className="geometry-svg-container mt-6">
                                            <svg width="200" height="120" viewBox="0 0 200 120">
                                                <line x1="20" y1="20" x2="180" y2="100" stroke="#31326F" strokeWidth="3" />
                                                <line x1="20" y1="100" x2="180" y2="20" stroke="#31326F" strokeWidth="3" />
                                                <text x="50" y="65" fontSize="12" fontWeight="bold">a</text>
                                                <text x="140" y="65" fontSize="12" fontWeight="bold">b</text>
                                            </svg>
                                        </div>
                                    </div>
