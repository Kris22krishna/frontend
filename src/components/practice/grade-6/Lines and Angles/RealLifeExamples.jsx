...
const CORRECT_MESSAGES = [
    "✨ Sharp eyes! You've spotted geometry in the real world! ✨",
    "🌟 Real-World Wiz! You see angles everywhere! 🌟",
    "🎉 Correct! Your geometric intuition is building fast! 🎉",
    "✨ Spot on! You've translated a real scenario into math! ✨",
    "🚀 Way to go! You're connecting theory to reality perfectly! 🚀"
];
...
const RealLifeExamples = () => {
    ...
    const SKILL_ID = 2010;
    const SKILL_NAME = "Real Life Examples";
    ...
    const generateQuestion = (index, retryCount = 0) => {
        const scenarios = [
            { q: "Which type of lines are formed by the tracks of a straight railway line?", a: "Parallel Lines", e: "Railway tracks never meet and stay at the same distance, so they are parallel.", opts: ["Parallel Lines", "Intersecting Lines", "Curved Lines", "Zigzag Lines"] },
            { q: "The hands of a clock at 3:00 PM form which type of angle?", a: "Right Angle", e: "At 3:00, one hand is at 12 and the other at 3, making a square corner of $90^\\circ$.", opts: ["Acute Angle", "Right Angle", "Obtuse Angle", "Straight Angle"] },
            { q: "When you open a pair of scissors, the blades represent:", a: "Intersecting Lines", e: "The blades cross at a hinge point, similar to intersecting lines.", opts: ["Parallel Lines", "Intersecting Lines", "Rays", "Points"] },
            { q: "A completely opened book lying flat on a table represents which angle?", a: "Straight Angle", e: "A flat surface forms a straight line, representing an angle of $180^\\circ$.", opts: ["Right Angle", "Acute Angle", "Straight Angle", "Reflex Angle"] },
            { q: "The letter 'L' in a signpost is an example of:", a: "Perpendicular Lines", e: "The horizontal and vertical parts of 'L' meet at a $90^\\circ$ angle.", opts: ["Parallel Lines", "Perpendicular Lines", "Zigzag Lines", "Curved Lines"] }
        ];

        const s = scenarios[index % scenarios.length];
        const shuffled = [...s.opts].sort(() => Math.random() - 0.5);
