...
const CORRECT_MESSAGES = [
    "✨ Straight shot! You've mastered the 180° logic! ✨",
    "🌟 Geometry Star! Those angles add up perfectly! 🌟",
    "🎉 Correct! You're lining up for success! 🎉",
    "✨ Brilliant! You know exactly how a straight line behaves! ✨",
    "🚀 Outstanding! You're navigating the linear landscape like a pro! 🚀"
];
...
const LinearPair = () => {
    ...
    const SKILL_ID = 2006;
    const SKILL_NAME = "Linear Pair of Angles";
    ...
    const generateQuestion = (index, retryCount = 0) => {
        const types = ["sum_property", "calculation", "definition"];
        ...
        if (type === "sum_property") {
            qText = "What is the sum of two angles forming a linear pair?";
            correct = "$180^\\circ$";
            options = ["$90^\\circ$", "$180^\\circ$", "$270^\\circ$", "$360^\\circ$"];
            explanation = "A linear pair of angles are adjacent angles whose non-common sides are opposite rays, forming a straight line. The sum of angles on a straight line is always $180^\\circ$.";
        } else if (type === "calculation") {
            const values = [30, 45, 60, 100, 120, 150];
            const val = values[index % values.length];
            qText = `One angle of a linear pair measures $${val}^\\circ$. What is the measure of the other angle?`;
            correct = `$${180 - val}^\\circ$`;
            options = [`$${180 - val}^\\circ$`, `$${90 - val}^\\circ$`, `$${val}^\\circ$`, `$${360 - val}^\\circ$`];
            explanation = `Since they form a linear pair, their sum is $180^\\circ$. Other angle = $180^\\circ - ${val}^\\circ = ${180 - val}^\\circ$.`;
        } else {
            qText = "A pair of adjacent angles whose non-common arms are opposite rays is called:";
            correct = "Linear Pair";
            options = ["Linear Pair", "Vertically Opposite Angles", "Acute Angles", "Reflex Angles"];
            explanation = "When the non-common arms form a straight line, the adjacent angles are said to form a linear pair.";
        }
                                    ...
                                    <div className="question-header-modern">
                                        ...
                                        <div className="geometry-svg-container mt-6">
                                            <svg width="240" height="100" viewBox="0 0 240 100">
                                                <line x1="20" y1="80" x2="220" y2="80" stroke="#31326F" strokeWidth="3" />
                                                <line x1="120" y1="80" x2="160" y2="20" stroke="#31326F" strokeWidth="3" />
