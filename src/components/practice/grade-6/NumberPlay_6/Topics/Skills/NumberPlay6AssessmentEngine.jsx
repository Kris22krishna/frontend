                    ...
                    {questionSet.map((question, index) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                {/* Show explanation context in review if available */}
                                {question.explanation && (
                                    <div style={{ marginTop: 16, fontSize: 14, color: '#64748b', background: '#f8fafc', padding: 16, borderRadius: 12 }}>
                                        <strong style={{ color: '#475569' }}>Note: </strong> <MathRenderer text={question.explanation} />
                                    </div>
                                )}
                            </div>
                        );
