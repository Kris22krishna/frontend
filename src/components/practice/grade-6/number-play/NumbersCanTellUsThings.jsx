...
const NumbersCanTellUsThings = () => {
    ...
    const v4IsFinishedRef = useRef(false); // ID for Number Play - Numbers can Tell us Things
    ...
    useEffect(() => {
        ...
        if (userId && !sessionId) {
            ...
            startSession({ nodeId: 'a4061003-0001-0000-0000-000000000000', sessionType: 'practice' });
