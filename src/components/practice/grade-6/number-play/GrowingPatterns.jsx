...
const GrowingPatterns = () => {
    ...
    const v4IsFinishedRef = useRef(false); // ID for Number Play - Growing Patterns
    ...
    useEffect(() => {
        ...
        if (userId && !sessionId) {
            ...
            startSession({ nodeId: 'a4061003-0002-0000-0000-000000000000', sessionType: 'practice' });
        ...
        <div className="junior-practice-page raksha-theme" style={{ fontFamily: '"Open Sans", sans-serif' }}>
            <header className="junior-practice-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '0 2rem' }}>
                <div className="header-left">
                    <span className="text-[#31326F] text-lg sm:text-xl">Growing Patterns</span>
                </div>
