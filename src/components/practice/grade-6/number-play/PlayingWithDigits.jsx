...
const PlayingWithDigits = () => {
    ...
    const v4IsFinishedRef = useRef(false); // ID for Number Play - Playing with Digits
    ...
    useEffect(() => {
        ...
        if (userId && !sessionId) {
            ...
            startSession({ nodeId: 'a4061003-0005-0000-0000-000000000000', sessionType: 'practice' });
            ...
            if (type === "count_n_digits") {
                ...
                qText = `
                    <div class='question-container'>
                        ...
                        <p class="text-2xl text-indigo-600">${num}</p>
                    </div>
                `;
        ...
        <div className="junior-practice-page raksha-theme" style={{ fontFamily: '"Open Sans", sans-serif' }}>
            <header className="junior-practice-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '0 2rem' }}>
                <div className="header-left">
                    <span className="text-[#31326F] text-lg sm:text-xl">Playing with Digits</span>
                </div>
