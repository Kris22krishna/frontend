...
const RectanglePractice = () => {
    ...
    const generateQuestion = () => {
        if (history[qIndex]) {
            ...
            setRectLength(data.rectLength);
            setRectWidth(data.rectWidth);
            setMode(data.mode);
    ...
    const handleCheck = async () => {
        ...
        let msg = '';
        if (isRight) {
            const messages = ["Excellent work!", "Spot on!", "Great job!"];
        ...
        <div className="junior-practice-page raksha-theme" style={{ fontFamily: '"Open Sans", sans-serif' }}>
            <header className="junior-practice-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '0 2rem' }}>
                <div className="header-left">
                    <span className="text-[#31326F] font-bold text-lg sm:text-xl">Rectangle</span>
                </div>
                        ...
                        <div className="question-card-modern" style={{ padding: '2rem' }}>
                            <div className="question-header-modern" style={{ marginBottom: '2rem' }}>
                                <div className="text-center space-y-2 w-full">
                                    ...
                                    <p className="text-gray-400 text-lg">of the rectangle</p>
                                </div>
                            </div>
                                        ...
                                        return (
                                            <g>
                                                ...
                                                <g transform={`translate(${x - 25}, ${y + scaledW / 2})`}>
                                                    ...
                                                    <text textAnchor="middle" dominantBaseline="middle" className="text-lg font-bold fill-[#31326F]">{rectWidth} cm</text>
                                                </g>
                                                <g transform={`translate(${x + scaledL / 2}, ${y + scaledW + 25})`}>
                                                    <rect x="-30" y="-12" width="60" height="24" rx="4" fill="white" fillOpacity="0.8" />
                                                    <text textAnchor="middle" dominantBaseline="middle" className="text-lg font-bold fill-[#31326F]">{rectLength} cm</text>
                                                </g>
                                                {mode === 'perimeter' && (
                                                    <rect
                                                        x={x} y={y} width={scaledL} height={scaledW}
