    ...
    return (
        <div className="junior-practice-page raksha-theme" style={{ fontFamily: '"Open Sans", sans-serif' }}>
            ...
            <ExplanationModal
                ...
                explanation={
                    mode === 'area'
                        ? `To find the area of a rectangle, multiply length by width:<br/><strong>Area = ${rectLength} × ${rectWidth} = ${getCorrectAnswer()} ${mode === 'area' ? 'cm²' : 'cm'}</strong>`
                        : `To find the perimeter, add all sides or use the formula:<br/><strong>Perimeter = 2 × (${rectLength} + ${rectWidth}) = ${getCorrectAnswer()} ${mode === 'area' ? 'cm²' : 'cm'}</strong>`
                }
            />
