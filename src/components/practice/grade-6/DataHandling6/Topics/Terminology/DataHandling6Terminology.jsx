...
import { TERMS, CHART_TYPES, VOCAB_QUIZ } from './DataHandling6TerminologyData.jsx';

export default function DataHandling6Terminology() {
    ...
    return (
        <div className={styles['dh-terminology-page']} style={{
            ...
            <nav className={styles['dh-intro-nav']}>
                <button className={styles['dh-intro-nav-back']} onClick={() => navigate('/middle/grade/6/data-handling-6')}>← Back to Data Handling Dashboard</button>
                <div className={styles['dh-intro-nav-links']}>
                    <button className={styles['dh-intro-nav-link']} onClick={() => navigate('/middle/grade/6/data-handling-6/introduction')}>🌟 Introduction</button>
                    <button className={`${styles['dh-intro-nav-link']} ${styles['dh-intro-nav-link--active']}`}>📖 Terminology</button>
                    <button className={styles['dh-intro-nav-link']} onClick={() => navigate('/middle/grade/6/data-handling-6/skills')}>🎯 Skills</button>
                </div>
            </nav>
            ...
            <div className="dh-lexicon-container" style={{ maxWidth: 1100, margin: '40px auto 20px', padding: '0 24px' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', marginBottom: 20 }}>
                    <h1 style={{ fontFamily: 'Outfit, sans-serif', fontSize: '2.8rem', fontWeight: 900, color: '#0f172a', margin: '0 0 8px' }}>
                        Data <span style={{ background: 'linear-gradient(135deg, #0891b2, #6366f1)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Vocabulary</span>
                    </h1>
                ...
                <div style={{ display: 'flex', justifyContent: 'center', gap: 8, marginBottom: 16 }}>
                    <button className={`${styles['dh-tab']} ${activeTab === 'terms' ? styles.active : ''}`} onClick={() => setActiveTab('terms')}>📚 Terminology</button>
                    <button className={`${styles['dh-tab']} ${activeTab === 'rules' ? styles.active : ''}`} onClick={() => setActiveTab('rules')}>📏 Chart Types</button>
                    <button className={`${styles['dh-tab']} ${activeTab === 'quiz' ? styles.active : ''}`} onClick={() => setActiveTab('quiz')}>🧪 Test Prep</button>
                </div>
                ...
                {activeTab !== 'quiz' ? (
                    ...
                    <div className="dh-lexicon-grid" style={{ display: 'grid', gridTemplateColumns: 'minmax(300px, 360px) 1fr', gap: 16, alignItems: 'start' }}>
                        <aside className="dh-selector-container" style={{
                            ...
                            {activeTab === 'terms' ? (
                                TERMS.map((term, i) => {
                                    ...
                                    return (
                                        <button key={i} className={`dh-term-btn-mini ${isActive ? 'active' : ''}`} onClick={() => setSelectedIdx(i)}
                                            style={{
                                ...
                                CHART_TYPES.map((rule, i) => {
                                    ...
                                    return (
                                        <button key={i} className={`dh-term-btn-mini ${isActive ? 'active' : ''}`} onClick={() => setSelectedRuleIdx(i)}
                        ...
                        <main className="dh-details-window-anim" key={activeTab === 'terms' ? selectedIdx : selectedRuleIdx} style={{
                    ...
                    /* ── VOCABULARY TEST TAB ── */
                    <div className="dh-details-window-anim" style={{ maxWidth: 800, margin: '0 auto', background: '#fff', borderRadius: 24, padding: '32px 40px', boxShadow: '0 15px 40px rgba(0,0,0,0.04)', border: '1px solid rgba(0,0,0,0.04)' }}>
                        {!quizFinished ? (
                            <>
                            ...
                            <div style={{ textAlign: 'center', padding: '20px 0' }}>
                                ...
                                <div style={{ display: 'flex', gap: 12, justifyContent: 'center' }}>
                                    ...
                                    <button style={{ padding: '12px 30px', background: '#fff', color: '#0891b2', border: '2px solid #0891b2', borderRadius: 100, fontWeight: 600, cursor: 'pointer' }} onClick={() => navigate('/middle/grade/6/data-handling-6/skills')}>Go to Skills 🎯</button>
                                </div>
                            </div>
                        )}
                    </div>
                ...
                <div style={{ marginTop: 16, textAlign: 'center' }}>
                    <button style={{ padding: '12px 30px', background: '#0891b2', color: '#fff', borderRadius: 100, border: 'none', fontWeight: 600, cursor: 'pointer' }} onClick={() => navigate('/middle/grade/6/data-handling-6/skills')}>Ready to Solve! 🎯</button>
                </div>
            </div>
        </div>
    );
