...
import QuizEngine from '../../Fractions6QuizEngine.jsx';
import AssessmentEngine from '../../Fractions6AssessmentEngine.jsx';
import { SKILLS } from './Fractions6SkillsData.jsx';

export default function Fractions6Skills() {
            ...
            <div className={styles['frac-page']} style={{ background: '#f8fafc', minHeight: '100vh', paddingBottom: '60px' }}>
                <nav className={styles['frac-intro-nav']}>
                    ...
                    <div className={styles['frac-intro-nav-links']}>
                        <button className={styles['frac-intro-nav-link']} onClick={() => navigate('/middle/grade/6/fractions-6/introduction')}>🌟 Intro</button>
                        <button className={styles['frac-intro-nav-link']} onClick={() => navigate('/middle/grade/6/fractions-6/terminology')}>📖 Terminology</button>
            ...
            <div style={{ padding: '20px 24px 80px', maxWidth: 1100, margin: '0 auto' }}>
                ...
                <div style={{ textAlign: 'center', marginBottom: 40 }}>
                    <h1 style={{ fontFamily: 'Outfit, sans-serif', fontSize: '2.8rem', fontWeight: 900, color: '#0f172a', margin: '0 0 8px' }}>
                        Fractions <span style={{ background: 'linear-gradient(135deg, #0369a1, #0891b2)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Skills</span>
                    </h1>
