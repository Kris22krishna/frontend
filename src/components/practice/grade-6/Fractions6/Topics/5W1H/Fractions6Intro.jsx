...
import { cards5W1H } from './Fractions6IntroData.jsx';
...
/* 🍕 Main page */
export default function Fractions6Intro() {
        ...
        <div className={styles['frac-intro-page']}>
            ...
            <nav className={styles['frac-intro-nav']}>
                <button
                    ...
                    onClick={() => navigate('/middle/grade/6/fractions-6')}
                >
                    ← Back to Fractions Dashboard
                </button>
                ...
                <div className={styles['frac-intro-nav-links']}>
                    ...
                    <button
                        ...
                        onClick={() => navigate('/middle/grade/6/fractions-6/terminology')}
                    >
                        📖 Terminology
                    </button>
                    <button
                        className={styles['frac-intro-nav-link']}
                        onClick={() => navigate('/middle/grade/6/fractions-6/skills')}
                    >
                        🎯 Skills
                    </button>
                </div>
            ...
            {/* 🍕 HERO BANNER */}
            <div className={styles['frac-intro-hero']} style={{ padding: '16px 24px 20px', background: 'linear-gradient(135deg, #1e3a8a 0%, #312e81 25%, #4c1d95 50%, #7c3aed 75%, #d946ef 100%)' }}>
                ...
                <div className={styles['frac-intro-hero-inner']}>
                    <h1 className={styles['frac-intro-hero-title']}>
                        Discover Fractions Through{' '}
                        <span className={styles['frac-intro-hero-highlight']} style={{ background: 'linear-gradient(90deg, #fde047 0%, #fef08a 40%, #fdba74 80%, #f97316 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>6 Big Questions</span>
                    </h1>
            ...
            <div className={styles['frac-intro-content']} style={{ padding: '10px 24px 20px' }}>
                ...
                <div className={styles['frac-intro-cta-strip']}>
                    <p className={styles['frac-intro-cta-sub']} style={{ margin: 0 }}>
                        Up next: Key terms & visual fractions
                    </p>
                    <button
