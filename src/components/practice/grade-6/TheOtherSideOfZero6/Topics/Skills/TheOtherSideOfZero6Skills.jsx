...
import QuizEngine from '../../TheOtherSideOfZero6QuizEngine.jsx';
import AssessmentEngine from '../../TheOtherSideOfZero6AssessmentEngine.jsx';
import { SKILLS } from './TheOtherSideOfZero6SkillsData.jsx';

export default function TheOtherSideOfZero6Skills() {
    ...
    if (view !== 'list' && skill) {
        return (
            <div className={styles['osz-page']} style={{ background: '#f8fafc', minHeight: '100vh', paddingBottom: '60px' }}>
                <nav className={styles['osz-intro-nav']}>
                    <button className={styles['osz-intro-nav-back']} onClick={() => { setView('list'); setSelectedLearnIdx(0); }}>← Back to Skills</button>
                    <div className={styles['osz-intro-nav-links']}>
                        <button className={styles['osz-intro-nav-link']} onClick={() => navigate('/middle/grade/6/the-other-side-of-zero/introduction')}>🌟 Intro</button>
                        <button className={styles['osz-intro-nav-link']} onClick={() => navigate('/middle/grade/6/the-other-side-of-zero/terminology')}>📖 Terminology</button>
                        <button className={`${styles['osz-intro-nav-link']} ${styles['osz-intro-nav-link--active']}`}>🎯 Skills</button>
                    </div>
                </nav>
            ...
            <div style={{ padding: '20px 24px 80px', maxWidth: 1100, margin: '0 auto' }}>
                ...
                <div style={{ textAlign: 'center', marginBottom: 40 }}>
                    <h1 style={{ fontFamily: 'Outfit, sans-serif', fontSize: '2.8rem', fontWeight: 900, color: '#0f172a', margin: '0 0 8px' }}>
                        Integer <span style={{ background: 'linear-gradient(135deg, #0369a1, #0891b2)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Skills</span>
                    </h1>
