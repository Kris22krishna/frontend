...
const CORRECT_MESSAGES = [
    "✨ Conversion Master! ✨",
    "🌟 You're great at weighing choices! 🌟",
    "🎉 Correct! The scale is perfectly balanced! 🎉",
    "✨ Fantastic work! ✨",
    "🚀 Super! You're calculating like a pro! 🚀",
    "🌿 Perfect! Nature loves precision! 🌿",
    "🎊 Great job! Moving on... 🎊",
...
const MassConversion = () => {
    ...
    useEffect(() => {
        ...
        startSession({ nodeId: 'a4051014-0007-0000-0000-000000000000', sessionType: 'practice' });
            ...
            if (i < 3) {
                ...
                if (i % 2 === 0) {
                    ...
                    question = {
                        ...
                        solution: `1 kg = 1,000 g.<br/>So, ${kg} kg = ${kg} × 1,000 = <strong>${kg * 1000} grams</strong>.`
                    };
                } else {
                ...
                if (i === 7) {
                    ...
                    question = {
                        ...
                        solution: `1. Convert 800 g to kg: 800 ÷ 1000 = 0.8 kg.<br/>
        ...
        return (
            <div className="junior-practice-page results-view overflow-y-auto" style={{ fontFamily: '"Open Sans", sans-serif' }}>
                ...
                <main className="practice-content results-content max-w-5xl mx-auto w-full px-4 text-center">
                    <h2 className="text-4xl font-black text-[#31326F] mb-1">Quest Complete! ✨</h2>
