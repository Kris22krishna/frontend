...
const CORRECT_MESSAGES = [
    ...
    "🎉 Correct! You're ready for the real village market! 🎉",
    "✨ Fantastic work! ✨",
    "🚀 Super! You apply math perfectly! 🚀",
    "🌿 Perfect! Understanding the world around you! 🌿",
    "🎊 Great job! Moving on... 🎊",
...
const MeasurementInRealLife = () => {
    ...
    useEffect(() => {
        ...
        startSession({ nodeId: 'a4051014-0009-0000-0000-000000000000', sessionType: 'practice' });
        ...
        const qs = [
            ...
            },
            {
                ...
                solution: `1 ton = 1,000 kg.<br/>
                                   Each kg = 1,000 g.<br/>
                    So, 1,000 × 1,000 = <strong>1,000,000 g</strong>.`
            },
            {
            ...
            },
            {
                ...
                solution: `Multiply volume by conversion factor:<br/>
                                   10 × 1,000 = <strong>10,000 Litres</strong>.`
            },
            {
            ...
            },
            {
                ...
                solution: `1. Total used = 10 × 250 ml = 2500 ml = 2.5 L.<br/>
