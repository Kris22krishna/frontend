...
const CORRECT_MESSAGES = [
    "✨ Amazing! You're a Volume Expert! ✨",
    "🌟 Brilliant! You measured that perfectly! 🌟",
    "🎉 Correct! The village thrives on your accuracy! 🎉",
    "✨ Fantastic work! ✨",
    "🚀 Super! Measurement Master at work! 🚀",
    "🌿 Perfect! Nature and science in harmony! 🌿",
    "🎊 Great job! Moving on... 🎊",
    "💎 Spot on! Precision is key! 💎"
];
...
const VolumeByDisplacement = () => {
    ...
    useEffect(() => {
        ...
        startSession({ nodeId: 'a4051014-0004-0000-0000-000000000000', sessionType: 'practice' });
            ...
            if (i < 3) {
                ...
                if (i === 3) {
                    ...
                    question = {
                        ...
                        solution: `1. Find total volume displaced: ${endLevel}ml - ${startLevel}ml = ${totalVol}ml.<br/>
                                   2. Divide by the number of marbles: ${totalVol}ml ÷ ${count} = <strong>${unitVol}ml</strong>.`
                    };
                } else {
                ...
                if (i < 8) {
                    ...
                    question = {
                        ...
                        solution: `1. Calculate the volume of the cube: Volume = side × side × side = ${side} × ${side} × ${side} = ${cubeVol} $cm^3$.<br/>
            ...
            <div className="junior-practice-page results-view overflow-y-auto" style={{ fontFamily: '"Open Sans", sans-serif' }}>
                ...
                <main className="practice-content results-content max-w-5xl mx-auto w-full px-4">
                    <div className="results-hero-section flex flex-col items-center mb-8">
                        <h2 className="text-4xl font-black text-[#31326F] mb-1">Experiment Complete! 🧪</h2>
