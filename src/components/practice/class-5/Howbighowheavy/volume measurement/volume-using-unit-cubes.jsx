...
const CORRECT_MESSAGES = [
    "✨ Perfect building skills! ✨",
    "🌟 You see the shapes clearly! 🌟",
    "🎉 Correct! You're a Volume Architect! 🎉",
    "✨ Fantastic work! ✨",
    "🚀 Super! You're stacking up knowledge! 🚀",
...
const VolumeUsingUnitCubes = () => {
    ...
    useEffect(() => {
        ...
        startSession({ nodeId: 'a4051014-0003-0000-0000-000000000000', sessionType: 'practice' });
            ...
            if (i < 3) {
                ...
                question = {
                    ...
                    solution: `To find the total number of cubes in a cuboid:<br/>
                               <strong>Volume = Length × Width × Height</strong><br/>
                               Volume = ${l} × ${w} × ${h} = <strong>${vol} cubes</strong>.`
                };
            } else {
                ...
                if (i === 6 || i === 7) {
                    ...
                    question = {
                        ...
                        solution: `For a cube, Length = Width = Height = ${side}.<br/>
                                   Volume = ${side} × ${side} × ${side} = <strong>${totalCubes} unit cubes</strong>.`
                    };
                }
            }
            questions.push({
            ...
            <div className="junior-practice-page results-view overflow-y-auto" style={{ fontFamily: '"Open Sans", sans-serif' }}>
                ...
                <main className="practice-content results-content max-w-5xl mx-auto w-full px-4">
                    <div className="results-hero-section flex flex-col items-center mb-8">
                        <h2 className="text-4xl font-black text-[#31326F] mb-1">Structure Complete! 🏗️</h2>
