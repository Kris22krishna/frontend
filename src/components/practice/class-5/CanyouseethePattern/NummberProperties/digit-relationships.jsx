...
const CORRECT_MESSAGES = [
    "✨ Digit Master! ✨",
    "🌟 Place value pro! 🌟",
    "🎉 Correct! You understand the relationships! 🎉",
    "✨ Fantastic work on these digits! ✨",
    "🚀 Super! You've got it! 🚀"
];

const DigitRelationships = () => {
    ...
    const SKILL_NAME = "Digit Relationships";
    ...
    useEffect(() => {
        ...
        startSession({ nodeId: 'a4051007-0010-0000-0000-000000000000', sessionType: 'practice' });
        ...
        const generateQuestions = () => {
            const qs = [];
            const easyData = [
                { num: 550, d: 5, p1: "tens", p2: "hundreds" },
                { num: 2200, d: 2, p1: "hundreds", p2: "thousands" },
                { num: 77, d: 7, p1: "ones", p2: "tens" }
            ];

            easyData.forEach(d => {
                qs.push({
                    text: `In the number ${d.num}, how many times greater is the ${d.d} in the ${d.p2} place than the ${d.d} in the ${d.p1} place?`,
                    correctAnswer: "10 times",
                    options: ["10 times", "100 times", "2 times", "Same value"],
                    solution: `As you move one place to the left, the value of the digit increases by <b>10 times</b>.`
                });
            });

            qs.push({
                text: "In 4,400, the 4 in the hundreds place is ____ the value of the 4 in the thousands place.",
                correctAnswer: "1/10",
                options: ["1/10", "10 times", "100 times", "1/100"],
                solution: "Moving one place to the right makes the value <b>1/10</b> of the previous place."
            });
            qs.push({
                text: "How many times greater is the 8 in the thousands place than the 8 in the tens place in 8,080?",
                correctAnswer: "100 times",
                options: ["100 times", "10 times", "1,000 times", "20 times"],
                solution: "Moving two places to the left ($10 \\times 10$) means <b>100 times</b> greater."
            });
            qs.push({
                text: "Which number has a 3 that is 10 times the value of the 3 in 350?",
                correctAnswer: "3,500",
                options: ["3,500", "35", "3,000", "300"],
                solution: "To be 10 times greater, the 3 must move from the hundreds place to the <b>thousands place</b>."
            });

            qs.push({
                text: "In 0.55, the 5 in the hundredths place is ____ the 5 in the tenths place.",
                correctAnswer: "1/10",
                options: ["1/10", "10 times", "1/100", "Same"],
                solution: "Moving right even in decimals is 1/10."
            });
            qs.push({
                text: "How many tenths make one unit (1.0)?",
                correctAnswer: "10",
                options: ["10", "100", "1", "0.1"],
                solution: "$10 \times 0.1 = 1.0$. So, 10 tenths make one unit."
            });
            qs.push({
                text: "The digit 2 in 2,468 is ____ times the value of the digit 4 in 2,468?",
                correctAnswer: "5",
                options: ["5", "10", "100", "2"],
                solution: "2 is $2,000$, 4 is $400$. $2,000/400 = 5$."
            });
            qs.push({
                text: "In the number 6,666, which digit has the greatest value relative to its position?",
                correctAnswer: "The leftmost 6",
                options: ["The leftmost 6", "The rightmost 6", "All have same value", "The second 6"],
                solution: "The leftmost 6 is in the thousands place ($6,000$), which is the highest value."
            });
    ...
    if (!currentQuestion && !showResults) return <div className="flex justify-center items-center h-screen text-[#31326F] font-bold">Connecting the digits...</div>;
        ...
        return (
            <div className="junior-practice-page results-view overflow-y-auto" style={{ fontFamily: '"Open Sans", sans-serif' }}>
                <header className="junior-practice-header results-header relative">
                    ...
                    <div className="title-area"><h1 className="results-title">Digit Report</h1></div>
                </header>
                <main className="practice-content results-content max-w-5xl mx-auto w-full px-4">
                    <div className="results-hero-section flex flex-col items-center mb-8">
                        <h2 className="text-4xl font-black text-[#31326F] mb-2">Relativity Decoded! ⚛️</h2>
                    ...
                    <div className="detailed-breakdown w-full mb-12">
                        <h3 className="text-2xl font-black text-[#31326F] mb-6 px-4">Relativity Log 📜</h3>
...
export default DigitRelationships;
