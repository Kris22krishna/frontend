...
export default function TheFishTaleReportModal({ isOpen, stats, onClose, onRetry }) {
        ...
        <div className={styles.ft_modal_overlay}>
            <div className={styles.ft_modal_content}>
                ...
                <p className={styles.ft_modal_subtitle}>
                    Excellent effort! Here's how you performed in the The Fish Tale chapter test.
                </p>
