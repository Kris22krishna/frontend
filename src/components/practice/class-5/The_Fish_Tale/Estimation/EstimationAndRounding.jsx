...
const EstimationAndRounding = () => {
    ...
    const SKILL_ID = "FT-05";
    const SKILL_NAME = "Estimation and rounding";
    ...
    const generateQuestions = () => {
        ...
        for (let i = 0; i < TOTAL_QUESTIONS; i++) {
            ...
            const roundPlace = places[Math.floor(Math.random() * places.length)];
            const placeName = roundPlace === 10 ? 'nearest 10' : roundPlace === 100 ? 'nearest 100' : 'nearest 1000';

            let qText = `Round off ${num.toLocaleString('en-IN')} to the ${placeName}.`;
            let correctAns = Math.round(num / roundPlace) * roundPlace;
            let opts = [
    ...
    useEffect(() => {
        startSession({ nodeId: 'a4051001-0005-0000-0000-000000000000', sessionType: 'practice' });
...
export default EstimationAndRounding;
