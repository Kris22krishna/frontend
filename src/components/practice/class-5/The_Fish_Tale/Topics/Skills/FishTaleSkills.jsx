            ...
            <div className={`ft-page ${view !== 'list' && view !== 'learn' ? 'ft-page-fixed' : ''}`}>
                <nav className="ft-topic-nav">
                    ...
                    <div style={{ display: 'flex', gap: 16 }}>
                        <span style={{ cursor: 'pointer', color: '#64748b', fontWeight: 600, fontSize: 13 }} onClick={() => navigate('/the-fish-tale/introduction')}>🌟 Intro</span>
                        <span style={{ cursor: 'pointer', color: '#64748b', fontWeight: 600, fontSize: 13 }} onClick={() => navigate('/the-fish-tale/terminology')}>📖 Terminology</span>
