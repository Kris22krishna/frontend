        ...
        const generateQuestions = () => {
            ...
            for (let i = 0; i < TOTAL_QUESTIONS; i++) {
                ...
                if (type === 1) { // Large Multiplication
                    ...
                    const res = a * b;
                    q = {
                        text: `<div class='question-container'><p>Multiply: $${a} \\times ${b}$</p></div>`,
                        correctAnswer: `${res}`,
                        solution: `$${a} \\times ${b} = ${res}$. You can use the area method or standard multiplication.`,
                    ...
                    const a = b * res;
                    q = {
                        text: `<div class='question-container'><p>Divide $${a}$ by $${b}$. What is the quotient?</p></div>`,
                        correctAnswer: `${res}`,
                        solution: `$${a} \\div ${b} = ${res}$. Divide digit by digit.`,
                        options: shuffle([`${res}`, `${res + 2}`, `${res - 2}`, `${res * 2}`])
                    };
                } else if (type === 3) { // Word Problem
                    const price = rand(10, 20) * 10;
                    const items = rand(5, items = rand(5, 15));
                    const total = price * items;
                    q = {
                        text: `<div class='question-container'><p>If one book costs $₹${price}$, how much will $${items}$ such books cost?</p></div>`,
                        correctAnswer: `$₹${total}$`,
                        solution: `Cost = Price per item $\\times$ Quantity = $₹${price} \\times ${items} = ₹${total}$.`,
                    ...
                    const a = b * qRes + rem;
                    q = {
                        text: `<div class='question-container'><p>Divide $${a}$ by $${b}$. What is the remainder?</p></div>`,
                        correctAnswer: `${rem}`,
                        solution: `$${a} = (${b} \\times ${qRes}) + ${rem}$. So the remainder is $${rem}$.`,
