...
const DivisionPracticeOneDigit = () => {
    ...
    const SKILL_NAME = "Divide by 1 digit number";
    ...
    useEffect(() => {
        ...
        startSession({ nodeId: 'a4051013-0006-0000-0000-000000000000', sessionType: 'practice' });
    ...
    const generateQuestion = (level) => {
        ...
        if (level === 0) {
            // Easy: 1-digit or 2-digit dividend by 1-digit divisor
            quotient = randomInt(2, 9);
            dividend = quotient * divisor;
            difficultyLabel = "Easy";
        } else if (level === 1) {
            // Medium: 3-digit dividend
            quotient = randomInt(11, 99);
            dividend = quotient * divisor;
            difficultyLabel = "Medium";
        } else {
            // Hard: 4-digit dividend
            quotient = randomInt(101, 999);
            dividend = quotient * divisor;
        ...
        solution += `We are finding how many groups of ${divisor} fit into ${dividend}.<br/><br/>`;
        ...
        while (options.length < 4) {
            const distractor = (quotient + randomInt(-5, 5)).toString();
...
export default DivisionPracticeOneDigit;
