...
const MultiplicationPractice = () => {
    ...
    const SKILL_NAME = "Multiplication of 2 digit numbers";
    ...
    useEffect(() => {
        ...
        startSession({ nodeId: 'a4051013-0001-0000-0000-000000000000', sessionType: 'practice' });
    ...
    const generateQuestion = (level) => {
        ...
        // Use level argument instead of state/index to avoid stale closure issues during transitions
        if (level === 0) {
            num1 = randomInt(11, 99);
            num2 = randomInt(11, 99);
            difficultyLabel = "Easy";
        } else if (level === 1) {
            num1 = randomInt(11, 99);
            num2 = randomInt(101, 999);
            difficultyLabel = "Medium";
        } else {
            num1 = randomInt(11, 99);
            num2 = randomInt(1001, 9999);
        ...
        let explanation = `To find the product of ${num1} and ${num2}:<br/>`;

        if (level === 0) {
            explanation += `
                1. Multiply ${num1} by the ones digit of ${num2}.<br/>
                2. Multiply ${num1} by the tens digit of ${num2} (and add a zero).<br/>
            `;
        } else if (level === 1) {
            explanation += `
                1. Multiply ${num1} by the ones digit of ${num2}.<br/>
                2. Multiply ${num1} by the tens digit of ${num2} (add zero).<br/>
                3. Multiply ${num1} by the hundreds digit of ${num2} (add two zeros).<br/>
            `;
        } else {
            explanation += `
                1. Multiply ${num1} by the ones digit of ${num2}.<br/>
                2. Multiply ${num1} by the tens digit of ${num2} (add zero).<br/>
                3. Multiply ${num1} by the hundreds digit of ${num2} (add two zeros).<br/>
                4. Multiply ${num1} by the thousands digit of ${num2} (add three zeros).<br/>
            `;
        }

        explanation += `
            <br/><strong>${num1} × ${num2} = ${product}</strong>
        `;
        ...
        while (options.length < 4) {
            const offset = randomInt(1, 5) * 10 + randomInt(0, 9);
    ...
    const handleNext = async () => {
        if (qIndex < TOTAL_QUESTIONS - 1) {
            ...
            if (userId) {
                ...
                try {
                    await api.createReport({
                        title: 'Multiplication Report', // Changed from SKILL_NAME
                        type: 'practice',
            ...
            setShowResults(true); // Added this line
        }
    };
