...
const MultiplicationPractice3D = () => {
    ...
    const SKILL_NAME = "Multiply 3 digit numbers";
    ...
    useEffect(() => {
        ...
        startSession({ nodeId: 'a4051013-0002-0000-0000-000000000000', sessionType: 'practice' });
    ...
    const generateQuestion = (level) => {
        ...
        if (level === 0) {
            explanation += `
                ...
                2. Multiply ${num1} by the tens digit (add zero).<br/>
                3. Multiply ${num1} by the hundreds digit (add two zeros).<br/>
            `;
        } else if (level === 1) {
            explanation += `
                1. Multiply ${num1} by the ones digit of ${num2}.<br/>
                2. Multiply ${num1} by the tens digit (add zero).<br/>
                3. Multiply ${num1} by the hundreds digit (add two zeros).<br/>
                4. Multiply ${num1} by the thousands digit (add three zeros).<br/>
            `;
        } else {
            explanation += `
                1. Multiply ${num1} by the ones digit of ${num2}.<br/>
                ...
                3. Multiply ${num1} by the hundreds digit (add two zeros).<br/>
                4. Multiply ${num1} by the thousands digit (add three zeros).<br/>
                5. Multiply ${num1} by the ten-thousands digit (add four zeros).<br/>
            `;
        }
        ...
        while (options.length < 4) {
            const offset = randomInt(1, 10) * 100 + randomInt(1, 99);
...
export default MultiplicationPractice3D;
