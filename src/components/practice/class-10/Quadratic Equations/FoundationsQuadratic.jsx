...
const FoundationsQuadratic = () => {
    ...
    const generateQuestions = () => {
        ...
        newQuestions.push(createQuestion(2,
            `Identify the coefficients $a, b, c$ in the equation $2x^2 - 3x + 1 = 0$.`,
            [`$a=2, b=-3, c=1$`, `$a=2, b=3, c=1$`, `$a=2, b=-3, c=-1$`, `$a=1, b=-3, c=2$`],
            `$a=2, b=-3, c=1$`,
            `Comparing with $ax^2 + bx + c = 0$: $a=2, b=-3, c=1$.`
        ));
        ...
        newQuestions.push(createQuestion(4,
            `What are the values of $a, b, c$ for the equation $x^2 + 5x - 6 = 0$?`,
            [`$a=1, b=5, c=-6$`, `$a=1, b=5, c=6$`, `$a=0, b=5, c=-6$`, `$a=1, b=-5, c=-6$`],
            `$a=1, b=5, c=-6$`,
            `Comparing with $ax^2 + bx + c = 0$: $a=1$ (coefficient of $x^2$), $b=5$, $c=-6$.`
        ));

        // Q5: Rearranging
        newQuestions.push(createQuestion(5,
            `Write the equation $3x^2 = 2x - 5$ in standard form.`,
            [`$3x^2 - 2x + 5 = 0$`, `$3x^2 + 2x - 5 = 0$`, `$3x^2 - 2x - 5 = 0$`, `$2x^2 - 3x + 5 = 0$`],
            `$3x^2 - 2x + 5 = 0$`,
            `Rearranging terms to LHS: $3x^2 - 2x + 5 = 0$.`
        ));
        ...
        newQuestions.push(createQuestion(6,
            ...
            [`2`, `1`, `3`, `0`],
            `2`,
            `A quadratic equation involves a polynomial of degree 2.`
        ));

        // Q7: Coefficients 3
        newQuestions.push(createQuestion(7,
            `If the equation is $4x^2 - 9 = 0$, what is the value of $b$?`,
            [`0`, `-9`, `4`, `9`],
            `0`,
            `Rewriting as $4x^2 + 0x - 9 = 0$, we see that $b=0$.`
        ));

        // Q8: Coefficients 4
        newQuestions.push(createQuestion(8,
            `Identify $a$ and $c$ in $7x^2 - x = 0$.`,
            [`$a=7, c=0$`, `$a=7, c=-1$`, `$a=1, c=0$`, `$a=0, c=0$`],
            `$a=7, c=0$`,
            `Standard form: $7x^2 - 1x + 0 = 0$. So $a=7, c=0$.`
        ));

        // Q9: Valid or Invalid
        newQuestions.push(createQuestion(9,
            `In the equation $ax^2 + bx + c = 0$, can $b$ or $c$ be zero?`,
            [`Yes`, `No, neither`, `No, only c`, `No, only b`],
            `Yes`,
            `Yes, $b$ and $c$ can be any real numbers, including zero. Only $a$ cannot be zero.`
        ));

        // Q10: General Form
        newQuestions.push(createQuestion(10,
            `Which represents a quadratic equation?`,
            [`$x(2x+3) = 5$`, `$x(x^2+1) = 0$`, `$2x+5=0$`, `$x^3 - x = 0$`],
            `$x(2x+3) = 5$`,
            `Expanding $x(2x+3)$ gives $2x^2 + 3x = 5$, which is degree 2.`
        ));
...
export default FoundationsQuadratic;
