...
const IdentifyingQuadratic = () => {
    ...
    const generateQuestions = () => {
        ...
        newQuestions.push(createQuestion(1,
            ...
            [`Yes`, `No`],
            `Yes`,
            `LHS: $x^2 - 4x + 4 + 1 = x^2 - 4x + 5$.
Eq: $x^2 - 4x + 5 = 2x - 3 \\Rightarrow x^2 - 6x + 8 = 0$.
It is of form $ax^2 + bx + c = 0$, so Yes.`
        ));

        // Q2: x(x+1) + 8 = (x+2)(x-2)
        newQuestions.push(createQuestion(2,
            `Is $x(x+1) + 8 = (x+2)(x-2)$ a quadratic equation?`,
            [`No`, `Yes`],
            `No`,
            `LHS: $x^2 + x + 8$. RHS: $x^2 - 4$.
Eq: $x^2 + x + 8 = x^2 - 4$.
$x^2$ terms cancel out $\\Rightarrow x + 12 = 0$. It is linear, so No.`
        ));

        // Q3: Cubic terms cancelling?
        newQuestions.push(createQuestion(3,
            `Is $(x+2)^3 = 2x(x^2 - 1)$ a quadratic equation?`,
            [`No`, `Yes`],
            `No`,
            `LHS: $x^3 + 6x^2 + 12x + 8$. RHS: $2x^3 - 2x$.
Rearranging: $x^3 - 6x^2 - 14x - 8 = 0$. Degree is 3, so No.`
        ));

        // Q4: Simple Linear
        newQuestions.push(createQuestion(4,
            `Check if $x^2 + 3x + 1 = (x-2)^2$ is quadratic.`,
            [`No`, `Yes`],
            `No`,
            `RHS: $x^2 - 4x + 4$.
Eq: $x^2 + 3x + 1 = x^2 - 4x + 4$.
$x^2$ cancels out $\\Rightarrow 7x - 3 = 0$. Linear, so No.`
        ));

        // Q5: Valid Quadratic
        newQuestions.push(createQuestion(5,
            `Is $(2x-1)(x-3) = (x+5)(x-1)$ quadratic?`,
            [`Yes`, `No`],
            `Yes`,
            `LHS: $2x^2 - 6x - x + 3 = 2x^2 - 7x + 3$.
RHS: $x^2 - x + 5x - 5 = x^2 + 4x - 5$.
Eq: $x^2 - 11x + 8 = 0$. Degree 2, so Yes.`
        ));
        ...
        newQuestions.push(createQuestion(7,
            `Is $(x+1)^2 = x^2 + 2x + 5$ a quadratic equation?`,
            [`No`, `Yes`],
            `No`,
            `LHS: $x^2 + 2x + 1$.
Eq: $x^2 + 2x + 1 = x^2 + 2x + 5 \\Rightarrow 1 = 5$, which is false (and definitely not quadratic).`
        ));

        // Q8: Root term
        newQuestions.push(createQuestion(8,
            `Is $x^2 + 2\\sqrt{x} - 3 = 0$ a quadratic equation?`,
            [`No`, `Yes`],
            `No`,
            `A quadratic equation involves polynomial terms. $\\sqrt{x}$ makes it not a polynomial equation of degree 2 in the standard sense.`
        ));
...
export default IdentifyingQuadratic;
