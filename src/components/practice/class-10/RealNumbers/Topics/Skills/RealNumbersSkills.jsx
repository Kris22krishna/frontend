        ...
        return (
            <div className="rn-page">
                ...
                <div className="rn-hero">
                    <h1 className="rn-hero-title">Core <span style={{ color: '#818cf8' }}>Skills</span></h1>
                    <p className="rn-hero-sub">Practice makes perfect. Choose a skill to start your journey.</p>
                </div>
                    ...
                    {SKILLS.map(s => (
                        <div key={s.id} className="rn-skill-card" style={{ '--skill-color': s.color }}>
                            ...
                            <div className="rn-skill-info">
                                <h3 className="rn-skill-title">{s.title}</h3>
