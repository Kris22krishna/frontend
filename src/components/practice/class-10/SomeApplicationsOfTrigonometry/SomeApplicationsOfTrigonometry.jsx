...
const MODULES = [
    {
        id: 'introduction',
        path: '/some-applications-of-trigonometry/introduction',
        label: 'Introduction',
        emoji: '🌟',
        tagline: '5W1H Exploration',
        desc: '6 Big Questions about Heights & Distances — What, Why, Who, When, Where and How.',
        gradFrom: '#0891b2',
        gradTo: '#06b6d4',
    ...
    {
        id: 'terminology',
        path: '/some-applications-of-trigonometry/terminology',
        label: 'Terminology',
        emoji: '📖',
        tagline: '10 Key Terms · 5 Rules',
        desc: 'Master the vocabulary — Line of Sight, Angles of Elevation & Depression & the 5 golden rules.',
        gradFrom: '#7c3aed',
        gradTo: '#a855f7',
    ...
    {
        id: 'skills',
        path: '/some-applications-of-trigonometry/skills',
        label: 'Skills',
        emoji: '🎯',
...
export default function SomeApplicationsOfTrigonometry() {
            ...
            <div className="sv-left">
                ...
                <div className="sv-left-content">
                    <h1 className="sv-main-title">
                        Master<br />
                        <span className="sv-title-accent">Heights & Distances</span>
                    </h1>

                    <p className="sv-main-sub">
                        From towers and shadows to rivers and buildings — master the
                        art of measuring the unmeasurable with trigonometry.
                    </p>
