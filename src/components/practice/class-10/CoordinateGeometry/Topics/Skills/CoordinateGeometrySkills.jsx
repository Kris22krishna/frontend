        ...
        return (
            <div className="rn-page">
                ...
                <div className="rn-hero" style={{ background: 'linear-gradient(145deg, #0f172a 0%, #1d4ed8 100%)' }}>
                    ...
                    <p className="rn-hero-sub">Practice makes perfect. Choose a skill to start mastering Coordinate Geometry.</p>
                </div>
...
/* ── Assess View Component (Without Palette) ── */
function AssessView({ skill, onComplete }) {
    ...
    return (
        <div className="quiz-engine-exam" style={{ maxWidth: '900px', margin: '0 auto', padding: '10px 0' }}>
            {/* Header */}
