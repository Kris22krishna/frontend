...
const MODULES = [
    {
        ...
        title: 'Introduction',
        tagline: 'START HERE',
        desc: 'Explore the Cartesian plane, coordinates, and the basic ideas that run through the whole chapter.',
        icon: '📈',
        color: '#2563eb',
        path: '/senior/grade/10/coordinate-geometry/introduction'
    },
    {
        id: 'terms',
        title: 'Terminology',
        tagline: 'THE LANGUAGE',
        desc: 'Master the theorem words, distance formula, section formula, and area language needed for proofs.',
        icon: '📘',
        color: '#0891b2',
        path: '/senior/grade/10/coordinate-geometry/terminology'
    },
    {
        id: 'skills',
        title: 'Skills',
        tagline: 'CORE PRACTICE',
        desc: 'Work through distance calculations, midpoint formulas, segment division, and real-life coordinate skills.',
        icon: '🎯',
        color: '#7c3aed',
        path: '/senior/grade/10/coordinate-geometry/skills'
    },
    {
        id: 'connect',
        title: 'Connectomics',
        tagline: 'BIG PICTURE',
        desc: 'See how coordinate geometry connects to GPS, maps, computer graphics, and design.',
        icon: '🔗',
        color: '#f59e0b',
        path: '/senior/grade/10/coordinate-geometry/connectomics'
    }
];

export default function CoordinateGeometryDashboard() {
            ...
            <div className="rn-left" style={{ background: 'linear-gradient(145deg, #0f172a 0%, #1d4ed8 40%, #0c4a6e 100%)' }}>
                ...
                <div className="rn-left-content">
                    ...
                    <h1 className="rn-main-title">
                        Master <br />
                        <span className="rn-title-accent">Coordinate Geometry</span>
                    </h1>
                    <p className="rn-main-sub">
                        Learn how to use coordinates to locate points, measure distances, find midpoints, and calculate areas of polygons on a graph.
                    </p>
