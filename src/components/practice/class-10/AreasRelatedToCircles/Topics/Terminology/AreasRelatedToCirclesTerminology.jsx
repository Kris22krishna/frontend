        ...
        <div className="rn-page">
            <nav className="rn-nav">
                ...
                <div className="rn-nav-links">
                    ...
                    <button className="rn-nav-link active" onClick={() => navigate('/senior/grade/10/areas-related-to-circles/terminology')}>📘 Terminology</button>
                    <button className="rn-nav-link" onClick={() => navigate('/senior/grade/10/areas-related-to-circles/skills')}>🎯 Skills</button>
                    <button className="rn-nav-link" onClick={() => navigate('/senior/grade/10/areas-related-to-circles/connectomics')}>🔗 Connectomics</button>
                </div>
            </nav>
            ...
            <div className="rn-lexicon-container">
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', marginBottom: 40 }}>
                    ...
                    <p style={{ fontSize: 18, fontWeight: 500, color: 'var(--rn-muted)', maxWidth: '650px', lineHeight: 1.6 }}>
                        {activeTab === 'quiz' ? 'Test your vocabulary and logic.' : `Explore the chapter through ${activeTab === 'terms' ? 'core terms' : '5 golden rules'} of areas.`}
                    </p>
                </div>
                        ...
                        {!quizFinished ? (
                            ...
                            <div style={{ textAlign: 'center', padding: '24px 0' }}>
                                ...
                                <div style={{ display: 'flex', gap: 16, justifyContent: 'center' }}>
                                    ...
                                    <button className="rn-btn-filled" onClick={() => navigate('/senior/grade/10/areas-related-to-circles/skills')} style={{ padding: '14px 32px', '--skill-color': 'var(--rn-indigo)' }}>Practical Skills →</button>
                                </div>
                            </div>
                        )}
                    </div>
                ...
                <div style={{ marginTop: 40, textAlign: 'center' }}>
                    <button className="rn-btn-filled" onClick={() => navigate('/senior/grade/10/areas-related-to-circles/skills')} style={{ padding: '12px 32px', fontSize: 15, '--skill-color': 'var(--rn-indigo)' }}>
