...
import { areasRelatedToCirclesIntroData } from './AreasRelatedToCirclesIntroData';
    ...
    return (
        ...
        >
            ...
            <div className="rn-intro-card-header">
                ...
                <div style={{ flex: 1 }}>
                    <div className="rn-intro-card-q" style={{ color: card.gradFrom }}><MathRenderer text={card.q} /></div>
...
export default function AreasRelatedToCirclesIntro() {
        ...
        <div className="rn-page">
            <nav className="rn-nav">
                ...
                <div className="rn-nav-links">
                    <button className="rn-nav-link active" onClick={() => navigate('/senior/grade/10/areas-related-to-circles/introduction')}>📐 Intro</button>
            ...
            <div className="rn-hero" style={{ background: 'linear-gradient(145deg, #0f172a 0%, #1d4ed8 100%)' }}>
                <h1 className="rn-hero-title">Dive into <span style={{ color: '#7dd3fc' }}>Areas Related to Circles</span></h1>
                <p className="rn-hero-sub">Explore arcs, sectors, segments, and their measurements.</p>
            </div>
            ...
            <main className="rn-topic-shell" style={{ maxWidth: '1200px', margin: '0 auto', padding: '40px 24px' }}>
                <section style={{ marginBottom: '60px' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(280px, 100%), 1fr))', gap: '24px' }}>
                        {areasRelatedToCirclesIntroData.prerequisites.map((item, idx) => (
                ...
                <div className="rn-grid" style={{ padding: 0 }}>
                    {areasRelatedToCirclesIntroData.cards5W1H.map((card, idx) => (
                ...
                <div style={{ marginTop: '60px', padding: '32px', background: 'linear-gradient(135deg, #0f172a, #1d4ed8)', borderRadius: '24px', color: '#fff', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '20px' }}>
                    <div>
                        <h3 style={{ fontSize: '20px', fontWeight: 800, margin: '0 0 4px' }}>Ready for the language of circles?</h3>
                        <p style={{ margin: 0, opacity: 0.8 }}>Next up: key terms, formulas, and the rules of circular areas.</p>
                    </div>
                    <button
                        onClick={() => navigate('/senior/grade/10/areas-related-to-circles/terminology')}
