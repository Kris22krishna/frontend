...
- Equal angles alone are not enough for general polygons`,
        ...
        practice: [
            ...
            { question: 'Two rectangles have sides $2, 4$ and $3, 6$. They are:', options: ['Similar', 'Not similar', 'Congruent', 'Squares'], correct: 0, explanation: 'The side ratios match: $\\frac{2}{3} = \\frac{4}{6}$ and all angles are right angles.' },
...
Once triangles are similar, corresponding sides are proportional and corresponding angles are equal.`,
        ...
        practice: [
            ...
            { question: 'If corresponding sides of two similar triangles are in the ratio $3:5$, and one side in the first triangle is $12$, the corresponding side in the second is:', options: ['15', '18', '20', '24'], correct: 2, explanation: '$\\frac{3}{5} = \\frac{12}{x}$ gives $x = 20$.' },
        ...
        assessment: [
            ...
            { question: 'If $\\triangle ABC \\sim \\triangle DEF$ and $AB=8$, $DE=12$, $BC=10$, then $EF$ is:', options: ['$12$', '$15$', '$18$', '$20$'], correct: 1, explanation: 'The scale factor is $\\frac{12}{8} = \\frac{3}{2}$, so $EF = 10 \\times \\frac{3}{2} = 15$.' },
...
Conversely, if these two ratios are equal, then the joining line is parallel to the third side.`,
            ...
            examples: [
                { q: 'If $DE \\parallel BC$, what is true?', a: '$\\frac{AD}{DB} = \\frac{AE}{EC}$.' },
                { q: 'If $\\frac{AD}{DB} = \\frac{AE}{EC}$, what can we conclude?', a: '$DE \\parallel BC$ by the converse of BPT.' }
            ]
        },
        practice: [
            { question: 'If $DE \\parallel BC$ in $\\triangle ABC$, then:', options: ['$\\frac{AD}{DB} = \\frac{AE}{EC}$', '$\\frac{AD}{AE} = \\frac{DB}{BC}$', '$AE = EC$', '$AD = DB$'], correct: 0, explanation: 'That is the statement of BPT.' },
            ...
            { question: 'If $\\frac{AD}{DB} \\ne \\frac{AE}{EC}$, then $DE$ is:', options: ['Definitely parallel to $BC$', 'Definitely perpendicular to $BC$', 'Not proved parallel to $BC$', 'Equal to $BC$'], correct: 2, explanation: 'The converse condition is not satisfied.' },
            { question: 'If $AD=4$, $DB=6$, and $AE=8$, then $EC$ equals:', options: ['10', '12', '6', '4'], correct: 1, explanation: '$\\frac{4}{6} = \\frac{8}{EC}$, so $EC = 12$.' },
            ...
            { question: 'If $\\frac{AD}{DB} = \\frac{5}{7}$ and $AE = 15$, then $EC$ is:', options: ['18', '20', '21', '24'], correct: 2, explanation: '$\\frac{5}{7} = \\frac{15}{EC}$, so $EC = 21$.' },
            { question: 'Which statement follows from $DE \\parallel BC$?', options: ['$\\frac{AD}{AB} = \\frac{AE}{AC}$', '$AD = AE$', '$DB = EC$', '$AB = AC$'], correct: 0, explanation: 'The smaller triangle is similar to the whole triangle, giving equal corresponding ratios.' },
            { question: 'If $AD = 3$, $DB = 9$, and $AE = 5$, then $EC$ is:', options: ['10', '12', '15', '18'], correct: 2, explanation: '$\\frac{3}{9} = \\frac{5}{EC}$, so $EC = 15$.' },
        ...
        assessment: [
            ...
            { question: 'If $\\frac{AD}{DB} = \\frac{AE}{EC}$, then the joining line through $D$ and $E$ is justified by:', options: ['BPT', 'Converse of BPT', 'SSS', 'SAS'], correct: 1, explanation: 'Equal side ratios imply parallelism by the converse.' },
            { question: 'If $DE \\parallel BC$ and $AB = 12$, $AD = 4$, then $\\frac{AE}{AC}$ equals:', options: ['$\\frac{1}{4}$', '$\\frac{1}{3}$', '$\\frac{1}{2}$', '$\\frac{2}{3}$'], correct: 1, explanation: 'Since $\\frac{AD}{AB} = \\frac{AE}{AC}$, we get $\\frac{AE}{AC} = \\frac{4}{12} = \\frac{1}{3}$.' },
            { question: 'If $AD = 2$, $DB = 3$, and $AE = 4$, then $AC$ is:', options: ['8', '10', '12', '14'], correct: 1, explanation: 'From BPT, $\\frac{2}{3} = \\frac{4}{EC}$, so $EC = 6$ and $AC = 10$.' },
            ...
            { question: 'If $\\frac{AD}{AB} = \\frac{AE}{AC}$, then this usually suggests:', options: ['Congruence', 'BPT or similarity due to a parallel line', 'A circle theorem', 'Only area comparison'], correct: 1, explanation: 'These equal ratios commonly arise from BPT or the similarity created by a parallel segment.' },
            { question: 'If $\\frac{AD}{DB} = \\frac{4}{5}$ and $AE = 12$, then $AC$ is:', options: ['21', '24', '27', '30'], correct: 2, explanation: '$\\frac{4}{5} = \\frac{12}{EC}$ gives $EC = 15$, so $AC = 12 + 15 = 27$.' }
        ]
    },
    {
...
4. Solve for the unknown length`,
            ...
            examples: [
                { q: 'If $AD=3$, $DB=2$, and $AE=9$, find $EC$.', a: 'By BPT, $\\frac{3}{2} = \\frac{9}{EC}$, so $EC = 6$.' },
                { q: 'What is the biggest help in these questions?', a: 'Correct correspondence and careful substitution.' }
            ]
        },
        practice: [
            { question: 'If $\\frac{AD}{DB} = \\frac{2}{3}$ and $AE = 8$, then $EC$ is:', options: ['10', '12', '6', '4'], correct: 1, explanation: '$\\frac{2}{3} = \\frac{8}{EC}$, so $EC = 12$.' },
            ...
            { question: 'If the ratio is $5:7$ and one segment is 15, the matching segment is:', options: ['21', '35', '10.5', '12'], correct: 0, explanation: '$\\frac{5}{7} = \\frac{15}{x}$, so $x=21$.' },
            ...
            { question: 'If triangles are similar with side ratio $3:4$, then the side corresponding to 12 is:', options: ['9', '16', '15', '8'], correct: 1, explanation: '$\\frac{3}{4} = \\frac{12}{x}$, so $x = 16$.' },
            { question: 'If $\\frac{AD}{DB} = \\frac{4}{9}$ and $AE = 12$, then $EC$ is:', options: ['18', '21', '27', '24'], correct: 2, explanation: '$\\frac{4}{9} = \\frac{12}{EC}$, so $EC = 27$.' },
            { question: 'If $DE \\parallel BC$ and $AD = 5$, $AB = 15$, then $\\frac{AE}{AC}$ equals:', options: ['$\\frac{1}{2}$', '$\\frac{1}{3}$', '$\\frac{2}{3}$', '$\\frac{3}{5}$'], correct: 1, explanation: 'From similarity, $\\frac{AD}{AB} = \\frac{AE}{AC} = \\frac{5}{15} = \\frac{1}{3}$.' },
            { question: 'If a smaller triangle inside a larger triangle is similar with scale factor $2:5$, then a corresponding side of the larger triangle measuring 25 gives the smaller side as:', options: ['5', '8', '10', '12.5'], correct: 2, explanation: '$\\frac{2}{5} = \\frac{x}{25}$, so $x = 10$.' },
            { question: 'If $AD = 7$, $DB = 5$, and $AE = 14$, then $EC$ is:', options: ['8', '10', '12', '15'], correct: 1, explanation: '$\\frac{7}{5} = \\frac{14}{EC}$, so $EC = 10$.' },
        ...
        assessment: [
            { question: 'If $DE \\parallel BC$, $AD=6$, $DB=4$, and $AE=9$, then $EC$ is:', options: ['6', '4', '9', '15'], correct: 0, explanation: '$\\frac{6}{4} = \\frac{9}{EC}$, so $EC=6$.' },
            { question: 'If $AD:AB = 3:5$ and $AB=20$, then $AD=$', options: ['10', '12', '15', '8'], correct: 1, explanation: '$AD = \\left(\\frac{3}{5}\\right)\\times 20 = 12$.' },
            ...
            { question: 'If $\\frac{AD}{DB} = \\frac{AE}{EC}$, then the line through $D$ and $E$ is:', options: ['A median', 'Parallel to $BC$', 'Perpendicular to $BC$', 'Equal to $BC$'], correct: 1, explanation: 'That follows from converse BPT.' },
            { question: 'If $AD = 8$, $DB = 12$, and $AE = 10$, then $EC$ is:', options: ['12', '15', '18', '20'], correct: 1, explanation: '$\\frac{8}{12} = \\frac{10}{EC}$, so $EC = 15$.' },
            ...
            { question: 'If corresponding sides of similar triangles are in ratio $5:8$ and the smaller side is $20$, the larger is:', options: ['24', '28', '32', '36'], correct: 2, explanation: '$\\frac{5}{8} = \\frac{20}{x}$, so $x=32$.' },
            { question: 'If $\\frac{AD}{AB} = \\frac{2}{5}$ and $AB = 25$, then $DB$ is:', options: ['10', '12', '15', '20'], correct: 2, explanation: '$AD = 10$, so $DB = 25 - 10 = 15$.' },
...
The goal is to pick the shortest correct test for the given data.`,
        ...
        practice: [
            ...
            { question: 'If $\\frac{AB}{DE} = \\frac{BC}{EF} = \\frac{AC}{DF}$, use:', options: ['AA', 'SAS', 'SSS', 'BPT'], correct: 2, explanation: 'All three side pairs are proportional.' },
            { question: 'If $\\frac{AB}{DE} = \\frac{AC}{DF}$ and $\\angle A = \\angle D$, use:', options: ['SSS', 'SAS', 'AA', 'Converse BPT'], correct: 1, explanation: 'Two side ratios and the included angle give SAS.' },
            ...
            { question: 'For SAS similarity, if $\\frac{AB}{DE} = \\frac{AC}{DF}$, then which angle must equal $\\angle A$?', options: ['$\\angle E$', '$\\angle F$', '$\\angle D$', '$\\angle EDF$'], correct: 2, explanation: 'The included angle between the compared sides must correspond, so $\\angle A = \\angle D$.' },
        ...
        assessment: [
            ...
            { question: 'If $\\frac{AB}{DE} = \\frac{AC}{DF}$ but $\\frac{BC}{EF}$ is different, then SSS similarity is:', options: ['Valid', 'Invalid', 'Always half-valid', 'A theorem'], correct: 1, explanation: 'All three side ratios must match for SSS.' },
            ...
            { question: 'If $\\frac{AB}{DE} = \\frac{BC}{EF} = \\frac{CA}{FD}$, then the triangles are similar by:', options: ['AA', 'SSS', 'SAS', 'BPT'], correct: 1, explanation: 'Equal ratios of all three corresponding sides prove SSS similarity.' },
            { question: 'Which condition proves triangles similar by SAS?', options: ['$\\frac{AB}{DE} = \\frac{AC}{DF}$ and $\\angle A = \\angle D$', '$AB = DE$ and $\\angle B = \\angle E$', '$\\frac{AB}{DE} = \\frac{BC}{EF}$', '$\\angle A = \\angle D$ only'], correct: 0, explanation: 'SAS requires two proportional sides and the included angle equal.' },
...
That is why one similarity proof often solves an entire geometry problem.`,
        ...
        practice: [
            ...
            { question: 'If similar triangles have side ratio $2:5$ and the smaller side is 8, the larger is:', options: ['10', '16', '20', '25'], correct: 2, explanation: '$\\frac{2}{5} = \\frac{8}{x}$, so $x=20$.' },
            ...
            { question: 'If two similar triangles have side ratio $3:7$ and the smaller perimeter is 18, the larger perimeter is:', options: ['24', '36', '42', '54'], correct: 2, explanation: 'Perimeters scale in the same ratio, so $18 \\times \\frac{7}{3} = 42$.' },
            ...
            { question: 'If the corresponding side of the larger triangle is 28 and the scale factor from smaller to larger is $4$, then the smaller side is:', options: ['6', '7', '8', '14'], correct: 1, explanation: 'The smaller side is $\\frac{28}{4} = 7$.' },
        ...
        assessment: [
            { question: 'If $\\triangle ABC \\sim \\triangle DEF$ and $\\frac{AB}{DE} = \\frac{4}{7}$, then a side corresponding to 20 becomes:', options: ['35', '28', '16', '80'], correct: 0, explanation: '$\\frac{4}{7} = \\frac{20}{x}$, so $x = 35$.' },
            { question: 'Enlargement by scale factor $s$ changes lengths by:', options: ['$s$', '$s^2$', '$\\frac{1}{s}$', 'No change'], correct: 0, explanation: 'Linear measures scale directly by $s$.' },
            ...
            { question: 'If two similar triangles have side ratio $5:6$ and the smaller area is $50$, the larger area is:', options: ['$60$', '$72$', '$75$', '$90$'], correct: 1, explanation: 'Area ratio is $25:36$, so larger area is $50 \\times \\frac{36}{25} = 72$.' },
            { question: 'If a corresponding side increases from 9 to 27, the scale factor is:', options: ['$2$', '$3$', '$9$', '$18$'], correct: 1, explanation: '$\\frac{27}{9} = 3$.' },
            ...
            { question: 'If the linear scale factor is $\\frac{1}{2}$, then the area scale factor is:', options: ['$\\frac{1}{2}$', '$\\frac{1}{4}$', '$2$', '$4$'], correct: 1, explanation: 'Area scale factor is the square of the side scale factor.' },
...
The main idea is that equal light angles create similar triangles.`,
            ...
            examples: [
                { q: 'A 2 m pole casts a 3 m shadow and a tower casts a 12 m shadow. Height of tower?', a: '$\\frac{2}{3} = \\frac{h}{12}$, so $h = 8$ m.' },
                { q: 'Why do shadow problems work?', a: 'Objects and shadows form similar right triangles under the same sunlight.' }
            ]
        },
        practice: [
            { question: 'A 3 m pole casts a 4 m shadow. A tree casts an 8 m shadow. Tree height is:', options: ['4 m', '5 m', '6 m', '9 m'], correct: 2, explanation: '$\\frac{3}{4} = \\frac{h}{8}$, so $h = 6$ m.' },
            ...
            { question: 'A person 1.5 m tall casts a 2 m shadow, while a post casts a 6 m shadow. Post height is:', options: ['3 m', '4.5 m', '6 m', '9 m'], correct: 1, explanation: '$\\frac{1.5}{2} = \\frac{h}{6}$, so $h = 4.5$ m.' },
            ...
            { question: 'A 4 m stick casts a 6 m shadow. A building casts a 24 m shadow. Building height is:', options: ['12 m', '14 m', '16 m', '18 m'], correct: 2, explanation: '$\\frac{4}{6} = \\frac{h}{24}$, so $h = 16$ m.' },
            ...
            { question: 'A 2.5 m object casts a 5 m shadow. Another object casts a 14 m shadow. Its height is:', options: ['5 m', '6 m', '7 m', '8 m'], correct: 2, explanation: '$\\frac{2.5}{5} = \\frac{h}{14}$, so $h = 7$ m.' },
        ...
        assessment: [
            { question: 'A 5 m pole casts a 10 m shadow. A building casts a 50 m shadow. Building height is:', options: ['20 m', '25 m', '30 m', '40 m'], correct: 1, explanation: '$\\frac{5}{10} = \\frac{h}{50}$, so $h = 25$ m.' },
            ...
            { question: 'A 6 m pole casts an 8 m shadow. A tower casts a 24 m shadow. Tower height is:', options: ['12 m', '16 m', '18 m', '20 m'], correct: 2, explanation: '$\\frac{6}{8} = \\frac{h}{24}$, so $h = 18$ m.' },
            { question: 'A child 1.2 m tall casts a 0.8 m shadow. A tree casts a 6 m shadow. Tree height is:', options: ['7.2 m', '8.4 m', '9 m', '10.2 m'], correct: 2, explanation: '$\\frac{1.2}{0.8} = \\frac{h}{6}$, so $h = 9$ m.' },
