...
const realNumberClassificationQuestions = [
    { question: 'Is $0$ a Rational Number?', options: ['Yes, it can be written as 0/1', 'No, zero is not a number', 'No, because it is an integer', 'Maybe'], correct: 0, explanation: 'Yes, any integer $n$ can be written as $n/1$, making it rational.' },
    ...
    { question: 'Can an Irrational number be written in $p/q$ form?', options: ['Yes', 'No', 'Only if p is zero', 'Sometimes'], correct: 1, explanation: 'No, by definition, irrational numbers cannot be expressed as a ratio of two integers.' },
...
const classificationAssessment = [
    { question: 'Is $-5$ a rational number?', options: ['Yes', 'No', 'Only if positive', 'None of these'], correct: 0, explanation: '$-5$ can be written as $-5/1$, which is the $p/q$ form.' },
    ...
    { question: 'Which of the following is an irrational number?', options: ['$\\sqrt{7}$', '$\\sqrt{25}$', '$3.14$', '$22/7$'], correct: 0, explanation: '$\\sqrt{7}$ is the square root of a non-perfect square, making it irrational.' },
...
const decimalExpansionQuestions = [
    { question: 'What is the decimal expansion of $1/3$?', options: ['$0.3\\bar{3}$', '$0.3$', '$0.03$', '$0.31$'], correct: 0, explanation: '$1 \\div 3 = 0.333...$ which is recurring/repeating.' },
    ...
    { question: 'Convert $0.\\bar{6}$ to a fraction.', options: ['$2/3$', '$6/10$', '$1/6$', '$3/2$'], correct: 0, explanation: '$0.666... = 6/9 = 2/3$.' },
];

const decimalAssessment = [
    { question: 'What is the decimal expansion of $2/5$?', options: ['$0.2$', '$0.4$', '$0.5$', '$2.5$'], correct: 1, explanation: '$2 \\div 5 = 0.4$, which is a terminating decimal.' },
    { question: 'A rational number $p/q$ has a terminating decimal if $q$ has factors of only:', options: ['$2$ and $5$', '$3$ and $7$', 'Any prime', '$2$, $3$ and $5$'], correct: 0, explanation: 'For a terminating decimal, the denominator must be in the form $2^n 5^m$.' },
    ...
    { question: 'Express $0.\\bar{3}$ as a fraction in simplest form.', options: ['$3/10$', '$1/3$', '$3/99$', '$33/100$'], correct: 1, explanation: '$0.333... = 3/9 = 1/3$.' },
    { question: 'Which of the following has a terminating decimal expansion?', options: ['$1/7$', '$1/3$', '$1/4$', '$2/11$'], correct: 2, explanation: '$1/4 = 0.25$, which terminates.' },
    ...
    { question: 'Express $0.\\bar{47}$ in $p/q$ form.', options: ['$47/100$', '$47/90$', '$47/99$', '$4.7/10$'], correct: 2, explanation: 'Two repeating digits mean we divide by 99.' },
    { question: 'If $x = 0.999...$, then $x$ is equal to:', options: ['$0.9$', '$1$', '$9/10$', '$9.9$'], correct: 1, explanation: '$10x = 9.999...$, so $9x = 9$, which means $x = 1$.' },
    ...
    { question: 'Which of the following is equal to $0.\\bar{3} + 0.\bar{6}$?', options: ['$0.9$', '$0.99$', '$1$', '$0.\bar{12}$'], correct: 2, explanation: '$1/3 + 2/3 = 1$.' },
];
...
const rationalisationQuestions = [
    { question: 'Rationalise: $1/\\sqrt{2}$', options: ['$\\sqrt{2}/2$', '$\\sqrt{2}$', '$2/\\sqrt{2}$', '$1/2$'], correct: 0, explanation: 'Multiply top and bottom by $\\sqrt{2}$: $(1 \\cdot \\sqrt{2}) / (\\sqrt{2} \\cdot \\sqrt{2}) = \\sqrt{2}/2$.' },
    { question: 'To rationalise $1/(\\sqrt{3}-1)$, we multiply by:', options: ['$\\sqrt{3}+1$', '$\\sqrt{3}-1$', '$1$', '$\\sqrt{3}$'], correct: 0, explanation: 'We multiply by the conjugate ($\\sqrt{3}+1$) to use the $(a-b)(a+b) = a^2-b^2$ identity.' },
    { question: 'Simplify: $1/\\sqrt{7}$', options: ['$\\sqrt{7}/7$', '$7/\\sqrt{7}$', '$\\sqrt{7}$', '$1/7$'], correct: 0, explanation: 'Rationalised form is $\\sqrt{7}/7$.' },
];

const rationalisationAssessment = [
    { question: 'Rationalise the denominator of $1/\\sqrt{5}$.', options: ['$5/\\sqrt{5}$', '$\\sqrt{5}/5$', '$1/5$', '$\\sqrt{5}$'], correct: 1, explanation: 'Multiply numerator and denominator by $\\sqrt{5}$.' },
    ...
    { question: 'Rationalise: $2/\\sqrt{6}$.', options: ['$\\sqrt{6}/3$', '$\\sqrt{6}$', '$2\\sqrt{6}/6$', '$\\sqrt{6}/2$'], correct: 0, explanation: '$2\\sqrt{6}/6 = \\sqrt{6}/3$.' },
    { question: 'Rationalise the denominator of $1/(\\sqrt{2} + 1)$.', options: ['$\\sqrt{2}-1$', '$\\sqrt{2}+1$', '$1/(\\sqrt{2}-1)$', '$\\sqrt{2}$'], correct: 0, explanation: 'Multiply by $(\\sqrt{2}-1)/(\\sqrt{2}-1)$, denominator becomes $2-1=1$.' },
    ...
    { question: 'Simplify: $1/(\\sqrt{5} + \\sqrt{2}) + 1/(\\sqrt{5} - \\sqrt{2})$', options: ['$2\\sqrt{5}/3$', '$2\\sqrt{2}/3$', '$\\sqrt{5}$', '$3/2\\sqrt{5}$'], correct: 0, explanation: '$[ (\\sqrt{5}-\\sqrt{2}) + (\\sqrt{5}+\\sqrt{2}) ] / (5-2) = 2\\sqrt{5}/3$.' },
    { question: 'If $1/(\\sqrt{3} + \\sqrt{2}) = a\\sqrt{3} + b\\sqrt{2}$, find $a$ and $b$.', options: ['$a=1, b=1$', '$a=1, b=-1$', '$a=-1, b=1$', '$a=-1, b=-1$'], correct: 1, explanation: 'Rationalisation gives $\\sqrt{3}-\\sqrt{2}$. So $a=1, b=-1$.' },
    { question: 'Rationalise: $3/(\\sqrt{3} - \\sqrt{2})$.', options: ['$3(\\sqrt{3}+\\sqrt{2})$', '$\\sqrt{3}+\\sqrt{2}$', '$3$', '$3\\sqrt{3}-3\\sqrt{2}$'], correct: 0, explanation: 'Denominator becomes $3-2=1$.' },
    { question: 'Rationalise: $1/(7 + 3\\sqrt{2})$.', options: ['$(7-3\\sqrt{2})/31$', '$(7-3\\sqrt{2})/49$', '$(7+3\\sqrt{2})/31$', '$7-3\\sqrt{2}$'], correct: 0, explanation: 'Denominator is $7^2 - (3\\sqrt{2})^2 = 49 - 18 = 31$.' },
    { question: 'Rationalise: $1/(\\sqrt{7} - \\sqrt{6})$.', options: ['$\\sqrt{7}+\\sqrt{6}$', '$\\sqrt{7}-\\sqrt{6}$', '$\\sqrt{13}$', '$1$'], correct: 0, explanation: 'Denominator becomes $7-6=1$.' },
];
...
const lawsOfExponentsQuestions = [
    ...
    { question: 'Simplify: $7^5 / 7^3$', options: ['$7^2$', '$7^8$', '$7^{15}$', '$1^2$'], correct: 0, explanation: 'Subtract powers: $5-3=2$. Result: $7^2$.' },
...
const exponentsAssessment = [
    ...
    { question: 'Simplify: $10^5 / 10^2$', options: ['$10^7$', '$10^3$', '$1^3$', '$10^{10}$'], correct: 1, explanation: 'Subtract exponents: $5-2=3$.' },
    { question: 'Value of $125^{1/3}$ is:', options: ['$5$', '$25$', '$15$', '$50$'], correct: 0, explanation: '$5^3 = 125$, so cube root is $5$.' },
    { question: 'Value of $64^{-1/2}$ is:', options: ['$8$', '$-8$', '$1/8$', '$-1/8$'], correct: 2, explanation: '$1/64^{1/2} = 1/\\sqrt{64} = 1/8$.' },
    { question: 'Simplify: $(16/81)^{1/4}$', options: ['$2/3$', '$4/9$', '$8/27$', '$2/9$'], correct: 0, explanation: 'Fourth root of 16 is 2, and of 81 is 3.' },
    ...
    { question: 'Simplify: $(p^a/p^b)^{a+b} \\cdot (p^b/p^c)^{b+c} \\cdot (p^c/p^a)^{c+a}$', options: ['$p^{a+b+c}$', '$1$', '$0$', '$p^{abc}$'], correct: 1, explanation: 'Powers become $(a^2-b^2) + (b^2-c^2) + (c^2-a^2) = 0$. $p^0 = 1$.' },
];

const chapterAssessment = [
    // --- EASY (Q1-Q6) ---
    { question: 'Is $0$ a rational number?', options: ['Yes', 'No', 'Only if positive', 'None of these'], correct: 0, explanation: '$0$ can be written as $0/1$, which is rational.' },
    ...
    { question: 'What is the decimal expansion of $1/3$?', options: ['$0.3$', '$0.\\bar{3}$', '$0.03$', '$0.31$'], correct: 1, explanation: '$1/3 = 0.333... = 0.\\bar{3}$.' },
    { question: 'Simplify: $\\sqrt{12}$', options: ['$6$', '$3\\sqrt{2}$', '$2\\sqrt{3}$', '$4\\sqrt{3}$'], correct: 2, explanation: '$\\sqrt{12} = \\sqrt{4 \\times 3} = 2\\sqrt{3}$.' },
    { question: 'Rationalise: $1/\\sqrt{2}$', options: ['$\\sqrt{2}$', '$\\sqrt{2}/2$', '$2/\\sqrt{2}$', '$1/2$'], correct: 1, explanation: 'Multiply by $\\sqrt{2}/\\sqrt{2}$.' },
    ...
    { question: 'Rationalise: $1/(\\sqrt{2} + 1)$', options: ['$\\sqrt{2}+1$', '$\\sqrt{2}-1$', '$1/(\\sqrt{2}-1)$', '$\\sqrt{2}$'], correct: 1, explanation: 'Multiply by $(\\sqrt{2}-1)$. Denominator becomes $2-1=1$.' },
    { question: 'Simplify: $(16/81)^{1/4}$', options: ['$2/3$', '$4/9$', '$8/27$', '$2/9$'], correct: 0, explanation: 'Take the 4th root of both 16 and 81.' },
...
export const SKILLS = [
    {
        ...
        learn: {
            ...
            rules: [
                { title: 'Rational Numbers', f: 'p/q, q \\neq 0', d: 'Numbers that can be expressed as a fraction of two integers.', ex: '$2/3, -5, 0.75$', tip: 'If it can be a fraction, it\'s rational!' },
    ...
    },
    {
        ...
        learn: {
            ...
            rules: [
                { title: 'Terminating', f: '0.125', d: 'The division ends after finite steps.', ex: '$1/8 = 0.125$', tip: 'These are always Rational.' },
                { title: 'Recurring', f: '0.333...', d: 'A block of digits repeats infinitely.', ex: '$1/3 = 0.\\bar{3}$', tip: 'These are also always Rational.' },
            ]
        }
    },
    {
    ...
    },
    {
        ...
        learn: {
            ...
            rules: [
                { title: 'Monomial Denom.', f: '1/\\sqrt{a} \\cdot \\sqrt{a}/\\sqrt{a}', d: 'Multiply by the same surd.', ex: '$1/\\sqrt{3} = \\sqrt{3}/3$', tip: 'The goal is to get a rational number on the bottom.' },
                { title: 'Binomial Denom.', f: '\\text{Use Conjugate}', d: 'Multiply by swapping the middle sign.', ex: '$1/(\\sqrt{2}-1) \\cdot (\\sqrt{2}+1)/(\\sqrt{2}+1)$', tip: 'Uses $(a-b)(a+b) = a^2-b^2$.' },
            ]
        }
    },
    {
