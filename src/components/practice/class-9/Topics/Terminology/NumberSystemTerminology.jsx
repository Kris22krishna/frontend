        ...
        <div className="terminology-page">
            ...
            <nav className="intro-nav">
                ...
                <div className="intro-nav-links">
                    <button className="intro-nav-link" onClick={() => navigate('/senior/grade/9/number-system/introduction')}>🌟 Introduction</button>
                    <button className="intro-nav-link intro-nav-link--active" onClick={() => navigate('/senior/grade/9/number-system/terminology')}>📖 Terminology</button>
                    <button className="intro-nav-link" onClick={() => navigate('/senior/grade/9/number-system/skills')}>🎯 Skills</button>
                </div>
            </nav>
            ...
            <div className="alg-lexicon-container" style={{ maxWidth: 1100, margin: '40px auto 20px', padding: '0 24px' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', marginBottom: 20 }}>
                    <h1 style={{ fontFamily: 'Outfit, sans-serif', fontSize: '2.8rem', fontWeight: 900, color: 'var(--alg-text)', margin: '0 0 8px' }}>
                        Number System <span style={{ background: 'linear-gradient(135deg, var(--alg-teal), var(--alg-indigo))', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Vocabulary</span>
                    </h1>
                ...
                <div style={{ display: 'flex', justifyContent: 'center', gap: 8, marginBottom: 16 }}>
                    ...
                    <button className={`alg-tab ${activeTab === 'rules' ? 'active' : ''}`} onClick={() => setActiveTab('rules')}>📏 Key Rules</button>
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <div style={{ display: 'flex', flexDirection: 'column' }}>
                                                <span style={{ fontWeight: 800, fontSize: 16, color: isActive ? '#fff' : 'var(--alg-text)', lineHeight: 1 }}>{rule.title}</span>
                                                <span style={{ fontSize: 11, fontWeight: 700, color: isActive ? 'rgba(255,255,255,0.8)' : 'var(--alg-muted)', textTransform: 'uppercase', letterSpacing: 0.5, marginTop: 4 }}>Rule {rule.num}</span>
                                            </div>
                        ...
                        {!quizFinished ? (
                            ...
                            <div style={{ textAlign: 'center', padding: '20px 0' }}>
                                ...
                                <div style={{ display: 'flex', gap: 12, justifyContent: 'center' }}>
                                    ...
                                    <button className="alg-btn-secondary" onClick={() => navigate('/senior/grade/9/number-system/skills')}>Go to Skills 🎯</button>
                                </div>
                            </div>
                        )}
                    </div>
                ...
                <div style={{ marginTop: 16, textAlign: 'center' }}>
                    <button className="alg-btn-primary" onClick={() => navigate('/senior/grade/9/number-system/skills')} style={{ padding: '10px 28px', fontSize: 13 }}>Explore Skills 🎯</button>
                </div>
            </div>
        </div>
    );
