...
export default function Quadrilaterals9() {
            ...
            <div className={styles['left']}>
                ...
                <div className={styles['left-content']}>
                    <h1 className={styles['main-title']}>
                        Master <br />
                        <span className={styles['title-accent']}>Quadrilaterals</span>
                    </h1>
                    <p className={styles['main-sub']}>
                        Explore the properties of parallelograms, rectangles, rhombuses, squares, and the powerful Mid-point Theorem.
                    </p>
            ...
            <div className={styles['right']}>
                <div className={styles['right-header']}>
                    <h2 className={styles['right-title']}>
                        All About <span className={styles['right-title-accent']}>Quadrilaterals</span>
                    </h2>
                ...
                <div className={styles['cards-col']}>
                    {/* Introduction */}
                    <button className={styles['card-btn']} onClick={() => navigate('/practice/class-9/quadrilaterals/intro')}>
                        ...
                        <div className={styles['card-text']}>
                            ...
                            <div className={styles['card-desc']}>
                                Start here! Discover what Quadrilaterals are, their real-world structures, and how breaking them into triangles helps.
                            </div>
                        </div>
                    ...
                    {/* Terminology */}
                    <button className={styles['card-btn']} onClick={() => navigate('/practice/class-9/quadrilaterals/terminology')}>
                        ...
                        <div className={styles['card-text']}>
                            <div className={styles['card-tagline']}>Definitions & Rules</div>
                            <div className={styles['card-label']}>Terminology</div>
                            <div className={styles['card-desc']}>
                                Learn about Parallelograms, Rectangles, Rhombuses, Squares, Trapezia, and the Mid-point Theorem.
                            </div>
                        </div>
                    ...
                    {/* Skills */}
                    <button className={styles['card-btn']} onClick={() => navigate('/practice/class-9/quadrilaterals/skills')}>
                        ...
                        <div className={styles['card-text']}>
                            ...
                            <div className={styles['card-desc']}>
                                Put your knowledge to the test. Formally prove properties and evaluate sides and angles based on theorems.
                            </div>
                        </div>
