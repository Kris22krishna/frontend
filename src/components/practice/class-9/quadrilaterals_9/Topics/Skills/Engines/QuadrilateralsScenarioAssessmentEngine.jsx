...
export default function QuadrilateralsScenarioAssessmentEngine({ scenarios = [], title, color = "#0f4c81", onBack, nodeId }) {
            ...
            <div style={{ flex: 1, display: 'flex', flexDirection: 'column', background: '#fff', borderRadius: 20, boxShadow: '0 10px 30px rgba(0,0,0,0.05)', border: '1px solid #e2e8f0', overflow: 'hidden' }}>
                ...
                <div style={{ flex: 1, overflowY: 'auto', padding: '32px', fontFamily: 'Open Sans, sans-serif' }}>
                    ...
                    <div style={{ maxWidth: 700, margin: '0 auto' }}>
                        ...
                        {cq.chart && (
                            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: 32, padding: 16, background: '#f8fafc', borderRadius: 16, border: '1px solid rgba(0,0,0,0.05)' }}>
                                {React.createElement(cq.chart)}
                            </div>
                        )}
