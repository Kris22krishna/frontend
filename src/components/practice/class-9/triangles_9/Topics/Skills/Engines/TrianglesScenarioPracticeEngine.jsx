...
export default function TrianglesScenarioPracticeEngine({ scenarios = [], title, color = "#0f4c81", onBack, nodeId }) {
    ...
    useEffect(() => {
        startSession({ nodeId: nodeId || 'triangles9-skill-practice', sessionType: 'practice' });
    }, []); // eslint-disable-line
    ...
    return (
        <div className={styles['quiz-container']}>
            ...
            <div className={styles['quiz-card']}>
                ...
                {cq.chart && (
                    <div style={{ marginBottom: 24, padding: 16, background: '#f8fafc', borderRadius: 16, display: 'flex', justifyContent: 'center', border: '1px solid rgba(0,0,0,0.05)' }}>
