...
export default function CirclesScenarioPracticeEngine({ scenarios = [], title, color = "#0f4c81", onBack, nodeId }) {
    ...
    useEffect(() => {
        startSession({ nodeId: nodeId || 'circles-9-skill-practice', sessionType: 'practice' });
    }, []); // eslint-disable-line
