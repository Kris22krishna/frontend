...
export default function Circles9() {
            ...
            <div className={styles['left']}>
                ...
                <div className={styles['left-content']}>
                    <h1 className={styles['main-title']}>
                        Master <br />
                        <span className={styles['title-accent']}>Circles</span>
                    </h1>
                    <p className={styles['main-sub']}>
                        Master the geometric properties of circles, chords, arcs, and cyclic quadrilaterals.
                    </p>
            ...
            <div className={styles['right']}>
                <div className={styles['right-header']}>
                    <h2 className={styles['right-title']}>
                        <span className={styles['right-title-accent']}>Circles</span>
                    </h2>
                ...
                <div className={styles['cards-col']}>
                    {/* Introduction */}
                    <button className={styles['card-btn']} onClick={() => navigate('/practice/class-9/circles/intro')}>
                        ...
                        <div className={styles['card-text']}>
                            ...
                            <div className={styles['card-desc']}>
                                Start here! Discover what Circles are, who invented the concepts, and why we use them in the real world.
                            </div>
                        </div>
                    ...
                    {/* Terminology */}
                    <button className={styles['card-btn']} onClick={() => navigate('/practice/class-9/circles/terminology')}>
                        ...
                        <div className={styles['card-text']}>
                            <div className={styles['card-tagline']}>Chords, Arcs & Segments</div>
                            <div className={styles['card-label']}>Terminology</div>
                            <div className={styles['card-desc']}>
                                Learn vital vocabulary like radius, diameter, chord, sector, segment, and subtended angles.
                            </div>
                        </div>
                    ...
                    {/* Skills */}
                    <button className={styles['card-btn']} onClick={() => navigate('/practice/class-9/circles/skills')}>
                        ...
                        <div className={styles['card-text']}>
                            ...
                            <div className={styles['card-desc']}>
                                Put your knowledge to the test. Deduce properties involving equal chords, cyclic quadrilaterals, and angles in the same segment.
                            </div>
                        </div>
