...
export default function HeronsFormulaScenarioPracticeEngine({ scenarios = [], title, color = "#0f4c81", onBack, nodeId }) {
        ...
        return (
            <div style={{ textAlign: 'center', padding: '40px 20px', fontFamily: 'Outfit, sans-serif' }}>
                ...
                <div style={{ width: 170, height: 170, borderRadius: '50%', background: `conic-gradient(#d97706 ${pct * 3.6}deg, #e2e8f0 0deg)`, margin: '0 auto 30px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    <div style={{ width: 150, height: 150, background: '#f8fafc', borderRadius: '50%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
                ...
                <div style={{ display: 'flex', gap: 16, justifyContent: 'center' }}>
                    <button onClick={handleRetry} style={{ padding: '14px 40px', background: 'transparent', border: `2px solid ${color}`, color, borderRadius: 50, fontSize: 16, fontWeight: 800, cursor: 'pointer', fontFamily: 'Outfit, sans-serif' }}>
                        Retry Practice
                    </button>
                    <button onClick={onBack} style={{ padding: '14px 40px', background: color, border: `2px solid ${color}`, color: '#fff', borderRadius: 50, fontSize: 16, fontWeight: 800, cursor: 'pointer', fontFamily: 'Outfit, sans-serif', boxShadow: `0 8px 20px ${color}40` }}>
                        Back to Skills
                    </button>
                </div>
            </div>
