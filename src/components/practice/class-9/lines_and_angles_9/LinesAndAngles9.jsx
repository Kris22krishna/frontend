...
export default function LinesAndAngles9() {
            ...
            <div className={styles['left']}>
                ...
                <div className={styles['left-content']}>
                    <h1 className={styles['main-title']}>
                        Master <br />
                        <span className={styles['title-accent']}>Lines and Angles</span>
                    </h1>
                    <p className={styles['main-sub']}>
                        Master the geometric relationships formed by intersecting lines, parallel lines, and transversals.
                    </p>
            ...
            <div className={styles['right']}>
                <div className={styles['right-header']}>
                    <h2 className={styles['right-title']}>
                        Lines and <span className={styles['right-title-accent']}>Angles</span>
                    </h2>
                ...
                <div className={styles['cards-col']}>
                    {/* Introduction */}
                    <button className={styles['card-btn']} onClick={() => navigate('/practice/class-9/lines-and-angles/intro')}>
                        ...
                        <div className={styles['card-text']}>
                            ...
                            <div className={styles['card-desc']}>
                                Start here! Discover what Lines and Angles are, who invented the concepts, and why we use them in the real world.
                            </div>
                        </div>
                    ...
                    {/* Terminology */}
                    <button className={styles['card-btn']} onClick={() => navigate('/practice/class-9/lines-and-angles/terminology')}>
                        ...
                        <div className={styles['card-text']}>
                            <div className={styles['card-tagline']}>Lines, Angles & Pairs</div>
                            <div className={styles['card-label']}>Terminology</div>
                            <div className={styles['card-desc']}>
                                Learn vital vocabulary like complementary, supplementary, adjacent, vertically opposite angles, and transversals.
                            </div>
                        </div>
                    ...
                    {/* Skills */}
                    <button className={styles['card-btn']} onClick={() => navigate('/practice/class-9/lines-and-angles/skills')}>
                        ...
                        <div className={styles['card-text']}>
                            ...
                            <div className={styles['card-desc']}>
                                Put your knowledge to the test. Measure, identify, and deduce angles using axioms and theorems.
                            </div>
                        </div>
