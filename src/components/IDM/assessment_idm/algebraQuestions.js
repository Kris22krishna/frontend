export const algebraQuestions = () => [
    ...
    },
    {
        id: 25,
        skill: "Word Problems",
        question: "Two pipes together fill a tank in 6 hours. Pipe A alone takes 10 hours. How long does Pipe B alone take?",
        options: ["$15$ hours", "$12$ hours", "$16$ hours", "$18$ hours"],
        correct: 0,
        type: "mcq"
    },
    {
