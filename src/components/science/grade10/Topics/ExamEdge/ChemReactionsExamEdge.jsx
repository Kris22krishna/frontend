    ...
    return (
        <div className={styles['chem-page']}>
            ...
            <div className={styles['chem-hero']}>
                <h1 className={styles['chem-hero-title']}>Chemical Reactions <span style={{ color: '#ef4444' }}>Exam Edge</span></h1>
            ...
            <main className={styles['chem-topic-shell']} style={{ maxWidth: '1100px', margin: '0 auto', padding: '40px 24px' }}>
                ...
                {/* Exam Tabs */}
                <div className={styles['chem-chip-row']} style={{ display: 'flex', justifyContent: 'center', gap: '12px', marginBottom: '40px', flexWrap: 'wrap' }}>
                ...
                <div className={styles['chem-details-window']} style={{ background: '#fff' }}>
                    
                    {/* Weightage & Frequency */}
                    <div className={styles['chem-stats-pair']} style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(220px, 100%), 1fr))', gap: '20px', marginBottom: '32px' }}>
                    ...
                    {/* Strategy & Pitfalls */}
                    <div className={styles['chem-responsive-grid']} style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(300px, 100%), 1fr))', gap: '32px' }}>
                        <div>
                            <h3 style={{ fontSize: '14px', fontWeight: 900, color: '#64748b', textTransform: 'uppercase', letterSpacing: '1px', marginBottom: '16px', display: 'flex', alignItems: 'center', gap: '8px' }}>
                ...
                {/* Pro Tips */}
                <div className={`${styles['chem-topic-banner']} ${styles['chem-topic-banner--dark']}`} style={{ marginTop: '40px', background: 'linear-gradient(135deg, #1e1b4b, #312e81)', padding: '40px', borderRadius: '32px', color: '#fff' }}>
                    <div className={styles['chem-section-head-inline']} style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '24px' }}>
                        <Lightbulb size={32} color="#f59e0b" />
                        <h2 style={{ fontSize: '24px', fontWeight: 800, margin: 0 }}>Bonus Exam Tips</h2>
                    </div>
                    <div className={styles['chem-responsive-grid']} style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(250px, 100%), 1fr))', gap: '20px' }}>
