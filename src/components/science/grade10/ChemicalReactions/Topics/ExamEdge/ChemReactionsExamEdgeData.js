            ...
            questions: [
                {
                    ...
                    a: "Magnesium metal is highly reactive. In stored conditions, it reacts with oxygen to form magnesium oxide over its outer layer. To remove this layer and to expose the underlying metal into air, the magnesium ribbon is cleaned by sandpaper."
                },
                {
                    q: "Write the balanced equation for the following chemical reactions.\ni) Hydrogen + Chlorine → Hydrogen Chloride\nii) Barium chloride + Aluminium sulphate → Barium sulphate + Aluminium chloride\niii) Sodium + water → Sodium hydroxide + Hydrogen",
                    a: "$$\\text{H}_2\\text{(g)} + \\text{Cl}_2\\text{(g)} \\rightarrow 2\\text{HCl}\\text{(g)}$$\n$$3\\text{BaCl}_2\\text{(s)} + \\text{Al}_2\\text{(SO}_4\\text{)}_3\\text{(s)} \\rightarrow 3\\text{BaSO}_4\\text{(s)} + 2\\text{AlCl}_3\\text{(s)}$$\n$$2\\text{Na}\\text{(s)} + 2\\text{H}_2\\text{O}\\text{(l)} \\rightarrow 2\\text{NaOH}\\text{(aq)} + \\text{H}_2\\text{(g)}$$"
                },
                {
                ...
                {
                    q: "$$\\text{Fe}_2\\text{O}_3 + 2\\text{Al} \\rightarrow \\text{Al}_2\\text{O}_3 + 2\\text{Fe}$$\nThe above reaction is an example of a:\n(a) Combination reaction\n(b) Double displacement reaction\n(c) Decomposition reaction\n(d) Displacement reaction",
                    a: "(d) The reaction is an example of a **displacement reaction**. Aluminium (more reactive) displaces iron from iron oxide."
                },
                {
                    q: "What happens when dilute hydrochloric acid is added to iron fillings? Tick the correct answer.\n(a) Hydrogen gas and iron chloride are produced.\n(b) Chlorine gas and iron hydroxide are produced.\n(c) No reaction takes place.\n(d) Iron salt and water are produced.",
                ...
                {
                    q: "A shiny brown coloured element 'X' on heating in air becomes black in colour. Name the element 'X' and the black coloured compound formed.",
                    a: "'X' is **Copper (Cu)**. The black coloured compound formed is **Copper(II) oxide (CuO)**.\n$$2\\text{Cu}\\text{(s)} + \\text{O}_2\\text{(g)} \\xrightarrow{\\Delta} 2\\text{CuO}\\text{(s)}$$"
                },
                {
                    q: "Why do we apply paint on iron articles?",
                    a: "Iron articles are painted to prevent them from rusting. When painted, the contact of iron articles with atmospheric moisture and air is cut off. Hence, rusting is prevented.\n$$4\\text{Fe}\\text{(s)} + 3\\text{O}_2\\text{(g)} + x\\text{H}_2\\text{O} \\rightarrow 2\\text{Fe}_2\\text{O}_3 \\cdot x\\text{H}_2\\text{O (rust)}$$"
                },
                {
                    q: "Oil and fat containing food items are flushed with nitrogen. Why?",
                    a: "Oil and fat containing food items are flushed with nitrogen to prevent them from getting oxidised, which may result in rancidity. When fats and oils are oxidised, they become rancid and their smell and taste change. Nitrogen is an inert gas that displaces oxygen and creates a protective atmosphere."
                },
                {
                    q: "Explain the following terms with one example each.\n(a) Corrosion\n(b) Rancidity",
                ...
                {
                    q: "How do you determine whether a chemical reaction has taken place?",
                    a: "The following observations help us determine whether a chemical reaction has taken place:\n\n• Change in state\n• Change in colour\n• Evolution of a gas\n• Change in temperature"
                },
                {
                    q: "Write the balanced equation for the reaction of iron with steam.",
                    a: "$$3\\text{Fe}\\text{(s)} + 4\\text{H}_2\\text{O}\\text{(g)} \\rightarrow \\text{Fe}_3\\text{O}_4\\text{(s)} + 4\\text{H}_2\\text{(g)}$$"
                },
                {
                    q: "What is quicklime? Write one use of quicklime.",
                    a: "Calcium oxide (CaO) is called lime or quicklime. It is used in the manufacture of cement."
                },
                {
                    q: "What are antioxidants?",
                    a: "The substances which prevent oxidation (and hence rancidity) are called antioxidants. Examples include BHA (Butylated Hydroxyanisole) and BHT (Butylated Hydroxytoluene)."
                }
            ]
        },
        {
