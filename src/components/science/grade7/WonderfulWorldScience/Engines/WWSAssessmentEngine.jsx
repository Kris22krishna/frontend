...
// ── Sampler: picks sampleSize questions from pool ─────────────────────────
...
export default function WWSAssessmentEngine({ questionPool, sampleSize = 10, title, color, onBack }) {
        ...
        return (
            <div style={{ maxWidth: 860, margin: '0 auto', padding: '20px', textAlign: 'center' }}>
                ...
                <p style={{ color: '#64748b', fontSize: 15, margin: '0 0 20px' }}>
                    This concept currently has no valid multiple-choice questions for assessment.
                </p>
                <button className={styles['wws-btn-secondary']} onClick={onBack}>Back to Concepts</button>
            </div>
        );
    }
    ...
    // ── Active assessment ──────────────────────────────────────────────────
    return (
        <div className={styles['wws-assessment-layout']}>
            {/* Main question area */}
            <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <div className={styles['wws-quiz-card']}>
                    ...
                    <div style={{ fontSize: 16, fontWeight: 600, color: '#0f172a', lineHeight: 1.65, marginBottom: 18 }}>
                        <MathRenderer text={q?.question || ''} />
                    </div>
                            ...
                            return (
                                <button key={oi} onClick={() => handleSelect(oi)}
                                    style={{
                                        ...
                                        width: '100%', fontFamily: 'Open Sans, sans-serif'
                                    }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: 20 }}>
                    <button className={styles['wws-btn-secondary']}
                    ...
                    {current + 1 === questions.length ? (
                        <button className={styles['wws-btn-primary']} onClick={handleSubmit} style={{ background: '#ef4444' }}>
                            Submit Assessment
                        </button>
                    ) : (
                        <button className={styles['wws-btn-primary']} onClick={() => setCurrent((c) => c + 1)} style={{ background: color }}>
                            Next →
                        </button>
                    )}
                </div>
            ...
            <div className={styles['wws-assessment-palette']}>
                ...
                <button className={styles['wws-btn-primary']} onClick={handleSubmit} style={{ background: '#ef4444', width: '100%', padding: '12px', marginTop: 24, fontSize: 13, boxShadow: 'none' }}>
                    Finish Now
                </button>
            </div>
        </div>
