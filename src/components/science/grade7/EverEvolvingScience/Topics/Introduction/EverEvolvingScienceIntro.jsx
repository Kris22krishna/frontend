        ...
        <div className={styles['chem-page']}>
            <nav className={styles['chem-nav']}>
                ...
                <div className={styles['chem-nav-links']}>
                    <button className={`${styles['chem-nav-link']} ${styles['active']}`} onClick={() => navigate('/middle/grade/7/science/wonderful-world-science/introduction')}>🌟 Intro</button>
            ...
            <div className={styles['chem-hero']}>
                <h1 className={styles['chem-hero-title']}>Dive into <span className={styles['chem-hero-accent--violet']}>The World of Science</span></h1>
            ...
            <main className={styles['chem-topic-shell']}>
                ...
                <section className={styles['chem-section-mb']}>
                    ...
                    <div className={styles['chem-grid']} style={{ padding: 0 }}>
                        {wonderfulWorldIntroData.prerequisites.map((p, idx) => (
                ...
                <div className={styles['chem-grid']} style={{ padding: 0 }}>
                    {wonderfulWorldIntroData.cards5W1H.map((card, idx) => (
                ...
                <div className={styles['chem-topic-cta']}>
                    ...
                    <button
                        ...
                        onClick={() => navigate('/middle/grade/7/science/wonderful-world-science/terminology')}
                    >
                        Terminology →
                    </button>
                </div>
