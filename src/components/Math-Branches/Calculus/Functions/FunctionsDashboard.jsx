...
const MODULES = [
    {
        id: 'introduction',
        path: '/calculus/functions/introduction',
        label: 'Introduction',
        emoji: '🌍',
    ...
    {
        id: 'terminology',
        path: '/calculus/functions/terminology',
        label: 'Terminology',
        emoji: '📖',
        tagline: 'Key Terms and Concepts',
        desc: 'Master the different types of functions, domains, and ranges.',
        gradFrom: '#8b5cf6',
        gradTo: '#a78bfa',
    ...
    {
        id: 'skills',
        path: '/calculus/functions/skills',
        label: 'Skills',
        emoji: '🎯',
        tagline: 'Learn, Practice and Assess',
        desc: 'Master the 6 main types of functions across hundreds of dynamic problems.',
        gradFrom: '#f43f5e',
        gradTo: '#fb7185',
...
const STATS = [
    ...
    { val: '6', label: 'Function Types', color: '#f43f5e' },
    { val: '240', label: 'Unique Questions', color: '#8b5cf6' },
];
            ...
            <div className="calc-left">
                ...
                <div className="calc-left-content">
                    ...
                    <h1 className="calc-main-title">
                        Master
                        <br />
                        <span className="calc-title-accent" style={{ background: 'linear-gradient(90deg, #10b981, #059669)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Functions</span>
                    </h1>

                    <p className="calc-main-sub">
                        Functions are the machinery of calculus. Learn their core properties to understand how inputs transform into outputs.
                    </p>
