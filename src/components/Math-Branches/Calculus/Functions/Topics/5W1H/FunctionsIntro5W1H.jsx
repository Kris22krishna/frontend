...
import { funcCards5W1H } from './FunctionsIntroData';
        ...
        <div className="calc-page">
            <nav className="intro-nav">
                <button
                    ...
                    onClick={() => navigate('/calculus/functions')}
            ...
            <div className="calc-module-hero">
                <div style={{ maxWidth: 1100, margin: '0 auto', textAlign: 'center' }}>
                    ...
                    <p className="calc-section-subtitle" style={{ marginBottom: 0 }}>
                        Tap each card to explore the core concept that powers all of Calculus ✨
                    </p>
                </div>
            </div>
            ...
            <div className="calc-section" style={{ paddingTop: 32 }}>
                ...
                <div style={{
                    ...
                    <p style={{ margin: 0, fontSize: 16, fontWeight: 600, color: '#475569' }}>
                        Up next: Domain, Range, and essential function concepts!
                    </p>
                    <button
                        onClick={() => navigate('/calculus/functions/terminology')}
                        style={{
