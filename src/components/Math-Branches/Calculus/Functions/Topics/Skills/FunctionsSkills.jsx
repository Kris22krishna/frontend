...
import { SKILLS } from './FunctionsSkillsData';
            ...
            <div className="calc-page calc-skills-stage" style={{ background: '#f8fafc', minHeight: '100vh', paddingBottom: '60px' }}>
                <nav className="intro-nav">
                    ...
                    <div className="intro-nav-links">
                        ...
                        <button className="intro-nav-link" onClick={() => navigate('/calculus/functions/terminology')}>📖 Terminology</button>
            ...
            <div className="calc-lexicon-container" style={{ maxWidth: 1100, margin: '40px auto 20px', padding: '0 24px' }}>
                <div style={{ textAlign: 'center', marginBottom: 40 }}>
                    <h1 style={{ fontFamily: 'Outfit, sans-serif', fontSize: '2.8rem', fontWeight: 900, color: 'var(--calc-text)', margin: '0 0 8px' }}>
                        Functions <span style={{ background: 'linear-gradient(135deg, var(--calc-rose), var(--calc-violet))', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Mastery</span>
                    </h1>
                    <p style={{ color: 'var(--calc-muted)', fontWeight: 600, fontSize: 16, margin: 0 }}>
                        Learn, Practice and Assess the 6 fundamental types of functions.
                    </p>
                </div>
                ...
                >
                    ...
                    <h3 style={{ fontSize: 24, fontWeight: 800, margin: '0 0 8px' }}>Ready for Limits?</h3>
                    <p style={{ opacity: 0.9, maxWidth: 500, margin: '0 auto 24px' }}>
                        Now that you understand functions, see what happens when you push them to their absolute limits!
                    </p>
                    <button
                        className="calc-skill-btn-outline"
                        style={{ background: '#fff', color: '#0ea5e9', fontWeight: 800, borderColor: '#fff' }}
                        onClick={() => navigate('/calculus/limits')}
                    >
                        Limits →
                    </button>
                </div>
