...
import { limitsCards5W1H } from './LimitsIntroData';
...
/* ─── Main page ───────────────────────────────────── */
export default function LimitsIntro5W1H() {
            ...
            <div className="calc-module-hero">
                <div style={{ maxWidth: 1100, margin: '0 auto', textAlign: 'center' }}>
                    <h1 className="calc-section-title">
                        Discover Limits Through{' '}
                        <span>6 Big Questions</span>
                    </h1>
                    <p className="calc-section-subtitle" style={{ marginBottom: 0 }}>
                        Tap each card to explore how functions behave near absolute boundaries ✨
                    </p>
                </div>
            </div>
            ...
            <div className="calc-section" style={{ paddingTop: 32 }}>
                ...
                <div style={{
                    ...
                    <p style={{ margin: 0, fontSize: 16, fontWeight: 600, color: '#475569' }}>
                        Up next: Key terms and concepts like LHL, RHL, and continuity!
                    </p>
                    <button
                        onClick={() => navigate('/calculus/limits/terminology')}
                        style={{
                            padding: '10px 24px', background: 'var(--calc-violet)', color: '#fff',
