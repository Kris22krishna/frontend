...
const MODULES = [
    {
        id: 'introduction',
        path: '/calculus/limits/introduction',
        label: 'Introduction',
        emoji: '🌍',
        tagline: '5W1H Exploration',
        desc: '6 big questions about Limits: what, why, who, when, where, and how.',
        gradFrom: '#0ea5e9',
        gradTo: '#38bdf8',
    ...
    {
        id: 'terminology',
        path: '/calculus/limits/terminology',
        label: 'Terminology',
        emoji: '📖',
        tagline: 'Key Terms and Concepts',
        desc: 'Master the language of Limits: left-hand, right-hand, indeterminate forms.',
        gradFrom: '#8b5cf6',
        gradTo: '#a78bfa',
    ...
    {
        id: 'skills',
        path: '/calculus/limits/skills',
        label: 'Skills',
        emoji: '🎯',
        tagline: 'Learn, Practice and Assess',
        desc: 'Master direct substitution, factoring, limits at infinity.',
        gradFrom: '#f43f5e',
        gradTo: '#fb7185',
...
const STATS = [
    ...
    { val: '10', label: 'Key Terms', color: '#8b5cf6' },
    { val: '3', label: 'Core Skills', color: '#f43f5e' },
];
            ...
            <div className="calc-left">
                ...
                <div className="calc-left-content">
                    ...
                    <h1 className="calc-main-title">
                        Master
                        <br />
                        <span className="calc-title-accent" style={{ background: 'linear-gradient(90deg, #38bdf8, #0ea5e9)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Limits</span>
                    </h1>

                    <p className="calc-main-sub">
                        The foundation of Calculus. Explore how functions behave as they approach specific points, even when undefined!
                    </p>
