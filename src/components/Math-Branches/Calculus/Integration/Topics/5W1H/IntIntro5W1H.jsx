...
import { intCards5W1H } from './IntIntroData';
...
/* ─── Main page ───────────────────────────────────── */
export default function IntIntro5W1H() {
            ...
            <div className="calc-module-hero">
                <div style={{ maxWidth: 1100, margin: '0 auto', textAlign: 'center' }}>
                    <h1 className="calc-section-title">
                        Discover Integration Through{' '}
                        <span>6 Big Questions</span>
                    </h1>
                    <p className="calc-section-subtitle" style={{ marginBottom: 0 }}>
                        Tap each card to explore the mathematics of accumulation and area ✨
                    </p>
                </div>
            </div>
            ...
            <div className="calc-section" style={{ paddingTop: 32 }}>
                ...
                <div style={{
                    ...
                    <p style={{ margin: 0, fontSize: 16, fontWeight: 600, color: '#475569' }}>
                        Up next: Important definitions and the $+C$ rule!
                    </p>
                    <button
                        onClick={() => navigate('/calculus/integration/terminology')}
                        style={{
                            padding: '10px 24px', background: 'var(--calc-fuchsia)', color: '#fff',
