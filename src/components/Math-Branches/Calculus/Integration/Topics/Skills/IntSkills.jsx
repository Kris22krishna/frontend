...
import { SKILLS } from './IntSkillsData';

export default function IntSkills() {
            ...
            <div className="calc-page calc-skills-stage" style={{ background: '#f8fafc', minHeight: '100vh', paddingBottom: '60px' }}>
                <nav className="intro-nav">
                    ...
                    <div className="intro-nav-links">
                        ...
                        <button className="intro-nav-link" onClick={() => navigate('/calculus/integration/terminology')}>📖 Terminology</button>
                                ...
                                <main key={`${skill.id}-${selectedLearnIdx}`} style={{
                                    ...
                                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: 20 }}>
                                        <div>
                                            ...
                                            <div style={{ marginTop: 24, background: `rgba(217,70,239,0.05)`, padding: 16, borderRadius: 16, border: `1px solid rgba(217,70,239,0.1)` }}>
            ...
            <div className="calc-lexicon-container" style={{ maxWidth: 1100, margin: '40px auto 20px', padding: '0 24px' }}>
                <div style={{ textAlign: 'center', marginBottom: 40 }}>
                    <h1 style={{ fontFamily: 'Outfit, sans-serif', fontSize: '2.8rem', fontWeight: 900, color: 'var(--calc-text)', margin: '0 0 8px' }}>
                        Integration <span style={{ background: 'linear-gradient(135deg, var(--calc-fuchsia), var(--calc-violet))', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Skills</span>
                    </h1>
                    <p style={{ color: 'var(--calc-muted)', fontWeight: 600, fontSize: 16, margin: 0 }}>
                        Step up from concepts to mastery with 10 targeted practice chapters.
                    </p>
                </div>
                ...
                <div
                    style={{
                        ...
                        color: '#fff',
                        textAlign: 'center',
                        boxShadow: '0 15px 40px rgba(217,70,239,0.15)'
                    }}
                >
                    <div style={{ fontSize: 32, marginBottom: 12 }}>🚀</div>
                    <h3 style={{ fontSize: 24, fontWeight: 800, margin: '0 0 8px' }}>Calculus Mastered!</h3>
                    <p style={{ opacity: 0.9, maxWidth: 500, margin: '0 auto 24px' }}>
                        You've reached the end of the Calculus branch. Great job accumulating all this knowledge!
                    </p>
                    <button
                        className="calc-skill-btn-outline"
                        style={{ background: '#fff', color: '#d946ef', fontWeight: 800, borderColor: '#fff' }}
