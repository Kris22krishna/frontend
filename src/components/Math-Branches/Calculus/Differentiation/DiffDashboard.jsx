...
const MODULES = [
    {
        id: 'introduction',
        path: '/calculus/differentiation/introduction',
        label: 'Introduction',
        emoji: '🌍',
        tagline: '5W1H Exploration',
        desc: '6 big questions about Differentiation: what, why, who, when, where, and how.',
        gradFrom: '#0ea5e9',
        gradTo: '#38bdf8',
    ...
    {
        id: 'terminology',
        path: '/calculus/differentiation/terminology',
        label: 'Terminology',
        emoji: '📖',
        tagline: 'Key Terms and Concepts',
        desc: 'Master Product Rule, Chain Rule, Implicit functions, and Parametric forms.',
        gradFrom: '#8b5cf6',
        gradTo: '#a78bfa',
    ...
    {
        id: 'skills',
        path: '/calculus/differentiation/skills',
        label: 'Skills',
        emoji: '🎯',
        tagline: 'Learn, Practice and Assess',
        desc: 'Master 9 core differentiation skills across hundreds of dynamic problems.',
        gradFrom: '#f43f5e',
        gradTo: '#fb7185',
...
const STATS = [
    ...
    { val: '9', label: 'Core Skills', color: '#f43f5e' },
    { val: '360', label: 'Unique Questions', color: '#8b5cf6' },
];

export default function DiffDashboard() {
            ...
            <div className="calc-left">
                ...
                <div className="calc-left-content">
                    ...
                    <h1 className="calc-main-title">
                        Master
                        <br />
                        <span className="calc-title-accent" style={{ background: 'linear-gradient(90deg, #fb7185, #f43f5e)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Differentiation</span>
                    </h1>

                    <p className="calc-main-sub">
                        The mathematics of instantaneous change. Learn how to calculate the exact slope of any curve at any single point in space and time.
                    </p>
