...
import { TERMS, FIVE_RULES, VOCAB_QUIZ } from './DiffTerminologyData';

export default function DiffTerminology() {
    ...
    return (
        <div className="calc-page">
            ...
            <nav className="intro-nav">
                <button className="calc-back-btn" onClick={() => navigate('/calculus/differentiation')} style={{ marginBottom: 0 }}>← Back to Differentiation</button>
                <div className="intro-nav-links">
                    <button className="intro-nav-link" onClick={() => navigate('/calculus/differentiation/introduction')}>🌟 Introduction</button>
            ...
            <div className="calc-lexicon-container" style={{ maxWidth: 1100, margin: '40px auto 20px', padding: '0 24px' }}>
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', marginBottom: 20 }}>
                    <h1 style={{ fontFamily: 'Outfit, sans-serif', fontSize: '2.8rem', fontWeight: 900, color: 'var(--calc-text)', margin: '0 0 8px' }}>
                        Differentiation <span style={{ background: 'linear-gradient(135deg, var(--calc-rose), var(--calc-violet))', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Vocabulary</span>
                    </h1>
                            ...
                            {!showResults ? (
                                ...
                                <div>
                                    ...
                                    <div style={{ display: 'flex', gap: 16, justifyContent: 'center' }}>
                                        ...
                                        <button onClick={() => navigate('/calculus/differentiation/skills')} style={{ padding: '12px 24px', background: accent, color: '#fff', border: 'none', borderRadius: 100, fontSize: 15, fontWeight: 700, cursor: 'pointer', boxShadow: `0 8px 20px ${accent}33` }}>Go to Skills →</button>
                                    </div>
                                </div>
                            )}
                        </div>
                ...
                <div style={{ marginTop: 16, textAlign: 'center' }}>
                    <button onClick={() => navigate('/calculus/differentiation/skills')} style={{ padding: '10px 28px', fontSize: 13, borderRadius: 100, border: 'none', background: accent, color: '#fff', fontWeight: 800, cursor: 'pointer', boxShadow: `0 4px 14px ${accent}4d` }}>Ready to Solve! 🎯</button>
                </div>
            </div>
        </div>
    );
