...
import { trigAppCards5W1H } from './TrigAppGr10IntroData';
...
export default function TrigAppGr10Intro() {
        ...
        <div className={styles.arithPage}>
            <nav className={styles.introNav}>
                <button
                    ...
                    onClick={() => navigate('/trigonometry/grade-10-applications')}
                >
                    ← Back to Branch
                </button>
            ...
            <div style={{ background: '#fff', padding: '60px 20px', borderBottom: '1px solid #e2e8f0', textAlign: 'center' }}>
                <div style={{ maxWidth: 800, margin: '0 auto' }}>
                    <h1 style={{ fontFamily: '"Outfit", sans-serif', fontSize: '2.8rem', fontWeight: 900, color: '#0f172a', marginBottom: 16 }}>
                        Heights & Distances Through{' '}
                        <span style={{ color: '#0ea5e9' }}>6 Big Questions</span>
                    </h1>
                    <p style={{ fontSize: '1.15rem', color: '#64748b' }}>
                        Tap each card to explore how trig scales the real world ✨
                    </p>
                </div>
            </div>
            ...
            <div className={styles.arithSection}>
                ...
                <div className={styles.arithSplitCta}>
                    <p style={{ margin: 0, fontSize: '1.1rem', fontWeight: 600, color: '#475569' }}>
                        Up next: Line of sight and elevation!
                    </p>
                    <button
                        onClick={() => navigate('/trigonometry/grade-10-applications/terminology')}
                        className={styles.arithSplitCtaButton}
                        style={{
                            padding: '14px 32px', background: '#0ea5e9', color: '#fff',
                            border: 'none', borderRadius: 100, fontWeight: 800, fontSize: 16,
                            cursor: 'pointer', boxShadow: '0 8px 24px rgba(14,165,233,0.3)'
                        }}
                    >
                        Terminology →
                    </button>
