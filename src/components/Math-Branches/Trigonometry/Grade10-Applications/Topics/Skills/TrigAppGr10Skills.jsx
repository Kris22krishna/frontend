...
import { SKILLS } from './TrigAppGr10SkillsIndex';
import { curriculumPathToNodeId } from '@/lib/curriculumIds';

export default function TrigAppGr10Skills() {
            ...
            <div className={styles.arithPage}>
                <nav className={styles.introNav}>
                    ...
                    <div className={styles.arithIntroNavLinks}>
                        ...
                        <button className={styles.arithIntroNavLink} onClick={() => navigate('/trigonometry/grade-10-applications/terminology')}>📖 Terminology</button>
                ...
                <div style={{ maxWidth: 1200, margin: '0 auto', padding: '40px 20px' }}>
                    {view === 'learn' ? (
                        ...
                        <QuizEngine
                            ...
                            onBack={() => setView('list')}
                            prefix="trig"
                            nodeId={curriculumPathToNodeId[`trig-app-${activeSkillIdx + 1}`]}
                        />
                    ) : (
                        <AssessmentEngine
                            questions={sessionQuestions}
    ...
    return (
        <div className="skills-page calc-skills-stage" style={{ background: '#f8fafc', minHeight: '100vh', paddingBottom: '60px' }}>
            <nav className="intro-nav">
                <button className="intro-nav-back" onClick={() => navigate('/trigonometry/grade-10-applications')}>← Back to Branch</button>
                <div className="intro-nav-links">
                    <button className="intro-nav-link" onClick={() => navigate('/trigonometry/grade-10-applications/introduction')}>Intro</button>
                    <button className="intro-nav-link" onClick={() => navigate('/trigonometry/grade-10-applications/terminology')}>Terminology</button>
            ...
            <div className="calc-lexicon-container calc-skills-stage-body calc-skills-stage-body--list">
                <div style={{ textAlign: 'center', marginBottom: 40 }}>
                    <h1 style={{ fontFamily: 'Outfit, sans-serif', fontSize: '2.8rem', fontWeight: 900, color: 'var(--calc-text)', margin: '0 0 8px' }}>
                        Applications{' '}
                        <span style={{ background: 'linear-gradient(135deg, #0ea5e9, #38bdf8)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Skills</span>
                    </h1>
                    <p style={{ color: 'var(--calc-muted)', fontWeight: 600, fontSize: 16, margin: 0 }}>
                        Apply trig ratios to solve complex height and distance problems.
                    </p>
                </div>
