...
export default function TrigAppGr10Skills() {
            ...
            <div className={styles['ccr-page']}>
                <nav className={styles['ccr-nav']}>
                    ...
                    <div className={styles['ccr-nav-links']}>
                        <button className={styles['ccr-nav-link']} onClick={() => navigate('/trigonometry/grade-10-applications')}>Home</button>
                        <button className={styles['ccr-nav-link']} onClick={() => navigate('/trigonometry/grade-10-applications/terminology')}>Terminology</button>
    ...
    return (
        <div className={styles['ccr-page']}>
            <nav className={styles['ccr-nav']}>
                <button className={styles['ccr-nav-back']} onClick={() => navigate('/trigonometry/grade-10-applications')}>← Apps of Trigonometry</button>
                <div className={styles['ccr-nav-links']}>
                    <button className={styles['ccr-nav-link']} onClick={() => navigate('/trigonometry/grade-10-applications/introduction')}>Introduction</button>
                    <button className={styles['ccr-nav-link']} onClick={() => navigate('/trigonometry/grade-10-applications/terminology')}>Terminology</button>
                    <button className={`${styles['ccr-nav-link']} ${styles['ccr-nav-link--active']}`}>Skills</button>
                </div>
            </nav>
            ...
            <div className={styles['ccr-module-hero']}>
                <h1 className={styles['ccr-module-title']}>Apps of Trig <span className={styles['ccr-accent-text']}>Skills</span></h1>
                <p className={styles['ccr-module-subtitle']}>Real-world heights and distances problems.</p>
            </div>
