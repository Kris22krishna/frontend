...
export default function InverseTrigGr12Skills() {
            ...
            <div className={styles['ccr-page']}>
                <nav className={styles['ccr-nav']}>
                    ...
                    <div className={styles['ccr-nav-links']}>
                        <button className={styles['ccr-nav-link']} onClick={() => navigate('/trigonometry/grade-12-inverse')}>Home</button>
                        <button className={styles['ccr-nav-link']} onClick={() => navigate('/trigonometry/grade-12-inverse/terminology')}>Terminology</button>
    ...
    return (
        <div className={styles['ccr-page']}>
            <nav className={styles['ccr-nav']}>
                <button className={styles['ccr-nav-back']} onClick={() => navigate('/trigonometry/grade-12-inverse')}>← Inverse Trig</button>
                <div className={styles['ccr-nav-links']}>
                    <button className={styles['ccr-nav-link']} onClick={() => navigate('/trigonometry/grade-12-inverse/introduction')}>Introduction</button>
                    <button className={styles['ccr-nav-link']} onClick={() => navigate('/trigonometry/grade-12-inverse/terminology')}>Terminology</button>
                    <button className={`${styles['ccr-nav-link']} ${styles['ccr-nav-link--active']}`}>Skills</button>
                </div>
            </nav>
            ...
            <div className={styles['ccr-module-hero']}>
                <h1 className={styles['ccr-module-title']}>Inverse Trig <span className={styles['ccr-accent-text']}>Skills</span></h1>
                <p className={styles['ccr-module-subtitle']}>Principal values and compositions of inverse functions.</p>
            </div>
