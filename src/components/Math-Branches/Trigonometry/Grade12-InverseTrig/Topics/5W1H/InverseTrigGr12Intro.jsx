...
import { inverseTrigCards5W1H } from './InverseTrigGr12IntroData';
...
export default function InverseTrigGr12Intro() {
        ...
        <div className={styles.arithPage}>
            <nav className={styles.introNav}>
                <button
                    ...
                    onClick={() => navigate('/trigonometry/grade-12-inverse')}
                >
                    ← Back to Branch
                </button>
            ...
            <div style={{ background: '#fff', padding: '60px 20px', borderBottom: '1px solid #e2e8f0', textAlign: 'center' }}>
                <div style={{ maxWidth: 800, margin: '0 auto' }}>
                    <h1 style={{ fontFamily: '"Outfit", sans-serif', fontSize: '2.8rem', fontWeight: 900, color: '#0f172a', marginBottom: 16 }}>
                        Inverse Trigonometry Through{' '}
                        <span style={{ color: '#ec4899' }}>6 Big Questions</span>
                    </h1>
                    <p style={{ fontSize: '1.15rem', color: '#64748b' }}>
                        Tap each card to explore domains, ranges, and arc functions ✨
                    </p>
                </div>
            </div>
            ...
            <div className={styles.arithSection}>
                <div className={styles.arithIntroGrid}>
                    {inverseTrigCards5W1H.map((card, idx) => (
                ...
                <div className={styles.arithSplitCta}>
                    <p style={{ margin: 0, fontSize: '1.1rem', fontWeight: 600, color: '#475569' }}>
                        Up next: Domains and Principal Values!
                    </p>
                    <button
                        onClick={() => navigate('/trigonometry/grade-12-inverse/terminology')}
                        className={styles.arithSplitCtaButton}
                        style={{
                            padding: '14px 32px', background: '#ec4899', color: '#fff',
