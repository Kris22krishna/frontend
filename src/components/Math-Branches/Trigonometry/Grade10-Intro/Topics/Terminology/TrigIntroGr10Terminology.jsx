    ...
    return (
        <div className={styles.arithPage}>
            <nav className={styles.introNav}>
                <button className={styles.arithBackBtn} onClick={() => navigate('/trigonometry/grade-10-intro')} style={{ marginBottom: 0 }}>← Back to Branch</button>
                <div className={styles.arithIntroNavLinks}>
                    ...
                    <button className={styles.arithIntroNavLink} onClick={() => navigate('/trigonometry/grade-10-intro/skills')}>🎯 Skills</button>
                </div>
            </nav>
            ...
            <div className={styles.arithTermContainer}>
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', marginBottom: 20, paddingTop: 32 }}>
                    <h1 style={{ fontFamily: '"Outfit", sans-serif', fontSize: '2.8rem', fontWeight: 900, color: '#0f172a', margin: '0 0 8px' }}>
                        Trigonometry{' '}
                        <span style={{ background: 'linear-gradient(135deg, #7c3aed, #6366f1)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Vocabulary</span>
                    </h1>
                                ...
                                TERMS.map((term, i) => {
                                    ...
                                    return (
                                        <button key={i}
                                            ...
                                            style={{
                                                background: isActive ? `linear-gradient(135deg, ${accentColor}, ${accentColor}dd)` : `linear-gradient(135deg, rgba(124,58,237,0.08), rgba(124,58,237,0.02))`,
                                                borderColor: isActive ? accentColor : 'rgba(124,58,237,0.15)',
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <div style={{ display: 'flex', flexDirection: 'column', textAlign: 'left' }}>
                                                ...
                                                <span style={{ fontSize: 11, fontWeight: 700, color: isActive ? 'rgba(255,255,255,0.8)' : '#64748b', textTransform: 'uppercase', letterSpacing: 0.5, marginTop: 3 }}>{identity.name.split('(')[0].substring(0, 18)}…</span>
                                            </div>
                                        </button>
                                    );
                                })
                            ...
                            {activeTab === 'terms' ? (
                                <>
                                    ...
                                    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                                        <div>
                                            ...
                                            <div style={{ background: 'rgba(99,102,241,0.04)', padding: 14, borderRadius: 12, border: '1px solid rgba(99,102,241,0.1)' }}>
                                ...
                                <>
                                    ...
                                    <div>
                                        ...
                                        <div style={{ background: 'rgba(124,58,237,0.04)', padding: 20, borderRadius: 16, border: '1px solid rgba(124,58,237,0.1)', textAlign: 'center' }}>
                            ...
                            {!showResults ? (
                                ...
                                <div>
                                    ...
                                    <div className={styles.arithActionRow}>
                                        ...
                                        <button onClick={() => navigate('/trigonometry/grade-10-intro/skills')} style={{ padding: '12px 24px', background: accentColor, color: '#fff', border: 'none', borderRadius: 100, fontSize: 15, fontWeight: 700, cursor: 'pointer' }}>Go to Skills →</button>
                                    </div>
                                </div>
                            )}
                        </div>
