...
import { trigFuncCards5W1H } from './TrigFuncGr11IntroData';
...
export default function TrigFuncGr11Intro() {
        ...
        <div className={styles.arithPage}>
            <nav className={styles.introNav}>
                <button
                    ...
                    onClick={() => navigate('/trigonometry/grade-11-functions')}
                >
                    ← Back to Branch
                </button>
            ...
            <div style={{ background: '#fff', padding: '60px 20px', borderBottom: '1px solid #e2e8f0', textAlign: 'center' }}>
                <div style={{ maxWidth: 800, margin: '0 auto' }}>
                    ...
                    <p style={{ fontSize: '1.15rem', color: '#64748b' }}>
                        Tap each card to explore radians, waves, and the unit circle ✨
                    </p>
                </div>
            </div>
            ...
            <div className={styles.arithSection}>
                <div className={styles.arithIntroGrid}>
                    {trigFuncCards5W1H.map((card, idx) => (
                ...
                <div className={styles.arithSplitCta}>
                    <p style={{ margin: 0, fontSize: '1.1rem', fontWeight: 600, color: '#475569' }}>
                        Up next: Radians, Periods, and Quadrants!
                    </p>
                    <button
                        onClick={() => navigate('/trigonometry/grade-11-functions/terminology')}
