...
export default function TrigFuncGr11Skills() {
            ...
            <div className={styles['ccr-page']}>
                <nav className={styles['ccr-nav']}>
                    ...
                    <div className={styles['ccr-nav-links']}>
                        <button className={styles['ccr-nav-link']} onClick={() => navigate('/trigonometry/grade-11-functions')}>Home</button>
                        <button className={styles['ccr-nav-link']} onClick={() => navigate('/trigonometry/grade-11-functions/terminology')}>Terminology</button>
    ...
    return (
        <div className={styles['ccr-page']}>
            <nav className={styles['ccr-nav']}>
                <button className={styles['ccr-nav-back']} onClick={() => navigate('/trigonometry/grade-11-functions')}>← Trigonometric Functions</button>
                <div className={styles['ccr-nav-links']}>
                    <button className={styles['ccr-nav-link']} onClick={() => navigate('/trigonometry/grade-11-functions/introduction')}>Introduction</button>
                    <button className={styles['ccr-nav-link']} onClick={() => navigate('/trigonometry/grade-11-functions/terminology')}>Terminology</button>
                    <button className={`${styles['ccr-nav-link']} ${styles['ccr-nav-link--active']}`}>Skills</button>
                </div>
            </nav>
            ...
            <div className={styles['ccr-module-hero']}>
                <h1 className={styles['ccr-module-title']}>Trig Functions <span className={styles['ccr-accent-text']}>Skills</span></h1>
                <p className={styles['ccr-module-subtitle']}>From angles to radians, identities to general solutions.</p>
            </div>
