...
import { TRI_SKILL_DIAGRAMS } from '../../../SkillDiagrams';
            ...
            <div className={styles.page} style={{ background: '#f8fafc', minHeight: '100vh', paddingBottom: 60 }}>
                <nav className={styles.introNav}>
                    ...
                    <div className={styles.introNavLinks}>
                        ...
                        <button className={styles.introNavLink} onClick={() => navigate('/geometry/triangles/terminology')}>📖 Terminology</button>
                            ...
                            <div className={styles.learnGrid}>
                                ...
                                <main key={`${skill.id}-${selectedLearnIdx}`} style={{ background: '#fff', borderRadius: 20, padding: '20px 28px', boxShadow: '0 8px 24px rgba(0,0,0,0.03)', border: `2px solid ${skill.color}15`, minHeight: 330, minWidth: 0, animation: 'geoSlideIn 0.4s cubic-bezier(0.4,0,0.2,1)' }}>
                                    ...
                                    <div className={styles.learnContentGrid}>
                                        ...
                                        <div>
                                            {TRI_SKILL_DIAGRAMS[skill.id]?.[selectedLearnIdx] && (
                                                <div style={{ marginBottom: 16 }}>
                                                    ...
                                                    <div style={{ background: '#f8fafc', borderRadius: 16, border: `1px solid ${skill.color}20`, padding: '10px 8px', display: 'flex', justifyContent: 'center', overflow: 'hidden' }}
                                                        dangerouslySetInnerHTML={{ __html: TRI_SKILL_DIAGRAMS[skill.id][selectedLearnIdx] }} />
                                                </div>
                                            )}
            ...
            <div className={styles.lexiconContainer} style={{ maxWidth: 1100, margin: '40px auto 20px', padding: '0 24px' }}>
                <div style={{ textAlign: 'center', marginBottom: 40 }}>
                    <h1 style={{ fontFamily: 'Outfit, sans-serif', fontSize: '2.8rem', fontWeight: 900, color: '#0f172a', margin: '0 0 8px' }}>
                        Triangles <span style={{ background: 'linear-gradient(135deg, #f59e0b, #fcd34d)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Skills</span>
                    </h1>
                    <p style={{ color: '#64748b', fontWeight: 600, fontSize: 16, margin: 0 }}>Master Pythagoras, area, angle sum, and congruence with targeted practice.</p>
                </div>
                ...
                <div style={{ marginTop: 60, padding: 32, borderRadius: 24, background: 'linear-gradient(135deg, #f59e0b, #fcd34d)', color: '#fff', textAlign: 'center', boxShadow: '0 15px 40px rgba(245,158,11,0.15)' }}>
                    <div style={{ fontSize: 32, marginBottom: 12 }}>🔺</div>
                    <h3 style={{ fontSize: 24, fontWeight: 800, margin: '0 0 8px' }}>Ready for More?</h3>
                    <p style={{ opacity: 0.9, maxWidth: 500, margin: '0 auto 24px' }}>Triangles are everywhere in geometry. Explore circles and mensuration next!</p>
                    <button className={styles.skillBtnOutline} style={{ background: '#fff', color: '#f59e0b', fontWeight: 800, borderColor: '#fff' }} onClick={() => navigate('/geometry')}>Explore More Topics →</button>
                </div>
            </div>
        </div>
    );
