...
const MODULES = [
    { id:'introduction', path:'/geometry/triangles/introduction', label:'Introduction', emoji:'🌍', tagline:'5W1H Exploration', desc:'6 big questions about Triangles: what, why, who, when, where, and how.', gradFrom:'#0ea5e9', gradTo:'#38bdf8', shadow:'rgba(14,165,233,0.4)' },
    { id:'terminology', path:'/geometry/triangles/terminology', label:'Terminology', emoji:'📖', tagline:'Key Terms & Concepts', desc:'Master the vocabulary of triangle types, congruence, similarity, and the Pythagorean theorem.', gradFrom:'#f59e0b', gradTo:'#fcd34d', shadow:'rgba(245,158,11,0.4)' },
    { id:'skills', path:'/geometry/triangles/skills', label:'Skills', emoji:'🎯', tagline:'Learn, Practice & Assess', desc:'Apply triangle rules, calculate areas, and solve Pythagoras problems.', gradFrom:'#f43f5e', gradTo:'#fb7185', shadow:'rgba(244,63,94,0.4)' },
];

const STATS = [
    { val:'6', label:'Big Questions', color:'#0ea5e9' },
    { val:'3', label:'Skills', color:'#f59e0b' },
        ...
        <div className={styles.fullpage}>
            <div className={styles.left}>
                ...
                <div className={styles.leftContent}>
                    ...
                    <h1 className={styles.mainTitle}>Master<br /><span className={styles.titleAccent}>Triangles</span></h1>
                    <p className={styles.mainSub}>Congruence, similarity, and Pythagoras — deep-dive into triangle types, congruence rules, similarity ratios, and the Pythagorean theorem.</p>
