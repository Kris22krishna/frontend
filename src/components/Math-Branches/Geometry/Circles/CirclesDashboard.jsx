...
const MODULES = [
    { id:'introduction', path:'/geometry/circles/introduction', label:'Introduction', emoji:'🌍', tagline:'5W1H Exploration', desc:'6 big questions about Circles: what, why, who, when, where, and how.', gradFrom:'#0ea5e9', gradTo:'#38bdf8', shadow:'rgba(14,165,233,0.4)' },
    { id:'terminology', path:'/geometry/circles/terminology', label:'Terminology', emoji:'📖', tagline:'Key Terms & Concepts', desc:'Master the vocabulary of radius, diameter, chord, arc, sector, tangent, and inscribed angles.', gradFrom:'#f43f5e', gradTo:'#fb7185', shadow:'rgba(244,63,94,0.4)' },
    { id:'skills', path:'/geometry/circles/skills', label:'Skills', emoji:'🎯', tagline:'Learn, Practice & Assess', desc:'Apply circle theorems, calculate arc lengths, sector areas, and circumference.', gradFrom:'#8b5cf6', gradTo:'#a78bfa', shadow:'rgba(139,92,246,0.4)' },
];

const STATS = [{ val:'6', label:'Big Questions', color:'#0ea5e9' },{ val:'3', label:'Skills', color:'#f43f5e' },{ val:'200+', label:'Questions', color:'#8b5cf6' }];
        ...
        <div className={styles.fullpage}>
            <div className={styles.left}>
                ...
                <div className={styles.leftContent}>
                    ...
                    <h1 className={styles.mainTitle}>Master<br /><span className={styles.titleAccent}>Circles</span></h1>
                    <p className={styles.mainSub}>Arcs, chords, tangents and sectors — understand the properties of circles from central angles to inscribed polygons.</p>
