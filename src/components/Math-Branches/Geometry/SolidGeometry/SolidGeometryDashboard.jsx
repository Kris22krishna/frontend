...
const MODULES = [
    { id:'introduction', path:'/geometry/3d-geometry/introduction', label:'Introduction', emoji:'🌍', tagline:'5W1H Exploration', desc:'6 big questions about 3D Geometry: what, why, who, when, where, and how.', gradFrom:'#0ea5e9', gradTo:'#38bdf8', shadow:'rgba(14,165,233,0.4)' },
    { id:'terminology', path:'/geometry/3d-geometry/terminology', label:'Terminology', emoji:'📖', tagline:'Key Terms & Concepts', desc:'Master the vocabulary of faces, edges, vertices, cross-sections, and nets.', gradFrom:'#ec4899', gradTo:'#f472b6', shadow:'rgba(236,72,153,0.4)' },
    { id:'skills', path:'/geometry/3d-geometry/skills', label:'Skills', emoji:'🎯', tagline:'Learn, Practice & Assess', desc:'Calculate surface areas and volumes of cubes, cuboids, cylinders, cones, and spheres.', gradFrom:'#f43f5e', gradTo:'#fb7185', shadow:'rgba(244,63,94,0.4)' },
];

const STATS = [{ val:'6', label:'Big Questions', color:'#0ea5e9' },{ val:'3', label:'Skills', color:'#ec4899' },{ val:'200+', label:'Questions', color:'#f43f5e' }];

export default function SolidGeometryDashboard() {
        ...
        <div className={styles.fullpage}>
            <div className={styles.left}>
                ...
                <div className={styles.leftContent}>
                    ...
                    <h1 className={styles.mainTitle}>Master<br /><span className={styles.titleAccent}>3D Geometry</span></h1>
                    <p className={styles.mainSub}>Solid shapes and space — explore three-dimensional solids and their surface area and volume.</p>
