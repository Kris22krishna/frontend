...
const MODULES = [
    {
        id: 'introduction',
        path: '/geometry/basic-geometry/introduction',
        label: 'Introduction',
        emoji: '🌍',
        tagline: '5W1H Exploration',
        desc: '6 big questions about Geometry: what, why, who, when, where, and how.',
        gradFrom: '#0ea5e9',
        gradTo: '#38bdf8',
    ...
    {
        id: 'terminology',
        path: '/geometry/basic-geometry/terminology',
        label: 'Terminology',
        emoji: '📖',
        tagline: 'Key Terms & Concepts',
        desc: 'Master the vocabulary of points, lines, angles, triangles, and polygons.',
        gradFrom: '#8b5cf6',
        gradTo: '#a78bfa',
    ...
    {
        id: 'skills',
        path: '/geometry/basic-geometry/skills',
        label: 'Skills',
        emoji: '🎯',
        tagline: 'Learn, Practice & Assess',
        desc: 'Master angle relationships, triangle properties, and polygon calculations.',
        gradFrom: '#f43f5e',
        gradTo: '#fb7185',
...
const STATS = [
    ...
    { val: '3', label: 'Skills', color: '#f43f5e' },
    { val: '240+', label: 'Questions', color: '#8b5cf6' },
];

export default function BasicGeometryDashboard() {
                ...
                <div className={styles.leftContent}>
                    <button
                        ...
                        style={{
                            ...
                            color: '#fff', borderRadius: 50, padding: '8px 16px', fontSize: 13,
                    ...
                    <h1 className={styles.mainTitle}>
                        Master
                        <br />
                        <span className={styles.titleAccent}>Basic Geometry</span>
                    </h1>

                    <p className={styles.mainSub}>
                        The foundation of all geometry — points, lines, angles, triangles, and polygons form the language of shape and space.
                    </p>

                    <div className={styles.statsGrid}>
                        {STATS.map((item) => (
                            <div className={styles.stat} key={item.label}>
                                <span className={styles.statNum} style={{ color: item.color }}>{item.val}</span>
                ...
                <div className={styles.cardsCol}>
                    {MODULES.map((m) => (
                        <button key={m.id} className={styles.cardBtn} onClick={() => navigate(m.path)}>
                            ...
                            <div className={styles.cardIcon} style={{ background: `linear-gradient(135deg, ${m.gradFrom}, ${m.gradTo})`, boxShadow: `0 6px 20px ${m.shadow}` }}>
                                {m.emoji}
                            </div>
