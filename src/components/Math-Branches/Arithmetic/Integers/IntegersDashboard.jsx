...
export default function IntegersDashboard() {
    ...
    const CARDS = [
        {
            id: 'intro',
            path: '/arithmetic/integers/introduction',
            tagline: 'Learn',
            title: 'Introduction',
            desc: 'Understand the concept of integers, zero, and navigating above or below baseline.',
            emoji: '💡',
            gradFrom: '#3b82f6',
            gradTo: '#3b82f6CC',
            shadow: '#3b82f644'
        ...
        {
            id: 'terms',
            path: '/arithmetic/integers/terminology',
            tagline: 'Memory',
            title: 'Terminology',
            desc: 'Master the core vocabulary and signs associated with integers.',
            emoji: '🧠',
            gradFrom: '#ef4444',
            gradTo: '#ef4444CC',
            shadow: '#ef444444'
        ...
        {
            id: 'skills',
            path: '/arithmetic/integers/skills',
    ...
    return (
        <div className={styles.arithFullpage}>
            <div className={styles.arithLeft} style={{ background: 'linear-gradient(145deg, #020617 0%, #0f172a 25%, #172554 50%, #1d4ed8 75%, #3b82f6 100%)' }}>
                ...
                <div className={styles.arithLeftContent}>
                    <h1 className={styles.arithMainTitle} style={{ fontSize: 'clamp(2.5rem, 4vw, 3.8rem)' }}>
                        <span style={{ fontSize: '0.9rem', display: 'block', marginBottom: 12, color: 'rgba(255,255,255,0.6)', letterSpacing: 1.5, textTransform: 'uppercase', fontWeight: 800 }}>Branch 2</span>
                        Integers
                        <br />
                    ...
                    <p className={styles.arithMainSub}>
                        Explore the full spectrum of whole numbers extending into the negatives. Understand heights, depths, and balances.
                    </p>
            ...
            <div className={styles.arithRight}>
                ...
                <p className={styles.arithRightEyebrow}>Explore Integers</p>
