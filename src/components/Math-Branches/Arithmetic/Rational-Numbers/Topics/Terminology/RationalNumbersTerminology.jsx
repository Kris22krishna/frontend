...
import { TERMS, FIVE_RULES, VOCAB_QUIZ } from './RationalNumbersTerminologyData';
import ArithmeticVocabularyVisualizer from '../../../ArithmeticVocabularyVisualizer';

export default function RationalNumbersTerminology() {
    ...
    const accentBg = 'rgba(249, 115, 22, 0.1)';

    return (
        <div className={styles.arithPage}>
            <nav className={styles.introNav}>
                <button className={styles.arithBackBtn} onClick={() => navigate('/arithmetic/rational-numbers')} style={{ marginBottom: 0 }}>← Back to Branch</button>
                <div className={styles.arithIntroNavLinks}>
                    <button className={styles.arithIntroNavLink} onClick={() => navigate('/arithmetic/rational-numbers/introduction')}>🌟 Introduction</button>
            ...
            <div className={styles.arithTermContainer}>
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', marginBottom: 20 }}>
                    <h1 style={{ fontFamily: '"Outfit", sans-serif', fontSize: '2.8rem', fontWeight: 900, color: '#0f172a', margin: '0 0 8px' }}>
                        Rational Numbers <span style={{ background: 'linear-gradient(135deg, #f97316, #fbbf24)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Vocabulary</span>
                    </h1>
                                ...
                                TERMS.map((term, i) => {
                                    ...
                                    return (
                                        <button key={i} 
                                            ...
                                            style={{
                                                background: isActive ? `linear-gradient(135deg, ${accentColor}, ${accentColor}dd)` : `linear-gradient(135deg, rgba(249,115,22,0.08), rgba(249,115,22,0.02))`,
                                                borderColor: isActive ? accentColor : 'rgba(249,115,22,0.15)',
                            ...
                            {activeTab === 'terms' ? (
                                ...
                                <>
                                    ...
                                    <div>
                                        ...
                                        <div style={{ background: 'rgba(249,115,22,0.04)', padding: 20, borderRadius: 16, border: '1px solid rgba(249,115,22,0.1)', textAlign: 'center' }}>
                            ...
                            {!showResults ? (
                                ...
                                <div>
                                    ...
                                    <div className={styles.arithActionRow}>
                                        ...
                                        <button onClick={() => navigate('/arithmetic/rational-numbers/skills')} style={{ padding: '12px 24px', background: accentColor, color: '#fff', border: 'none', borderRadius: 100, fontSize: 15, fontWeight: 700, cursor: 'pointer' }}>Go to Skills →</button>
                                    </div>
                                </div>
                            )}
                        </div>
