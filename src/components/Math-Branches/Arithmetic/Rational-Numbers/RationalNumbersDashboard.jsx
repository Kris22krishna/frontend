...
export default function RationalNumbersDashboard() {
    ...
    const CARDS = [
        {
            id: 'intro',
            path: '/arithmetic/rational-numbers/introduction',
            tagline: 'Learn',
            title: 'Introduction',
            desc: 'Understand what a rational number is and how it encompasses fractions and integers.',
            emoji: '💡',
            gradFrom: '#14b8a6',
            gradTo: '#14b8a6CC',
            shadow: '#14b8a644'
        ...
        {
            id: 'terms',
            path: '/arithmetic/rational-numbers/terminology',
            tagline: 'Memory',
            title: 'Terminology',
            desc: 'Master the core vocabulary: decimals, terminating, repeating, and ratios.',
            emoji: '🧠',
            gradFrom: '#f97316',
            gradTo: '#f97316CC',
            shadow: '#f9731644'
        ...
        {
            id: 'skills',
            path: '/arithmetic/rational-numbers/skills',
            tagline: 'Practice & Test',
            title: 'Skills',
            desc: 'Convert between fractions, decimals, and calculate across the rational number line.',
            emoji: '🎯',
            gradFrom: '#8b5cf6',
            gradTo: '#8b5cf6CC',
            shadow: '#8b5cf644'
    ...
    return (
        <div className={styles.arithFullpage}>
            <div className={styles.arithLeft} style={{ background: 'linear-gradient(145deg, #020617 0%, #0f172a 25%, #064e3b 50%, #047857 75%, #10b981 100%)' }}>
                ...
                <div className={styles.arithLeftContent}>
                    <h1 className={styles.arithMainTitle} style={{ fontSize: 'clamp(2.5rem, 4vw, 3.8rem)' }}>
                        <span style={{ fontSize: '0.9rem', display: 'block', marginBottom: 12, color: 'rgba(255,255,255,0.6)', letterSpacing: 1.5, textTransform: 'uppercase', fontWeight: 800 }}>Branch 4</span>
                        Rational
                        <br />
                    ...
                    <p className={styles.arithMainSub}>
                        Unify integers, fractions, returning decimals, and ratios under a single, powerful mathematical umbrella: The Rational Numbers.
                    </p>
            ...
            <div className={styles.arithRight}>
                ...
                <p className={styles.arithRightEyebrow}>Explore Rational Numbers</p>
