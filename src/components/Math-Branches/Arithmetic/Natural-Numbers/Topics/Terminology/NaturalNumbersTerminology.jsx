...
import { TERMS, FIVE_RULES, VOCAB_QUIZ } from './NaturalNumbersTerminologyData';
import ArithmeticVocabularyVisualizer from '../../../ArithmeticVocabularyVisualizer';

export default function NaturalNumbersTerminology() {
    ...
    return (
        <div className={styles.arithPage}>
            <nav className={styles.introNav}>
                <button className={styles.arithBackBtn} onClick={() => navigate('/arithmetic/natural-numbers')} style={{ marginBottom: 0 }}>← Back to Branch</button>
                <div className={styles.arithIntroNavLinks}>
                    <button className={styles.arithIntroNavLink} onClick={() => navigate('/arithmetic/natural-numbers/introduction')}>🌟 Introduction</button>
                    <button className={`${styles.arithIntroNavLink} ${styles.arithIntroNavLinkActive}`}>📖 Terminology</button>
                    <button className={styles.arithIntroNavLink} onClick={() => navigate('/arithmetic/natural-numbers/skills')}>🎯 Skills</button>
                </div>
            </nav>
            ...
            <div className={styles.arithTermContainer}>
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', marginBottom: 20 }}>
                    ...
                    <div style={{ fontSize: 16, fontWeight: 700, color: '#64748b', letterSpacing: 0.5 }}>
                        {activeTab === 'quiz' ? 'Test your knowledge with interactive questions!' : `Select any ${activeTab === 'terms' ? 'term' : 'property'} below to explore details.`}
                    </div>
                </div>
                                ...
                                TERMS.map((term, i) => {
                                    ...
                                    return (
                                        <button key={i} 
                                            ...
                                            style={{
                                                background: isActive ? `linear-gradient(135deg, ${accentColor}, ${accentColor}dd)` : `linear-gradient(135deg, rgba(139,92,246,0.08), rgba(139,92,246,0.02))`,
                                                borderColor: isActive ? accentColor : 'rgba(139,92,246,0.15)',
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <div style={{ display: 'flex', flexDirection: 'column', textAlign: 'left' }}>
                                                <span style={{ fontWeight: 800, fontSize: 16, color: isActive ? '#fff' : '#1e293b', lineHeight: 1 }}>Property {i + 1}</span>
                                ...
                                <>
                                    ...
                                    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                                        <div>
                                            ...
                                            <div style={{ background: 'rgba(139,92,246,0.04)', padding: 14, borderRadius: 12, border: '1px solid rgba(139,92,246,0.1)' }}>
