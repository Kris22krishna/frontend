...
import { naturalNumbersCards5W1H } from './NaturalNumbersIntroData';
...
export default function NaturalNumbersIntro() {
        ...
        <div className={styles.arithPage}>
            <nav className={styles.introNav}>
                <button
                    ...
                    onClick={() => navigate('/arithmetic/natural-numbers')}
                >
                    ← Back to Branch
                </button>
            ...
            <div style={{ background: '#fff', padding: '60px 20px', borderBottom: '1px solid #e2e8f0', textAlign: 'center' }}>
                <div style={{ maxWidth: 800, margin: '0 auto' }}>
                    <h1 style={{ fontFamily: '"Outfit", sans-serif', fontSize: '2.8rem', fontWeight: 900, color: '#0f172a', marginBottom: 16 }}>
                        Discover Counting Through{' '}
                        <span style={{ color: '#10b981' }}>6 Big Questions</span>
                    </h1>
                    <p style={{ fontSize: '1.15rem', color: '#64748b' }}>
                        Tap each card to explore the origins and properties of natural numbers ✨
                    </p>
                </div>
            </div>
            ...
            <div className={styles.arithSection}>
                <div className={styles.arithIntroGrid}>
                    {naturalNumbersCards5W1H.map((card, idx) => (
                ...
                <div className={styles.arithSplitCta}>
                    <p style={{ margin: 0, fontSize: '1.1rem', fontWeight: 600, color: '#475569' }}>
                        Up next: Key terms and sequences!
                    </p>
                    <button
                        onClick={() => navigate('/arithmetic/natural-numbers/terminology')} className={styles.arithSplitCtaButton} style={{ padding: '14px 32px', background: '#10b981', color: '#fff',
