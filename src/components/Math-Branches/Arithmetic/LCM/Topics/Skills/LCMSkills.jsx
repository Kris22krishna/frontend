...
import { SKILLS } from './LCMSkillsData';

export default function LCMSkills() {
    ...
    return (
        <div className="skills-page calc-skills-stage" style={{ background: '#f8fafc', minHeight: '100vh', paddingBottom: '60px' }}>
            <nav className="intro-nav">
                <button className="intro-nav-back" onClick={() => navigate('/arithmetic/lcm')}>← Back to Branch</button>
                <div className="intro-nav-links">
                    <button className="intro-nav-link" onClick={() => navigate('/arithmetic/lcm/introduction')}>Intro</button>
                    <button className="intro-nav-link" onClick={() => navigate('/arithmetic/lcm/terminology')}>Terminology</button>
            ...
            <div className="calc-lexicon-container calc-skills-stage-body calc-skills-stage-body--list">
                <div style={{ textAlign: 'center', marginBottom: 40 }}>
                    <h1 style={{ fontFamily: 'Outfit, sans-serif', fontSize: '2.8rem', fontWeight: 900, color: 'var(--calc-text)', margin: '0 0 8px' }}>
                        LCM <span style={{ background: 'linear-gradient(135deg, var(--calc-blue), var(--calc-teal))', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Skills</span>
                    </h1>
