...
import { irrationalCards5W1H } from './IrrationalNumbersIntroData';
...
export default function IrrationalNumbersIntro() {
        ...
        <div className={styles.arithPage}>
            <nav className={styles.introNav}>
                <button
                    ...
                    onClick={() => navigate('/arithmetic/irrational-numbers')}
                >
                    ← Back to Branch
                </button>
            ...
            <div style={{ background: '#fff', padding: '60px 20px', borderBottom: '1px solid #e2e8f0', textAlign: 'center' }}>
                <div style={{ maxWidth: 800, margin: '0 auto' }}>
                    <h1 style={{ fontFamily: '"Outfit", sans-serif', fontSize: '2.8rem', fontWeight: 900, color: '#0f172a', marginBottom: 16 }}>
                        Discover Irrational Numbers Through{' '}
                        <span style={{ color: '#6366f1' }}>6 Big Questions</span>
                    </h1>
                    <p style={{ fontSize: '1.15rem', color: '#64748b' }}>
                        Tap each card to explore Pi, square roots, and numbers that never end ✨
                    </p>
                </div>
            </div>
            ...
            <div className={styles.arithSection}>
                <div className={styles.arithIntroGrid}>
                    {irrationalCards5W1H.map((card, idx) => (
                ...
                <div className={styles.arithSplitCta}>
                    <p style={{ margin: 0, fontSize: '1.1rem', fontWeight: 600, color: '#475569' }}>
                        Up next: Pi, radicals, and infinite decimals!
                    </p>
                    <button
                        onClick={() => navigate('/arithmetic/irrational-numbers/terminology')} className={styles.arithSplitCtaButton} style={{ padding: '14px 32px', background: '#6366f1', color: '#fff',
