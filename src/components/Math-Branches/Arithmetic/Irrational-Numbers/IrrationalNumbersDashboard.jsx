...
export default function IrrationalNumbersDashboard() {
    ...
    const CARDS = [
        {
            id: 'intro',
            path: '/arithmetic/irrational-numbers/introduction',
            tagline: 'Learn',
            title: 'Introduction',
            desc: 'Understand the concept of numbers that cannot be expressed as simple fractions.',
            emoji: '💡',
            gradFrom: '#6366f1',
            gradTo: '#6366f1CC',
            shadow: '#6366f144'
        ...
        {
            id: 'terms',
            path: '/arithmetic/irrational-numbers/terminology',
            tagline: 'Memory',
            title: 'Terminology',
            desc: 'Master the core vocabulary: Pi, square roots, non-repeating, and non-terminating.',
            emoji: '🧠',
            gradFrom: '#10b981',
            gradTo: '#10b981CC',
            shadow: '#10b98144'
        ...
        {
            id: 'skills',
            path: '/arithmetic/irrational-numbers/skills',
            tagline: 'Practice & Test',
            title: 'Skills',
            desc: 'Evaluate your understanding with interactive quizzes on Pi and surds.',
            emoji: '🎯',
            gradFrom: '#f43f5e',
            gradTo: '#f43f5eCC',
            shadow: '#f43f5e44'
    ...
    return (
        <div className={styles.arithFullpage}>
            <div className={styles.arithLeft} style={{ background: 'linear-gradient(145deg, #020617 0%, #0f172a 25%, #3b0764 50%, #7e22ce 75%, #a855f7 100%)' }}>
                ...
                <div className={styles.arithLeftContent}>
                    <h1 className={styles.arithMainTitle} style={{ fontSize: 'clamp(2.5rem, 4vw, 3.8rem)' }}>
                        <span style={{ fontSize: '0.9rem', display: 'block', marginBottom: 12, color: 'rgba(255,255,255,0.6)', letterSpacing: 1.5, textTransform: 'uppercase', fontWeight: 800 }}>Branch 5</span>
                        Irrational
                        <br />
                    ...
                    <p className={styles.arithMainSub}>
                        Explore the numbers that go on forever without ever repeating. Discover Pi, roots of non-perfect squares, and the golden ratio.
                    </p>
            ...
            <div className={styles.arithRight}>
                ...
                <p className={styles.arithRightEyebrow}>Explore Irrational Numbers</p>
