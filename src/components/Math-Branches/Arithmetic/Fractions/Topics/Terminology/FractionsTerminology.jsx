...
import { TERMS, FIVE_RULES, VOCAB_QUIZ } from './FractionsTerminologyData';
...
export default function FractionsTerminology() {
    ...
    const accentBg = 'rgba(236, 72, 153, 0.1)';

    return (
        <div className={styles.arithPage}>
            <nav className={styles.introNav}>
                <button className={styles.arithBackBtn} onClick={() => navigate('/arithmetic/fractions')} style={{ marginBottom: 0 }}>← Back to Branch</button>
                <div className={styles.arithIntroNavLinks}>
                    <button className={styles.arithIntroNavLink} onClick={() => navigate('/arithmetic/fractions/introduction')}>🌟 Introduction</button>
                    <button className={`${styles.arithIntroNavLink} ${styles.arithIntroNavLinkActive}`}>📖 Terminology</button>
                    <button className={styles.arithIntroNavLink} onClick={() => navigate('/arithmetic/fractions/skills')}>🎯 Skills</button>
                </div>
            </nav>
            ...
            <div style={{ maxWidth: 1100, margin: '40px auto 20px', padding: '0 24px' }}>
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', marginBottom: 20 }}>
                    <h1 style={{ fontFamily: '"Outfit", sans-serif', fontSize: '2.8rem', fontWeight: 900, color: '#0f172a', margin: '0 0 8px' }}>
                        Fractions <span style={{ background: 'linear-gradient(135deg, #a855f7, #ec4899)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Vocabulary</span>
                    </h1>
                                ...
                                TERMS.map((term, i) => {
                                    ...
                                    return (
                                        <button key={i} 
                                            ...
                                            style={{
                                                background: isActive ? `linear-gradient(135deg, ${accentColor}, ${accentColor}dd)` : `linear-gradient(135deg, rgba(236,72,153,0.08), rgba(236,72,153,0.02))`,
                                                borderColor: isActive ? accentColor : 'rgba(236,72,153,0.15)',
                            ...
                            {activeTab === 'terms' ? (
                                ...
                                <>
                                    ...
                                    <div>
                                        ...
                                        <div style={{ background: 'rgba(236,72,153,0.04)', padding: 20, borderRadius: 16, border: '1px solid rgba(236,72,153,0.1)', textAlign: 'center' }}>
                            ...
                            {!showResults ? (
                                ...
                                <div>
                                    ...
                                    <div style={{ display: 'flex', gap: 16, justifyContent: 'center' }}>
                                        ...
                                        <button onClick={() => navigate('/arithmetic/fractions/skills')} style={{ padding: '12px 24px', background: accentColor, color: '#fff', border: 'none', borderRadius: 100, fontSize: 15, fontWeight: 700, cursor: 'pointer' }}>Go to Skills →</button>
                                    </div>
                                </div>
                            )}
                        </div>
