            ...
            <div className={styles.arithPage}>
                <nav className={styles.introNav}>
                    ...
                    <div className={styles.arithIntroNavLinks}>
                        ...
                        <button className={styles.arithIntroNavLink} onClick={() => navigate('/arithmetic/fractions/terminology')}>📖 Terminology</button>
    ...
    return (
        <div className="skills-page calc-skills-stage" style={{ background: '#f8fafc', minHeight: '100vh', paddingBottom: '60px' }}>
            <nav className="intro-nav">
                <button className="intro-nav-back" onClick={() => navigate('/arithmetic/fractions')}>← Back to Branch</button>
                <div className="intro-nav-links">
                    <button className="intro-nav-link" onClick={() => navigate('/arithmetic/fractions/introduction')}>Intro</button>
                    <button className="intro-nav-link" onClick={() => navigate('/arithmetic/fractions/terminology')}>Terminology</button>
            ...
            <div className="calc-lexicon-container calc-skills-stage-body calc-skills-stage-body--list">
                <div style={{ textAlign: 'center', marginBottom: 40 }}>
                    <h1 style={{ fontFamily: 'Outfit, sans-serif', fontSize: '2.8rem', fontWeight: 900, color: 'var(--calc-text)', margin: '0 0 8px' }}>
                        Fractions <span style={{ background: 'linear-gradient(135deg, var(--calc-blue), var(--calc-teal))', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Skills</span>
                    </h1>
