...
import { generateQuestions } from './ThreeDGeometrySkillsData';

export default function ThreeDGeometrySkills() {
    ...
    if (selectedTopic === 'assessment') {
        return (
            <AssessmentEngine 
                ...
                title="3D Foundation Assessment"
        ...
        <div className="geom-page">
            <div className="geom-module-hero">
                <div style={{ maxWidth: 1100, margin: '0 auto', padding: '0 24px' }}>
                    <button className="geom-back-btn" onClick={() => navigate('/coordinate-geometry/3d-geometry')}>
                        ← Back to 3D Foundation
                    </button>
