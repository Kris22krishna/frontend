...
export default function TwoDGeometryDashboard() {
    ...
    const CARDS = [
        {
            id: 'intro',
            path: '/coordinate-geometry/2d-geometry/introduction',
            tagline: 'Learn',
            title: 'Introduction',
            desc: 'Discover who created coordinate geometry, why the Cartesian plane matters, and how it powers modern science.',
            emoji: '💡',
            gradFrom: '#10b981',
            gradTo: '#10b981CC',
            shadow: '#10b98144'
        ...
        {
            id: 'terms',
            path: '/coordinate-geometry/2d-geometry/terminology',
            tagline: 'Memory',
            title: 'Terminology',
            desc: 'Master the Cartesian plane, quadrants, distance formula, section formula, and key coordinate concepts.',
            emoji: '🧠',
            gradFrom: '#0ea5e9',
            gradTo: '#0ea5e9CC',
            shadow: '#0ea5e944'
        },
        {
            ...
            title: 'Skills',
            desc: 'Solve distance, midpoint, section formula, and collinearity problems with increasing difficulty.',
            emoji: '🎯',
            gradFrom: '#f43f5e',
            gradTo: '#f43f5eCC',
            shadow: '#f43f5e44'
    ...
    return (
        <div className={styles.arithFullpage}>
            <div className={styles.arithLeft} style={{ background: 'linear-gradient(145deg, #020617 0%, #042f2e 25%, #134e4a 55%, #0d9488 80%, #10b981 100%)' }}>
                ...
                <div className={styles.arithLeftContent}>
                    <h1 className={styles.arithMainTitle} style={{ fontSize: 'clamp(2.5rem, 4vw, 3.8rem)' }}>
                        <span style={{ fontSize: '0.9rem', display: 'block', marginBottom: 12, color: 'rgba(255,255,255,0.6)', letterSpacing: 1.5, textTransform: 'uppercase', fontWeight: 800 }}>Branch 1 · Foundation</span>
                        2D Coordinate
                        <br />
                        <span className={styles.arithTitleAccent} style={{ background: 'linear-gradient(135deg, #34d399, #6ee7b7)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Geometry</span>
                    </h1>

                    <p className={styles.arithMainSub}>
                        Master the Cartesian plane, distance formula, section formula, and area of triangles using coordinates.
                    </p>
            ...
            <div className={styles.arithRight}>
                <button onClick={() => navigate('/coordinate-geometry')} style={{
                ...
                <p className={styles.arithRightEyebrow}>Explore 2D Coordinate Geometry</p>
