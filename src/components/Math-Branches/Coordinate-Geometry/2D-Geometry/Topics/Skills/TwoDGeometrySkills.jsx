...
import TrigPracticeEngine from '../../../../Trigonometry/Engines/TrigPracticeEngine';
import TrigAssessmentEngine from '../../../../Trigonometry/Engines/TrigAssessmentEngine';
import { SKILLS } from './TwoDGeometrySkillsIndex';

export default function TwoDGeometrySkills() {
            ...
            <div className={styles['ccr-page']}>
                <nav className={styles['ccr-nav']}>
                    ...
                    <div className={styles['ccr-nav-links']}>
                        <button className={styles['ccr-nav-link']} onClick={() => navigate('/coordinate-geometry/2d-geometry')}>Home</button>
                        <button className={styles['ccr-nav-link']} onClick={() => navigate('/coordinate-geometry/2d-geometry/terminology')}>Terminology</button>
                ...
                <div className={styles['ccr-module-hero']}>
                    ...
                    <p className={styles['ccr-module-subtitle']}>Learn the core concepts step by step</p>
                </div>
        ...
        return (
            <div className={styles['ccr-page']}>
                ...
                <div className={styles['ccr-module-hero']}>
                    ...
                    <p className={styles['ccr-module-subtitle']}>Practice questions to strengthen your understanding</p>
                </div>
                <div className={styles['ccr-section']}>
                    <TrigPracticeEngine
        ...
        return (
            <div className={styles['ccr-page']}>
                ...
                <div className={styles['ccr-module-hero']}>
                    ...
                    <p className={styles['ccr-module-subtitle']}>Short review set for this section</p>
                </div>
                <div className={styles['ccr-section']}>
    ...
    return (
        <div className={styles['ccr-page']}>
            <nav className={styles['ccr-nav']}>
                <button className={styles['ccr-nav-back']} onClick={() => navigate('/coordinate-geometry/2d-geometry')}>← 2D Geometry</button>
                <div className={styles['ccr-nav-links']}>
                    <button className={styles['ccr-nav-link']} onClick={() => navigate('/coordinate-geometry/2d-geometry/introduction')}>Introduction</button>
                    <button className={styles['ccr-nav-link']} onClick={() => navigate('/coordinate-geometry/2d-geometry/terminology')}>Terminology</button>
                    <button className={`${styles['ccr-nav-link']} ${styles['ccr-nav-link--active']}`}>Skills</button>
                </div>
            </nav>
            ...
            <div className={styles['ccr-module-hero']}>
                <h1 className={styles['ccr-module-title']}>2D Geometry <span className={styles['ccr-accent-text']}>Skills</span></h1>
                <p className={styles['ccr-module-subtitle']}>From distance formulas to area calculations — master it all.</p>
            </div>
