...
import { generateQuestions } from './TwoDGeometrySkillsData';
    ...
    if (selectedTopic === 'assessment') {
        return (
            <AssessmentEngine 
                ...
                title="2D Foundation Assessment"
        ...
        <div className="geom-page">
            <div className="geom-module-hero">
                <div style={{ maxWidth: 1100, margin: '0 auto', padding: '0 24px' }}>
                    <button className="geom-back-btn" onClick={() => navigate('/coordinate-geometry/2d-geometry')}>
                        ← Back to 2D Foundation
                    </button>
