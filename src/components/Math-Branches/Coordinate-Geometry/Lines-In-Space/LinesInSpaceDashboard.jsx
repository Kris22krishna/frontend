...
const MODULES = [
    {
        id: 'skills',
        path: '/coordinate-geometry/lines-in-space/skills',
        label: 'Skills',
        emoji: '🎯',
            ...
            <div className="geom-left">
                ...
                <div className="geom-left-content">
                    ...
                    <h1 className="geom-main-title">
                        Master
                        <br />
                        <span className="geom-title-accent" style={{ background: 'linear-gradient(90deg, #38bdf8, #0ea5e9)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Lines In Space</span>
                    </h1>

                    <p className="geom-main-sub">
                        Calculate vector equations, angles between lines, and the shortest distance between skew lines.
                    </p>
