...
import { generateQuestions } from './LinesInSpaceSkillsData';

export default function LinesInSpaceSkills() {
    ...
    if (selectedTopic === 'assessment') {
        return (
            <AssessmentEngine 
                ...
                title="Lines In Space Assessment"
        ...
        <div className="geom-page">
            <div className="geom-module-hero">
                <div style={{ maxWidth: 1100, margin: '0 auto', padding: '0 24px' }}>
                    <button className="geom-back-btn" onClick={() => navigate('/coordinate-geometry/lines-in-space')}>
                        ← Back to Lines In Space
                    </button>
